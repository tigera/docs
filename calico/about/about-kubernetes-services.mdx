...
![Kubernetes Service conceptual diagram](/img/calico/master/k8s-service-concept.svg)
...
![kube-proxy cluster IP](/img/calico/master/kube-proxy-cluster-ip.svg)
...
![kube-proxy node port](/img/calico/master/kube-proxy-node-port.svg)
...
![kube-proxy load balancer](/img/calico/master/kube-proxy-load-balancer.svg)
...
![kube-proxy service advertisement](/img/calico/master/kube-proxy-service-advertisement.svg)
...
![kube-proxy service advertisement](/img/calico/master/kube-proxy-service-local.svg)
...
![kube-proxy service advertisement](/img/calico/master/calico-native-service-handling.svg)
