...
To learn more about {variables.prodname} network policies, see [Calico network policy](network-policy/get-started/calico-policy/calico-network-policy.mdx) guide.
...
out the {variables.prodname} [policy for hosts](network-policy/hosts/index.mdx) guides.
