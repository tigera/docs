...
![In-cluster ingress](/img/calico/master/ingress-in-cluster.svg)
...
![External ingress](/img/calico/master/ingres-external.svg)
...
![In-cluster ingress with NLB local](/img/calico/master/ingress-in-cluster-nlb-local.svg)

**External ingress solution via node ports**

![External ingress via node port](/img/calico/master/ingress-external-node-ports.svg)

**External ingress solution direct to pods**

![External ingress direct to pods](/img/calico/master/ingress-external-direct-to-pods.svg)
