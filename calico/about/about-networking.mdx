...
![OSI network layers diagram](/img/calico/master/osi-network-layers.svg)
...
![Anatomy of a network packet](/img/calico/master/anatomy-of-a-packet.svg)
...
![Anatomy of an overlay network packet](/img/calico/master/anatomy-of-an-overlay-packet.svg)
