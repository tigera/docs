...
Browse to [http://localhost:9090](http://localhost:9090) you should be able to see Prometheus dashboard. Type **`felix_active_local_endpoints`** in the Expression input text box then hit the execute button. Console table should be populated with all your nodes and quantity of endpoints in each of them.
