...
By default, the Windows firewall blocks listening on ports. To have {{prodname}} manage the Prometheus metrics ports Windows firewall rules, enabled the `windowsManageFirewallRules` setting in FelixConfiuration:
