...
Calico installation uses eBPF mode by default on OpenShift. For more information on how to install Calico on OpenShift, see [Install an OpenShift 4 cluster with Calico](../../getting-started/kubernetes/openshift/installation.mdx).
