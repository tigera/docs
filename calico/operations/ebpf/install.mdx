...
As of **v3.30**, Calico installation uses eBPF mode by default on OpenShift. For more information on how to install it, see [Install an OpenShift 4 cluster with Calico](../../getting-started/kubernetes/openshift/installation.mdx).
