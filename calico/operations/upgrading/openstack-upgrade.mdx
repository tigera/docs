...
This page describes how to upgrade to {{version}} from {variables.prodname} v3.0 or later. The procedure
...
1. On all nodes, change the location of the {variables.prodname} packages to point to the {{version}} repo:
