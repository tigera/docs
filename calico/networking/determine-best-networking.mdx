...
<GeekDetails details='Policy:Calico,IPAM:Calico,CNI:Calico,Overlay:No,Routing:BGP' />
...
<GeekDetails details='Policy:Calico,IPAM:Calico,CNI:Calico,Cross-subnet:VXLAN,Routing:Calico' />

_Alternative:_

<GeekDetails details='Policy:Calico,IPAM:Calico,CNI:Calico,Cross-subnet:IPIP,Routing:BGP' />
...
<GeekDetails details='Policy:Calico,IPAM:AWS,CNI:AWS,Overlay:No,Routing:VPC Native' />
...
<GeekDetails details='Policy:Calico,IPAM:Azure,CNI:Azure,Overlay:No,Routing:VPC Native' />
...
<GeekDetails details='Policy:Calico,IPAM:Host Local,CNI:Calico,Overlay:No,Routing:VPC Native' />
...
<GeekDetails details='Policy:Calico,IPAM:Calico,CNI:Calico,Overlay:VXLAN,Routing:Calico' />

_Alternative:_

<GeekDetails details='Policy:Calico,IPAM:Calico,CNI:Calico,Overlay:IPIP,Routing:BGP' />
...
- [Calico Enterprise network visibility](/security/calico-enterprise/network-visibility)
- [Calico Enterprise federation](/security/calico-enterprise/federation)
- [Calico Enterprise user console](/security/calico-enterprise/user-console)
