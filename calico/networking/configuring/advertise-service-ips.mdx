...
1. Configure MetalLB to provision addresses by creating the following IPAddressPool, replacing `x.x.x.x/16` with the CIDR given to {{prodname}} in the steps above. Please note IPAddressPool require Metallb `0.13+`.
