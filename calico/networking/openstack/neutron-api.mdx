...
Floating IPs are supported at beta level. For more information, see [Floating IPs](/networking/openstack/floating-ips).
...
model.  See [Detailed semantics](/networking/openstack/semantics) for a
...
[IP addressing and connectivity](/networking/openstack/connectivity) for more.
...
[IP addressing and connectivity](/networking/openstack/connectivity) for details on how to achieve this setup.
