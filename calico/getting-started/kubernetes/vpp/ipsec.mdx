...
- `show interface` will show all the interfaces present in VPP with their corresponding states. This includies the ipip interfaces (which correspond to the IPsec tunnels) which should be up.
