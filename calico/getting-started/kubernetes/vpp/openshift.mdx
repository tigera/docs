...
<InstallOpenShiftManifests skipDataplaneConfigSteps />
...
curl -O "https://raw.githubusercontent.com/projectcalico/vpp-dataplane/$[vppbranch]/yaml/platforms/openshift/01-configmap-kubernetes-services-endpoint.yaml"
...
curl -O "https://raw.githubusercontent.com/projectcalico/vpp-dataplane/$[vppbranch]/yaml/platforms/openshift/cluster-network-operator.yaml"
cd ..
cp vpp/* manifests/
```
