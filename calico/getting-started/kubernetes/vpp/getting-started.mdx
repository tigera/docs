...
The VPP data plane has some minor behavioural differences with respect to the other $[prodname] data planes and some of the features are not supported. For details please refer to [Known issues & unsupported features](./specifics.mdx).
