...
Run Windows workloads on OpenShift 4 with {variables.prodname}.

## How to

### Before you begin

- Ensure that your environment meets the {variables.prodname} [system requirements](../../openshift/requirements.mdx).
...
Edit the Installation custom resource manifest `manifests/01-cr-installation.yaml` so that it configures an OpenShift {variables.prodname} cluster with VXLAN enabled and BGP disabled:
...
### Install {variables.prodnameWindows}
