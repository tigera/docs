...
- **Kubernetes BGP**
  ...
  <GeekDetails details='Policy:Calico,IPAM:Calico,CNI:Calico,Overlay:No,Routing:BGP,Datastore:Kubernetes' />
...
```powershell
Invoke-WebRequest {{url}}{{baseUrl}}/scripts/Install-Containerd.ps1 -OutFile c:\Install-Containerd.ps1
...
```powershell
Invoke-WebRequest {{url}}{{baseUrl}}/scripts/PrepareNode.ps1 -OutFile c:\PrepareNode.ps1
