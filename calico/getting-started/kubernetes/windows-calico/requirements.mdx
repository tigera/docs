...
The manual method for installing {{prodnameWindows}} is deprecated in favor of using [the Operator and Windows HostProcess containers (HPC)](operator.mdx#install-calico-for-windows-using-the-operator). Support for this method will be dropped in a future {variables.prodname} version.
