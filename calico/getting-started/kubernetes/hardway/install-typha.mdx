...
It watches the Kubernetes resources and {variables.prodname} custom resources used by these daemons, and whenever a resource changes
...
Define a cluster role for Typha with permission to watch {variables.prodname} datastore objects.
