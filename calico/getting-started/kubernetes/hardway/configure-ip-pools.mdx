...
[test networking](/getting-started/kubernetes/hardway/test-networking) lab, we will enable this pool and demonstrate how to control which pools your pods are assigned
addresses from.
...
[Install CNI plugin](/getting-started/kubernetes/hardway/install-cni-plugin)
