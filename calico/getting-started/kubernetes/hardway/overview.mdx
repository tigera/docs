---
description: Calico the hard way overview for Calico Open Source — the cluster you will build, the components installed by hand, and what to know before starting.
---
