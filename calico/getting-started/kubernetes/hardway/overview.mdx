...
### Labs
 ...
 1. [Standing up Kubernetes](/getting-started/kubernetes/hardway/standing-up-kubernetes)
 1. [The Calico datastore](/getting-started/kubernetes/hardway/the-calico-datastore)
 1. [Configure IP pools](/getting-started/kubernetes/hardway/configure-ip-pools)
 1. [Install CNI plugin](/getting-started/kubernetes/hardway/install-cni-plugin)
 1. [Install Typha](/getting-started/kubernetes/hardway/install-typha)
 1. [Install calico/node](/getting-started/kubernetes/hardway/install-node)
 1. [Configure BGP peering](/getting-started/kubernetes/hardway/configure-bgp-peering)
 1. [Test networking](/getting-started/kubernetes/hardway/test-networking)
 1. [Test network policy](/getting-started/kubernetes/hardway/test-network-policy)
 1. [End user RBAC](/getting-started/kubernetes/hardway/end-user-rbac)
 1. [Istio integration](/getting-started/kubernetes/hardway/istio-integration)
