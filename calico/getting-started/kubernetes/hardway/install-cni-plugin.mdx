...
Kubernetes uses the Container Network Interface (CNI) to interact with networking providers like {variables.prodname}.
The {variables.prodname} binary that presents this API to Kubernetes is called the **CNI plugin** and must be installed
