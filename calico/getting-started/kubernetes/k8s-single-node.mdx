...
title: "Tutorial: Install Calico on single-host k8s cluster"
---
...
This gets you a single-host Kubernetes cluster with $[prodname] in approximately 15 minutes.

## Value

Use this guide to quickly and easily try $[prodname] features. To deploy a cluster suitable for production, refer to [$[prodname] on Kubernetes](../index.mdx).
