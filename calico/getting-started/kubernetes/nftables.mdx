---
description: Install Calico Open Source with the nftables data plane instead of the default iptables back end.
...
To use Calico in nftables mode, your cluster's kube-proxy must also be in nftables mode.
```yaml title="Example KubeProxyConfiguration resource"
