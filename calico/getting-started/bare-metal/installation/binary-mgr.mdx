...
1. Ensure the host meets the minimum [system requirements](/getting-started/bare-metal/requirements)
1. If your system is not an Ubuntu- or RedHat-derived system, you will need to choose a different install method.
1. If you want to install {{site.prodname}} with networking (so that you can communicate with cluster workloads), you should choose the [container install method](/getting-started/bare-metal/installation/container)
