...
- Non-cluster host meets [system requirements](/getting-started/bare-metal/requirements) for {{site.prodname}}. If you want to use a package manager for installation, the non-cluster host must be a system derived from Ubuntu or RedHat.
...
| ------------------------------------------------------------ | ---------- | ------ |
| [Docker container](/getting-started/bare-metal/installation/container)                 | ✓          | ✓      |
| [Binary install with package manager](/getting-started/bare-metal/installation/binary-mgr) |            | ✓      |
| [Binary install without package manager](/getting-started/bare-metal/installation/binary) |            | ✓      |
