...
<If condition={props.platform === 'kubernetes' || props.platform === 'openstack'}>On Kubernetes, you can configure Calico to access an etcdv3 cluster directly or to use the Kubernetes API datastore.</If>
