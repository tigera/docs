...
> **Note**: You can also
> [view the manifest in your browser](/security/tutorials/app-layer-policy/manifests/10-yaobank.yaml){:target="_blank"}.
{: .alert .alert-info}
...
> **Note**: You can also
> [view the manifest in your browser](/security/tutorials/app-layer-policy/manifests/30-policy.yaml){:target="_blank"}.
{: .alert .alert-info}
