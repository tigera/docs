...
application. Determine your ingress host and port [following the Istio instructions](http://istio.io/latest/). Once you have the `INGRESS_HOST` and `INGRESS_PORT` variables set, you can
