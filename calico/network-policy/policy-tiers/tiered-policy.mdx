...
The AdminNetworkPolicy tier is created during installation and has the order of 1,000.

The AdminNetworkPolicy tier is where:

- You manage all Kubernetes admin network policies
