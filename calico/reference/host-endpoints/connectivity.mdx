---
description: Reference for the Calico Open Source failsafe policy that protects host endpoints from being cut off when host network policy is misconfigured.
---
