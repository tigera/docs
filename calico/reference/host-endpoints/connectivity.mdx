...
except for traffic that is allowed by the [failsafe rules](/reference/host-endpoints/failsafe).

While the [failsafe rules](/reference/host-endpoints/failsafe) provide protection against removing all
...
[failsafe rules](/reference/host-endpoints/failsafe).
