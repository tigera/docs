...
1. [Generate CA, certificates, and keys](/reference/etcd-rbac/certificate-generation).
...
3. [Create Users and Roles in etcd](/reference/etcd-rbac/users-and-roles).
4. Configure components. For example:
   - [Setting up Kubernetes with {{site.prodname}} utilizing etcd RBAC](/reference/etcd-rbac/kubernetes).
   - [Advanced Kubernetes set ups utilizing etcd RBAC](/reference/etcd-rbac/kubernetes-advanced).
