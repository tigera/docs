...
It assumes you have followed [this guide](/reference/etcd-rbac/kubernetes) for initial etcd
...
- [cni-plugin](/reference/etcd-rbac/calico-etcdv3-paths#cni-plugin)
- [{{site.prodname}} Kubernetes controllers](/reference/etcd-rbac/calico-etcdv3-paths#calicokube-controllers)
- [{{site.nodecontainer}}](/reference/etcd-rbac/calico-etcdv3-paths#caliconode)
- It may also be useful to create a certificate key pair for use with
  calicoctl, even creating specific ones for
  [read only access](/reference/etcd-rbac/calico-etcdv3-paths#calicoctl-read-only-access),
  [policy editor access](/reference/etcd-rbac/calico-etcdv3-paths#calicoctl-policy-editor-access),
  and [full read/write access](/reference/etcd-rbac/calico-etcdv3-paths#calicoctl-full-readwrite-access).
...
[Using etcd RBAC to segment Kubernetes and {{site.prodname}}: Updating a hosted {{site.prodname}} manifest](/reference/etcd-rbac/kubernetes#updating-a-hosted-Calico-manifest),
