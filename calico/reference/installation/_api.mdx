...
<h3 class="anchor anchorWithStickyNavbar" id="operator.tigera.io/v1.APIServerDeploymentPodTemplateSpec">APIServerDeploymentPodTemplateSpec<a href="#operator.tigera.io/v1.APIServerDeploymentPodTemplateSpec" class="hash-link"></a></h3>
<p>
