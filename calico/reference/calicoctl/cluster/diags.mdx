---
description: Reference for the calicoctl cluster diags command in Calico Open Source, used to collect diagnostics from all nodes in a cluster.
---
...
```
Collect snapshot of diagnostic info and logs related to Calico at the cluster-level
