...
```
Show details of Calico IP address usage. With no flags it summarizes pool
usage; the flags drill into a specific address, individual blocks, borrowed
addresses, or the current IPAM configuration.

Usage:
  calicoctl ipam show [flags]

Examples:
  # Summarize IP pool usage.
  calicoctl ipam show
...
Flags:
  ...
  -h, --help                 help for show
      --ip string            Report whether this specific IP address is in use.
