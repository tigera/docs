...
| Field       | Description                 | Accepted Values   | Schema | Default    |
|-------------|-----------------------------|-------------------|--------|------------|
| ingress (deprecated) | The ingress rules belonging to this profile. | | List of [Rule](/reference/resources/networkpolicy#rule) |
| egress  (deprecated) | The egress rules belonging to this profile. | | List of [Rule](/reference/resources/networkpolicy#rule)  |
