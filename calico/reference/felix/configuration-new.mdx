...
This page provides guidance and reference material for configuring Felix.
...
The following sections contain a complete list of Felix configuration parameters, organized by category.
