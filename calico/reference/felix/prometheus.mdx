...
| ** General dataplane **                    | _Metrics shared by all of Felix's "internal" dataplanes.  (The VPP dataplane is "external", it runs outside the Felix process.)_                      |
...
| `felix_route_table_conntrack_wait_seconds` | Summary of time spent waiting for conntrack deletions to finish.  Conntrack entries are deleted before re-using IPs.                                  |
| `felix_route_table_num_ifaces`             | Number of interfaces that Felix is monitoring for the particular routing table.                                                                       |
| `felix_route_table_num_routes`             | Number of routes that Felix is managing in the particular routing table.                                                                              |
| `felix_route_table_resync_seconds`         | Summary of time taken to do full resync of the routing table.                                                                                         |
| `felix_route_table_partial_resync_seconds` | Summary of time taken to resync the routes of a single interface.                                                                                     |
| ** iptables dataplane **                   |                                                                                                                                                       |
...
| `felix_ipset_calls`                        | Number of `ipset` sub-processes executed.                                                                                                             |
| `felix_ipset_errors`                       | Number of ipset command failures.                                                                                                                     |
| `felix_ipset_lines_executed`               | Number of lines of `ipset` commands executed .                                                                                                        |
| `felix_ipsets_calico`                      | Number of Calico-owned IP sets.                                                                                                                       |
| `felix_ipsets_total`                       | Number of IP sets in the dataplane in total.                                                                                                          |
| ** BPF dataplane **                        |                                                                                                                                                       |
