...
3. Install the [calicoctl command line tool](../../maintenance/calicoctl/install.mdx).
...
```bash
kubectl apply -f {{url}}{{baseUrl}}/security/tutorials/app-layer-policy/manifests/10-yaobank.yaml
```

:::note

You can also
[view the manifest in your browser](/security/tutorials/app-layer-policy/manifests/10-yaobank.yaml).
...
We can mitigate both of the above deficiencies with a {{prodname}} policy.
    ...
    wget {{url}}{{baseUrl}}/security/tutorials/app-layer-policy/manifests/30-policy.yaml
    calicoctl create -f 30-policy.yaml

:::note

You can also
[view the manifest in your browser](/security/tutorials/app-layer-policy/manifests/30-policy.yaml).
