...
```shell
kubectl create -f {{url}}{{baseUrl}}/security/tutorials/kubernetes-policy-demo/manifests/00-namespace.yaml
kubectl create -f {{url}}{{baseUrl}}/security/tutorials/kubernetes-policy-demo/manifests/01-management-ui.yaml
kubectl create -f {{url}}{{baseUrl}}/security/tutorials/kubernetes-policy-demo/manifests/02-backend.yaml
kubectl create -f {{url}}{{baseUrl}}/security/tutorials/kubernetes-policy-demo/manifests/03-frontend.yaml
kubectl create -f {{url}}{{baseUrl}}/security/tutorials/kubernetes-policy-demo/manifests/04-client.yaml
```
...
```shell
kubectl create -n stars -f {{url}}{{baseUrl}}/security/tutorials/kubernetes-policy-demo/policies/default-deny.yaml
kubectl create -n client -f {{url}}{{baseUrl}}/security/tutorials/kubernetes-policy-demo/policies/default-deny.yaml
```
...
```shell
kubectl create -f {{url}}{{baseUrl}}/security/tutorials/kubernetes-policy-demo/policies/allow-ui.yaml
kubectl create -f {{url}}{{baseUrl}}/security/tutorials/kubernetes-policy-demo/policies/allow-ui-client.yaml
```
...
```shell
kubectl create -f {{url}}{{baseUrl}}/security/tutorials/kubernetes-policy-demo/policies/backend-policy.yaml
```
...
```shell
kubectl create -f {{url}}{{baseUrl}}/security/tutorials/kubernetes-policy-demo/policies/frontend-policy.yaml
```
