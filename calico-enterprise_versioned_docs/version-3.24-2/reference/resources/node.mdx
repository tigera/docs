---
description: Reference for the Node resource in Calico Enterprise that represents a host running the cnx-node agent.
---
...
| loadBalancer         | Load balancer configuration for this node. This is applicable only if the eBPF dataplane is enabled in [Felix Configuration](felixconfig.mdx).    |                 | [LoadBalancer](#loadbalancer)  |
