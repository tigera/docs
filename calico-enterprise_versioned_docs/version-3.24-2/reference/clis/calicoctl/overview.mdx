---
description: Reference overview of the calicoctl command-line tool for managing Calico Enterprise tiered policy, BGP, IP address management, and node operations.
---
...
Usage:
  calicoctl [options] <command> [<args>...]
    ...
    review                   Review network policy activity.
...
-  [calicoctl review](review/index.mdx)
...
| Global threat feed                   | `globalthreatfeed`, `globalthreatfeeds`                      |
