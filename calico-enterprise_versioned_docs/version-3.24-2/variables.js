...
const variables = {
  releaseTitle: 'v3.24.0-2.0',
  helmPre: 'v3.24.0-2.0'.includes('-') ? ' --devel' : '',
  prodname: 'Calico Enterprise',
  prodnamedash: 'calico-enterprise',
  version: 'v3.24',
  openSourceVersion: releases[0].calico.minor_version.slice(1),
  baseUrl: '/calico-enterprise/3.24',
  filesUrl: 'https://downloads.tigera.io/ee/v3.24.0-2.0',
  ...
  tmpScriptsURL: 'https://docs.tigera.io/calico-enterprise/3.24',
  ...
  registry: 'quay.io/',
  envoyVersion: '1.8.2',
  chart_version_name: 'v3.24.0-2.0',
