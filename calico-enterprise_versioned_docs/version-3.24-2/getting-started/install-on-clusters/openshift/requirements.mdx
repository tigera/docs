...
import ReqsSys from '@site/calico-enterprise_versioned_docs/version-3.24-2/_includes/components/ReqsSys';
import ReqsKernel from '@site/calico-enterprise_versioned_docs/version-3.24-2/_includes/components/ReqsKernel';
