...
import AnomalyDetectionMonitor from '@site/calico-enterprise_versioned_docs/version-v3.14/_includes/content/anomaly-detection/_monitor.mdx';

import AnomalyDetectionEnableDisableCommon from '@site/calico-enterprise_versioned_docs/version-v3.14/_includes/content/anomaly-detection/_enable-disable-common.mdx';
