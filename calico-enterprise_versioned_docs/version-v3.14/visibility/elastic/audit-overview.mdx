...
![audit-logs](/img/calico-enterprise/v3.14/audit-logs.png)
...
![kibana-auditlogs](/img/calico-enterprise/v3.14/kibana-auditlogs.png)

Finally, audit logs provide the core data for compliance reports.

![compliance-reports](/img/calico-enterprise/v3.14/configuration-compliance.png)
