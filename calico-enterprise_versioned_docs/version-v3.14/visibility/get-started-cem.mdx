...
![dashboards](/img/calico-enterprise/v3.14/dashboards.png)
...
![service-graph](/img/calico-enterprise/v3.14/service-graph.png)
...
![service-graph-namespace](/img/calico-enterprise/v3.14/service-graph-namespace.png)
...
![edges](/img/calico-enterprise/v3.14/edges.png)
...
![service-graph-layers](/img/calico-enterprise/v3.14/service-graph-layers.png)
...
![service-graph-flows](/img/calico-enterprise/v3.14/service-graph-flows.png)
...
![packet-capture-service](/img/calico-enterprise/v3.14/packet-capture-service.png)
...
![flow-viz](/img/calico-enterprise/v3.14/flow-viz.png)
...
![policy-board](/img/calico-enterprise/v3.14/policy-board.png)
...
![policy-filters](/img/calico-enterprise/v3.14/policy-filters.png)
...
![recommend-policy](/img/calico-enterprise/v3.14/recommend-policy.png)
...
![stage-policyl](/img/calico-enterprise/v3.14/stage-policy.png)

**Preview**

When you edit a policy, you can select **Preview** to see how changes may affect existing traffic.

![policy-preview](/img/calico-enterprise/v3.14/policy-preview.png)
...
![endpoints](/img/calico-enterprise/v3.14/endpoints.png)

**Node List**

This page lists all nodes associated with your cluster.

![node-list](/img/calico-enterprise/v3.14/node-list.png)
...
![networksets](/img/calico-enterprise/v3.14/networksets.png)
...
![managed-clusters](/img/calico-enterprise/v3.14/managed-clusters.png)
...
![cis-benchmark](/img/calico-enterprise/v3.14/cis-benchmark.png)

Using the filter, you can select report types.

![compliance-filter](/img/calico-enterprise/v3.14/compliance-filter.png)
...
![timeline](/img/calico-enterprise/v3.14/timeline.png)
...
![alerts](/img/calico-enterprise/v3.14/alerts.png)

As shown, there are many types of alerts you can enable. None are enabled by default.

## Kibana

{{prodname}} includes a fully-integrated deployment of Elasticsearch to collect flow
log data that drives key features like the Flow Visualizer, metrics in the Dashboard and Policy Board, policy automation, and testing features and security. {{prodname}} also embeds Kibana so you can view raw log data for the traffic within your cluster.
...
![kibana-dashboards](/img/calico-enterprise/v3.14/kibana-dashboards.png)
...
![kibana](/img/calico-enterprise/v3.14/kibana.png)

Now that you understand the basics, we recommend the following:

- [Get started with tiered network policy](../security/policy-tiers/tiered-policy.mdx)
- [Get started with network sets](../security/networksets.mdx)
