...
import CalicoctlVersion from '@site/calico-enterprise_versioned_docs/version-v3.14/_includes/content/_calicoctl-version.mdx';
...
[to connect to your datastore](../../../maintenance/clis/calicoctl/configure/overview.mdx).
