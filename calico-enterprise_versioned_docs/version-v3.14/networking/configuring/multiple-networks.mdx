...
- Calico Enterprise CNI plugin
  ...
  Verify that you are using the Calico Enterprise CNI. On AKS, EKS, and GKE, the CNI plugin used by Kubernetes may be different, which means this feature will not work.
...
- [Install and configure calicoctl](../../maintenance/clis/calicoctl/index.mdx) or configure access to [Calico Enterprise Manager UI](../../maintenance/cnx/access-the-manager.mdx)
