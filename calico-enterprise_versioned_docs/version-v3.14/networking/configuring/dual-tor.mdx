...
![dual-tor](/img/calico-enterprise/v3.14/dual-tor.png)
...
configuration](../../getting-started/install-on-clusters/openshift/installation/index.mdx#provide-additional-configuration).
