...
1. Download the necessary Installation custom resource.
   ...
   ```bash-plain-text
   wget {{url}}{{baseUrl}}/manifests/custom-resources.yaml
   ```
...
1. [Install and configure calicoctl](../../../../maintenance/clis/calicoctl/install.mdx)
...
- [Secure pods with {{prodname}} network policy](../../../../security/beginners/calico-network-policy.mdx)
