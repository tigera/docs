...
import DockerEe from '@site/calico-enterprise_versioned_docs/version-v3.14/_includes/content/_docker-ee.mdx';
...
```
kubectl create -f {{url}}{{baseUrl}}/manifests/tigera-policies.yaml
```
