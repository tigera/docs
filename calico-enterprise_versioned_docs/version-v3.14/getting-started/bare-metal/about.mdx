...
import DockerContainerService from '@site/calico-enterprise_versioned_docs/version-v3.14/_includes/content/_docker-container-service.mdx';

import NonClusterBinaryInstall from '@site/calico-enterprise_versioned_docs/version-v3.14/_includes/content/_non-cluster-binary-install.mdx';
...
![non-cluster-host](/img/calico-enterprise/v3.14/non-cluster-host.png)
...
To learn how to restrict traffic to/from hosts using {{prodname}} network policy see, [Protect hosts](../../security/hosts/protect-hosts.mdx).
...
- Non-cluster host meets {{prodname}} [system requirements](about.mdx)
...
- [Protect hosts](../../security/hosts/protect-hosts.mdx)
