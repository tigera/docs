...
A rough idea of your tiered policy workflow, and who should access what. See [Configure tiered policies](/security/policy-tiers/tiered-policy/).
...
1. Download the [min-ui-user-rbac.yaml manifest]({{url}}{{baseUrl}}/getting-started/kubernetes/installation/hosted/cnx/demo-manifests/min-ui-user-rbac.yaml).
...
1. Download the [`read-all-crud-default-rbac.yaml` manifest]({{url}}{{baseUrl}}/getting-started/kubernetes/installation/hosted/cnx/demo-manifests/read-all-crud-default-rbac.yaml).
