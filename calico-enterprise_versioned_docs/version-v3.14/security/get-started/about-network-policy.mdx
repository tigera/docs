...
![Example mix of network policy types](/img/calico-enterprise/v3.14/example-k8s-calico-policy-mix.svg)
...
![Example tiers](/img/calico-enterprise/v3.14/example-tiers.svg)
