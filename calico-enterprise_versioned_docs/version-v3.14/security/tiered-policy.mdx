...
![policy-types](/img/calico-enterprise/v3.14/policy-types.png)
...
![policy-tiers](/img/calico-enterprise/v3.14/policy-tiers.png)
...
![default-tier](/img/calico-enterprise/v3.14/default-tier.png)
...
Do not modify these tiers or change their order. Create all of your tiers after system tiers.
...
![hidden-tiers](/img/calico-enterprise/v3.14/hidden-tiers.png)
...
![tier-order](/img/calico-enterprise/v3.14/tier-order.png)
...
![policy-processing](/img/calico-enterprise/v3.14/policy-processing.png)
...
![tier-funnel](/img/calico-enterprise/v3.14/tier-funnel.png)
...
![implicit-deny](/img/calico-enterprise/v3.14/implicit-deny.svg)
...
![endpoint-match](/img/calico-enterprise/v3.14/endpoint-match.svg)
...
- For details on using RBAC for fine-grained access to tiers and policies, see [Configure RBAC for tiered policies](policy-tiers/rbac-tiered-policies.mdx).
