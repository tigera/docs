<!-- This file is contains extra OpenShift installation instructions for hybrid Linux+Windows clusters. -->
...
the node. (For more details, see this [upstream issue](https://github.com/kubernetes/kubernetes/issues/87339).)
