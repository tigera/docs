import CreateKubeconfig from '@site/calico-enterprise_versioned_docs/version-v3.14/_includes/content/_create-kubeconfig.mdx';
...
```bash-plain-text
kubectl apply -f {{url}}{{baseUrl}}/manifests/non-cluster-host-clusterrole.yaml
