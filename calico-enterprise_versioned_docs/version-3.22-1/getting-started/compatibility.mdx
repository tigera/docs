...
- [AKS](#aks)
- [Canonical Charmed Kubernetes](#canonical-charmed-kubernetes)
- [EKS](#eks)
- [GKE](#gke)
...
| $[prodname] version    | $[prodname] support                                                                      |
| ----------------------- | ----------------------------------------------------------------------------------------- |
| 3.20 to current release | - $[prodname] CNI with network policy<br />- Flannel CNI with $[prodname] network policy |
...
| -------------------- | ---------------------------- | -------------------------------------------------------------------------------------- |
| 3.22                 | 1.31 - 1.32                  | - $[prodname] CNI with network policy<br />- AWS CNI with $[prodname] network policy |
...
| -------------------- | --------------------------- | ------------------------------------ |
| 3.22                 | 1.31 - 1.33                 | $[prodname] CNI with network policy |
...
| -------------------- | --------------------------------- | ------------------------------------ |
| 3.22                 | 4.17 - 4.19                       | $[prodname] CNI with network policy |
...
| -------------------- | ------------------------------------ | ------------------- |
| 3.22                 | $[prodname] CNI with network policy | 1.31 - 1.33         |
