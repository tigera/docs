...
You can get up and running with $[prodname] by following any of the $[prodname] [install guides](../../getting-started/index.mdx)
 without needing to be a networking expert. $[prodname] hides the complexities for
