      ...
      <li>
        ...
        <CodeBlock language='bash'>
          {props.networkingType === 'vxlan'
            ? `curl ${variables.filesUrl}/manifests/calico-windows-vxlan.yaml -o calico-windows.yaml`
            : `curl ${variables.filesUrl}/manifests/calico-windows-bgp.yaml -o calico-windows.yaml`}
        </CodeBlock>
      </li>
      <li>
        <p>
      ...
      <li>
        ...
        <ul>
          <li>
            ...
            <CodeBlock language='bash'>curl {variables.filesUrl}/manifests/windows-kube-proxy.yaml -o windows-kube-proxy.yaml</CodeBlock>
          </li>
          <li>
