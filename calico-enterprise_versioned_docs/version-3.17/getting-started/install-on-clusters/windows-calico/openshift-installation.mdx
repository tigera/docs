...
import InstallOpenshiftBeforeYouBegin from '@site/calico-enterprise_versioned_docs/version-3.17/_includes/components/InstallOpenshiftBeforeYouBegin';
...
Install an OpenShift 4 cluster on AWS with {variables.prodname} on Windows nodes.
