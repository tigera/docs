...
Install {variables.prodnameWindows} on Kubernetes clusters. This {variables.prodnameWindows} standard installation requires time and expertise for configuration. To get started quickly, we recommend the [Quickstart](../quickstart.mdx).
