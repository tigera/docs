...
- If you bring your own Prometheus operator and omit the Tigera Prometheus operator from our Helm chart during installation, make sure that it is running before you install {variables.prodname}.
...
- [Create a {variables.prodname} management cluster](../../../multicluster/create-a-management-cluster.mdx)
- [Create a {variables.prodname} managed cluster](../../../multicluster/create-a-managed-cluster.mdx)
