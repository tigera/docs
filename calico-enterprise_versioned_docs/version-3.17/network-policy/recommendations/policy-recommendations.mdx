...
- [Why are egress-to-domain rules being generated for a Kubernetes service?](#why-are-egress-to-domain-rules-being-generated-for-a-kubernetes-service)
...
**Notes**:
This is option is not available on managed clusters if you have implemented the multi-cluster-management feature.
