...
<CodeBlock language='powershell'>
Invoke-WebRequest \{variables.windowsScriptsURL}/Install-Containerd.ps1 -OutFile c:\Install-Containerd.ps1
...
<CodeBlock language='powershell'>
Invoke-WebRequest \{variables.windowsScriptsURL}/PrepareNode.ps1 -OutFile c:\PrepareNode.ps1
