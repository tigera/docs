...
import NonClusterReadOnlyStep from '@site/calico-enterprise_versioned_docs/version-3.18/_includes/content/_non-cluster-read-only-step.mdx';
...
1. Confirm that the image has loaded by typing `docker images`.
   ...
   {variables.registry}{variables.releases.0.components.cnx-node.image}      {{ releases.0.components.cnx-node.version }}        e07d59b0eb8a   2 minutes ago   42MB
   ```
