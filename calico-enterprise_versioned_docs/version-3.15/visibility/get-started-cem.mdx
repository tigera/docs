...
![dashboards](/img/calico-enterprise/3.15/dashboards.png)
...
![service-graph](/img/calico-enterprise/3.15/service-graph.png)
...
![service-graph-namespace](/img/calico-enterprise/3.15/service-graph-namespace.png)
...
![edges](/img/calico-enterprise/3.15/edges.png)
...
![service-graph-layers](/img/calico-enterprise/3.15/service-graph-layers.png)
...
![service-graph-flows](/img/calico-enterprise/3.15/service-graph-flows.png)
...
![packet-capture-service](/img/calico-enterprise/3.15/packet-capture-service.png)
...
![flow-viz](/img/calico-enterprise/3.15/flow-viz.png)
...
![policy-board](/img/calico-enterprise/3.15/policy-board.png)
...
![policy-filters](/img/calico-enterprise/3.15/policy-filters.png)
...
![stage-policyl](/img/calico-enterprise/3.15/stage-policy.png)
...
![endpoints](/img/calico-enterprise/3.15/endpoints.png)

**Node List**

This page lists all nodes associated with your cluster.

![node-list](/img/calico-enterprise/3.15/node-list.png)
...
![networksets](/img/calico-enterprise/3.15/networksets.png)
...
![managed-clusters](/img/calico-enterprise/3.15/managed-clusters.png)
...
![cis-benchmark](/img/calico-enterprise/3.15/cis-benchmark.png)

Using the filter, you can select report types.

![compliance-filter](/img/calico-enterprise/3.15/compliance-filter.png)
...
![timeline](/img/calico-enterprise/3.15/timeline.png)
...
![alerts](/img/calico-enterprise/3.15/alerts.png)
...
![kibana-dashboards](/img/calico-enterprise/3.15/kibana-dashboards.png)
...
![kibana](/img/calico-enterprise/3.15/kibana.png)
