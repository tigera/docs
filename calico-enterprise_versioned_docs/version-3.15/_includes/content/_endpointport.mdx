...
be referenced as a named port in [policy rules](/_includes/content/networkpolicy#entityrule).

| Field    | Description                                                                                                                                                             | Accepted Values      | Schema | Default |
| -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- | ------ | ------- |
| name     | The name to attach to this port, allowing it to be referred to in [policy rules](/_includes/content/networkpolicy#entityrule). Names must be unique within an endpoint. |                      | string |         |
