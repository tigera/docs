...
![In-cluster ingress](/img/calico-enterprise/3.15/ingress-in-cluster.svg)
...
![External ingress](/img/calico-enterprise/3.15/ingres-external.svg)
...
![In-cluster ingress with NLB local](/img/calico-enterprise/3.15/ingress-in-cluster-nlb-local.svg)

**External ingress solution via node ports**

![External ingress via node port](/img/calico-enterprise/3.15/ingress-external-node-ports.svg)

**External ingress solution direct to pods**

![External ingress direct to pods](/img/calico-enterprise/3.15/ingress-external-direct-to-pods.svg)
