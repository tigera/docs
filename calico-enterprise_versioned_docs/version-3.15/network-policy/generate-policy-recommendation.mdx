...
![Navigate to Policy Recommendation](/img/calico-enterprise/3.15/generate-policy-recommendation/recommend-policy-action-bar.png)
...
![Create a Policy Recommendation](/img/calico-enterprise/3.15/generate-policy-recommendation/recommend-policy-screen.png){:height="75%" width="75%"}
...
![Create a Policy Recommendation](/img/calico-enterprise/3.15/generate-policy-recommendation/recommend-policy-screen-advanced-options.png){:height="75%" width="75%"}
...
![Preview or Stage a Policy Recommendation](/img/calico-enterprise/3.15/generate-policy-recommendation/create-policy-action-buttons.png)
