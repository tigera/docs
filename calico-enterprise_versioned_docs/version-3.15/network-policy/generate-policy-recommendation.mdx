...
![Create a Policy Recommendation](/img/calico-enterprise/3.15/generate-policy-recommendation/recommend-policy-screen.png)
...
![Create a Policy Recommendation](/img/calico-enterprise/3.15/generate-policy-recommendation/recommend-policy-screen-advanced-options.png)
