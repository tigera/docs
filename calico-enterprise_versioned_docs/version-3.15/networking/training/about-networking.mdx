...
![OSI network layers diagram](/img/calico-enterprise/3.15/osi-network-layers.svg)
...
![Anatomy of a network packet](/img/calico-enterprise/3.15/anatomy-of-a-packet.svg)
...
![Anatomy of an overlay network packet](/img/calico-enterprise/3.15/anatomy-of-an-overlay-packet.svg)
