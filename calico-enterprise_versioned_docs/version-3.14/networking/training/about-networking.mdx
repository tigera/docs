...
![OSI network layers diagram](/img/calico-enterprise/3.14/osi-network-layers.svg)
...
![Anatomy of a network packet](/img/calico-enterprise/3.14/anatomy-of-a-packet.svg)
...
![Anatomy of an overlay network packet](/img/calico-enterprise/3.14/anatomy-of-an-overlay-packet.svg)
