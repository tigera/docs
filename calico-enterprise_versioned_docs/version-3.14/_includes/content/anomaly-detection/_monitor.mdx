...
![anomaly-detection-single-alert](/img/calico-enterprise/3.14/anomaly-detection-single-alert.png)

**Service Graph**

From the left navbar, click Service Graph. Monitor security performance in the bottom panel.

![anomaly-detection-service-graph-alerts-tab](/img/calico-enterprise/3.14/anomaly-detection-service-graph-alerts-tab.png)
