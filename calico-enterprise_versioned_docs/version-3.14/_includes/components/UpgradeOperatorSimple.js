    ...
    <>
      <ol>
        ...
        <li>
          ...
          <CodeBlock language='batch'>curl -L -O {filesUrl}/manifests/tigera-prometheus-operator.yaml</CodeBlock>
        </li>
    ...
    -p '{"spec":{"template":{"spec":{"imagePullSecrets":[{"name": "tigera-pull-secret"}]}}}}'`}
        ...
        <When condition={props.upgradeFrom === 'OpenSource'}>
          <li>
            ...
            <CodeBlock language='batch'>kubectl get apiserver</CodeBlock>
...
tigera-secure   19h`}
            ...
            <CodeBlock language='batch'>kubectl delete apiserver default</CodeBlock>
          </li>
        </When>
...
EOF`}
            ...
            <li>
              ...
              <CodeBlock language='batch'>kubectl apply -f {filesUrl}/manifests/tigera-policies-managed.yaml</CodeBlock>
