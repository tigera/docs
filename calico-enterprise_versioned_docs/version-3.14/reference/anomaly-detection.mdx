...
The following detectors are searching for [security anomalies](../threat/security-anomalies.mdx). These detectors search primarily for security anomalies related to malicious activities.
