...
| Feature                        |                                                                                                                                                                                                                                                                            |
| ------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Distributions                  | **Supported:**<br />- EKS<br />- AWS<br />- GCE<br />- Azure<br />- AKS (via [upgrade from Calico](../../upgrading/upgrading-calico-to-calico-enterprise/upgrade-to-tsee/index.mdx))<br />- Kubernetes on-premises<br />- OpenShift<br />- Rancher Kubernetes Engine (RKE) |
...
|                                | **Not supported**: <br />- Overlay mode with BGP peering<br />- IP in IP overlay with BGP routing<br />- Cross-subnet support and MTU setting for VXLAN<br />- IPv6 and dual stack<br />- Dual-ToR<br />- Service advertisement<br />- Multiple networks to pods           |
...
|                                | **Not supported**: <br />- Honeypods<br />- Anomaly detection<br />- WAF                                                                                                                                                                                                              |
...
- Delete the {{prodname}} HNS network:
  ...
  ```powershell
  Import-Module {{rootDirWindows}}\libs\hns\hns.psm1
