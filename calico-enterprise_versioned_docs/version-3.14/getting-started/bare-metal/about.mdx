...
import DockerContainerService from '@site/calico-enterprise_versioned_docs/version-3.14/_includes/content/_docker-container-service.mdx';

import NonClusterBinaryInstall from '@site/calico-enterprise_versioned_docs/version-3.14/_includes/content/_non-cluster-binary-install.mdx';
...
![non-cluster-host](/img/calico-enterprise/3.14/non-cluster-host.png)
