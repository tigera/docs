...
We would love to hear about your experience with the eBPF dataplane. Please don’t hesitate to connect with us via the [Calico Users Slack](https://slack.projectcalico.org/) group.
