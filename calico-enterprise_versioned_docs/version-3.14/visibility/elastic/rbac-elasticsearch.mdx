...
- A `tigera-network-admin` role with full permissions to create and modify resources. For help, see [Log in to {{prodname}} Manager](../../maintenance/cnx/authentication-quickstart.mdx).

- To view Elasticsearch resources in {{prodname}} Manager, users must have [minimum permissions](../../security/policy-tiers/rbac-tiered-policies.mdx).
...
- Configure [RBAC for tiered policies](../../security/policy-tiers/rbac-tiered-policies.mdx).
