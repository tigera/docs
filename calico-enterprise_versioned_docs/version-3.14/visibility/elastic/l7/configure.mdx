...
L7 logs require a minimum of 1 additional GB of log storage per node, per one day retention period. Adjust your [Log Storage](../../../operations/logstorage/adjust-log-storage-size.mdx) now.
