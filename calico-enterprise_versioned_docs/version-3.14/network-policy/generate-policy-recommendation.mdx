...
![Navigate to Policy Recommendation](/img/calico-enterprise/3.14/generate-policy-recommendation/recommend-policy-action-bar-3.14.png)
...
![Generate a Policy Recommendation](/img/calico-enterprise/3.14/generate-policy-recommendation/recommend-policy-screen-3.14.png)
...
![Preview or Stage a Policy Recommendation](/img/calico-enterprise/3.14/generate-policy-recommendation/create-policy-action-buttons-3.14.png)
