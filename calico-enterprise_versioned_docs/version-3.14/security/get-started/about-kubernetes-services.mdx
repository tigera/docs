...
![Kubernetes Service conceptual diagram](/img/calico-enterprise/3.14/k8s-service-concept.svg)
...
![kube-proxy cluster IP](/img/calico-enterprise/3.14/kube-proxy-cluster-ip.svg)
...
![kube-proxy node port](/img/calico-enterprise/3.14/kube-proxy-node-port.svg)
...
![kube-proxy load balancer](/img/calico-enterprise/3.14/kube-proxy-load-balancer.svg)
...
![kube-proxy service advertisement](/img/calico-enterprise/3.14/kube-proxy-service-advertisement.svg)
...
![kube-proxy service advertisement](/img/calico-enterprise/3.14/kube-proxy-service-local.svg)
...
![kube-proxy service advertisement](/img/calico-enterprise/3.14/calico-native-service-handling.svg)
