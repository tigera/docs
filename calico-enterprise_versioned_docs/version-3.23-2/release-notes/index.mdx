...
You can now install $[prodname] on vSphere Kubernetes Service (VKS). You deploy it as a Supervisor Service to your guest clusters, and can add Windows nodes if you need them.
...
* Windows nodes on VKS can restart during VKS controller reconciliation. This will be fixed upstream in VKS 3.8 or later.
