...
To route license alerts, see [Configure Alertmanager](monitor/pickle/alertmanager.mdx).

## Additional resources

- [LicenseKey resource](../reference/resources/licensekey.mdx)
- [Configure Alertmanager](monitor/pickle/alertmanager.mdx)
- [Configure Prometheus](monitor/pickle/configure-pickle.mdx)
