...
import MaintenanceClisCalicoqInstalling from '@site/calico-enterprise_versioned_docs/version-3.23-2/_includes/components/MaintenanceClisCalicoqInstalling';
