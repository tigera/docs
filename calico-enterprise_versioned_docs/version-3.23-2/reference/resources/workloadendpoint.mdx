---
description: Reference for the WorkloadEndpoint resource in Calico Enterprise that represents a pod or VM interface for policy and IPAM.
---

# Workload endpoint

import Ipnat from '@site/calico-enterprise_versioned_docs/version-3.23-2/_includes/content/_ipnat.mdx';
