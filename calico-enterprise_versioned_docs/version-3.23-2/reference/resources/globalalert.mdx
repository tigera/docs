---
description: Reference for the GlobalAlert resource in Calico Enterprise that defines an alerting query against flow, audit, or DNS logs.
---
...
added to the Alerts page in the $[prodname] web console. Alerts may
...
- [Audit logs](../../observability/elastic/audit-overview.mdx)
- [DNS logs](../../observability/elastic/dns/index.mdx)
- [Flow logs](../../observability/elastic/flow/index.mdx)
- [L7 logs](../../observability/elastic/l7/index.mdx)
...
alerts in the $[prodname] web console Alert user interface. Any field
...
the default for lookback is 10 minutes. The lookback should always be
...
These are used in the $[prodname] web console to create alerts
...
See [DNS logs](../../observability/elastic/dns/dns-logs.mdx) for description of fields.

### Flow logs

See [Flow logs](../../observability/elastic/flow/datatypes.mdx) for description of fields.

### L7 logs

See [L7 logs](../../observability/elastic/l7/datatypes.mdx) for description of fields.
