---
description: Reference for using Calico Enterprise over a layer-2 Ethernet interconnect fabric covering BGP peering and broadcast domain considerations.
---
