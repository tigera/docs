...
FelixConfiguration should be updated to reflect that:
 - [BPFMaglevMaxEndpointsPerService](../../reference/resources/felixconfig.mdx)
 - [BPFMaglevMaxServices](../../reference/resources/felixconfig.mdx)


## Additional resources
* [Prometheus Metrics for Maglev](../../reference/component-resources/node/felix/prometheus.mdx#load-balancer-metrics)
* [FelixConfiguration](../../reference/resources/felixconfig.mdx)
* [Enable the eBPF data plane](../../operations/ebpf/enabling-ebpf.mdx)
* [Advertise Service IPs with BGP](advertise-service-ips.mdx)
