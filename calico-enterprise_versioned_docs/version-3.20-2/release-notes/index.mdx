...
* Fixed an issue where edgres were missing in the service graph between non cluster hosts.
...
* Fixed an ICMP error when deliving packets to host networked pods.
* Security updates.
