...
* Fixed routing from outside the cluster in EKS with aws-cni when using the eBPF data plane.
...
* Fixed attaching and detaching CTLB programs when using BPF data plane.
* Security updates.
...
* Fixed cgroupv2 mounting for connect time load balancing in the eBPF data plane.
...
* Fixed an issue where the eBPF data plane did not work for OpenShift 4.18.
