---
description: Install Calico Enterprise on a Canonical Juju Charmed Kubernetes cluster.
---
...
# Canonical Juju Charmed Kubernetes
...
By default, Charmed Kubernetes uses Calico for networking. Other CNI options like Flannel can be configured using bundle overlays during deployment.
