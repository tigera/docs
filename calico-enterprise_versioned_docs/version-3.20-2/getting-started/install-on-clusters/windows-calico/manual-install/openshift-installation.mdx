...
import InstallOpenShift from '@site/calico-enterprise_versioned_docs/version-3.20-2/_includes/components/InstallOpenShift';
import InstallOpenshiftBeforeYouBegin from '@site/calico-enterprise_versioned_docs/version-3.20-2/_includes/components/InstallOpenshiftBeforeYouBegin';
