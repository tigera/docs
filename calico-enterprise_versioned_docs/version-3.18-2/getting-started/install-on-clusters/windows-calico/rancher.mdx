...
The following steps will outline the installation of {variables.prodname} networking on the RKE cluster, then the installation of {{prodnameWindows}} on the Windows nodes.
