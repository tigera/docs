...
import InstallOpenShiftManifests from '@site/calico-enterprise_versioned_docs/version-3.18-2/_includes/components/InstallOpenShiftManifests';
import OpenShiftPullSecret from '@site/calico-enterprise_versioned_docs/version-3.18-2/_includes/components/OpenShiftPullSecret';
import OpenShiftPrometheusOperator from '@site/calico-enterprise_versioned_docs/version-3.18-2/_includes/components/OpenShiftPrometheusOperator';
