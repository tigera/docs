...
<h3 id="operator.tigera.io/v1.AmazonCloudIntegration" class="anchor anchorWithStickyNavbar">AmazonCloudIntegration
<a href="#operator.tigera.io%2fv1.AmazonCloudIntegration" class="hash-link" aria-label="Direct link to AmazonCloudIntegration" title="Direct link to AmazonCloudIntegration">&ZeroWidthSpace;</a></h3>
<div>
<p>
...
<em>
<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#daemonsetupdatestrategy-v1-apps">
...
<h3 id="operator.tigera.io/v1.AmazonCloudIntegrationSpec" class="anchor anchorWithStickyNavbar">AmazonCloudIntegrationSpec
<a href="#operator.tigera.io%2fv1.AmazonCloudIntegrationSpec" class="hash-link" aria-label="Direct link to AmazonCloudIntegrationSpec" title="Direct link to AmazonCloudIntegrationSpec">&ZeroWidthSpace;</a></h3>
<p>

(<em>Appears on:</em><a href="#operator.tigera.io/v1.AmazonCloudIntegration">AmazonCloudIntegration</a>)
...
<h3 id="operator.tigera.io/v1.AmazonCloudIntegrationStatus" class="anchor anchorWithStickyNavbar">AmazonCloudIntegrationStatus
<a href="#operator.tigera.io%2fv1.AmazonCloudIntegrationStatus" class="hash-link" aria-label="Direct link to AmazonCloudIntegrationStatus" title="Direct link to AmazonCloudIntegrationStatus">&ZeroWidthSpace;</a></h3>
<p>
...
<h3 id="operator.tigera.io/v1.Auth" class="anchor anchorWithStickyNavbar">Auth
<a href="#operator.tigera.io%2fv1.Auth" class="hash-link" aria-label="Direct link to Auth" title="Direct link to Auth">&ZeroWidthSpace;</a></h3>
<p>

(<em>Appears on:</em><a href="#operator.tigera.io/v1.ManagerSpec">ManagerSpec</a>, <a href="#operator.tigera.io/v1.ManagerStatus">ManagerStatus</a>)
...
<h3 id="operator.tigera.io/v1.AuthType" class="anchor anchorWithStickyNavbar">AuthType
(<code>string</code> alias)<a href="#operator.tigera.io%2fv1.AuthType" class="hash-link" aria-label="Direct link to AuthType" title="Direct link to AuthType">&ZeroWidthSpace;</a></h3>
<p>

(<em>Appears on:</em><a href="#operator.tigera.io/v1.Auth">Auth</a>)
...
<h3 id="operator.tigera.io/v1.MetadataAccessAllowedType" class="anchor anchorWithStickyNavbar">MetadataAccessAllowedType
(<code>string</code> alias)<a href="#operator.tigera.io%2fv1.MetadataAccessAllowedType" class="hash-link" aria-label="Direct link to MetadataAccessAllowedType" title="Direct link to MetadataAccessAllowedType">&ZeroWidthSpace;</a></h3>
<p>

(<em>Appears on:</em><a href="#operator.tigera.io/v1.AmazonCloudIntegrationSpec">AmazonCloudIntegrationSpec</a>)
...
<em>
<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#preferredschedulingterm-v1-core">
...
<em>
<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#nodeselector-v1-core">
...
<em>
<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#rollingupdatedeployment-v1-apps">
