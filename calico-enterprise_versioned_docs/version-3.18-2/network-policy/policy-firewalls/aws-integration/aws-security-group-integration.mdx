...
- You have installed [{variables.prodname} for EKS](../../../getting-started/install-on-clusters/eks.mdx)
...
Commands above apply only to EKS clusters with unmanaged nodegroups i.e. [eksctl without --managed](https://eksctl.io/usage/nodegroup-managed/) option.
...
1.  Install AWS per-account resources.
    ...
    --template-body \{variables.filesUrl}/manifests/aws/security-group-integration/account-cf.yaml
...
1.  Install AWS per-VPC resources.
    ...
    --template-body \{variables.filesUrl}/manifests/aws/security-group-integration/vpc-cf.yaml
...
1.  Install AWS per-cluster resources.
    ...
    --template-body \{variables.filesUrl}/manifests/aws/security-group-integration/cluster-cf.yaml
