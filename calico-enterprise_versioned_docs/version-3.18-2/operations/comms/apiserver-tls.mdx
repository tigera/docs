...
Additional documentation is available for securing [the $[prodname] web console connections](crypto-auth.mdx#connections-from-calico-enterprise-components-to-kube-apiserver-kubernetes-and-openshift).
