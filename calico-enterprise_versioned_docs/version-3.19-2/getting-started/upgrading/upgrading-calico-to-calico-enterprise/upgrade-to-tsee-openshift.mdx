...
import InstallOpenShiftManifestsTemp from '@site/calico-enterprise_versioned_docs/version-3.19-2/_includes/components-temp/InstallOpenShiftManifests-temp';
import OpenShiftPullSecretTemp from '@site/calico-enterprise_versioned_docs/version-3.19-2/_includes/components-temp/OpenShiftPullSecret-temp';
import OpenShiftPrometheusOperatorTemp from '@site/calico-enterprise_versioned_docs/version-3.19-2/_includes/components-temp/OpenShiftPrometheusOperator-temp';
