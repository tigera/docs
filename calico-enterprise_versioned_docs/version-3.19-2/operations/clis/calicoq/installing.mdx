...
import MaintenanceClisCalicoqInstallingTemp from '@site/calico-enterprise_versioned_docs/version-3.19-2/_includes/components-temp/MaintenanceClisCalicoqInstalling-temp.js';
