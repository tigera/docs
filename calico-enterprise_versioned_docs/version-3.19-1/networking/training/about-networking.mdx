...
You can get up and running with {variables.prodname} by following any of the {variables.prodname} [install
guides](../../getting-started/index.mdx) without needing to be a networking expert. {variables.prodname} hides the complexities for
