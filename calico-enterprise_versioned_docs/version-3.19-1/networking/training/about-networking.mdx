...
You can get up and running with {variables.prodname} by following any of the {variables.prodname} [install guides](../../getting-started/index.mdx)
 without needing to be a networking expert. {variables.prodname} hides the complexities for
...
![OSI network layers diagram](/img/calico-enterprise/osi-network-layers.svg)
...
![Anatomy of a network packet](/img/calico-enterprise/anatomy-of-a-packet.svg)
...
![Anatomy of an overlay network packet](/img/calico-enterprise/anatomy-of-an-overlay-packet.svg)
...
{variables.prodname} networking options are exceptionally flexible, so in general you can choose whether you prefer
{variables.prodname} to provide an overlay network, or non-overlay network. You can read more about this in the {variables.prodname}
[determine best networking option](../determine-best-networking.mdx) guide.
