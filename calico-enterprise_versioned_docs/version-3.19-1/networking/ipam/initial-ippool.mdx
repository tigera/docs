...
- To make changes to the IP pools after Tigera Operator install, you may use [calicoctl](../../reference/clis/calicoctl/index.mdx) or kubectl. If you make the changes to the IP Pool in the Installation resource (Operator IPPool) after installation, the changes are not applied.
...
- You are making these changes for a cluster that has not yet had {variables.prodname} deployed.
