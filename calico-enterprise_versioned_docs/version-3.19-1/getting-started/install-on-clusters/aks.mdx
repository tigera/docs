...
import InstallAKSTemp from '@site/calico-enterprise_versioned_docs/version-3.19-1/_includes/components-temp/InstallAKS-temp.js';

# Microsoft Azure Kubernetes Service (AKS)

## Big picture

Install {variables.prodname} on an AKS managed Kubernetes cluster.
...
- Azure CNI networking with {variables.prodname} network policy
...
- Azure CNI with overlay networking with {variables.prodname} network policy
...
1. [Option B: Install with Calico networking](#install-with-{variables.prodnamedash}-networking)
1. [Install the {variables.prodname} license](#install-the-calico-enterprise-license)

<InstallAKSTemp clusterType='standalone' />
