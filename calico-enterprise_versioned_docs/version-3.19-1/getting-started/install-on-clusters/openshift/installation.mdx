...
This guide augments the applicable steps in the [OpenShift documentation](https://cloud.redhat.com/openshift/install) to install {variables.prodname}.

## Before you begin

<InstallOpenshiftBeforeYouBeginTemp />
...
<InstallOpenShiftTemp clusterType='standalone' />
