...
import DefaultInstall from '@site/calico-enterprise_versioned_docs/version-3.19-1/_includes/content/_default-install.mdx';
...
| **Compliance**                  | Configures the {variables.prodname} compliance reporting feature.                                                                                                                                                    |
