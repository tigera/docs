...
import PrivateRegistryImagePathTemp from '@site/calico-enterprise_versioned_docs/version-3.19-1/_includes/components-temp/PrivateRegistryImagePath-temp';

# Install from an image path in a private registry

## Big picture

Move Calico Enterprise container images to an image path in a private registry and configure {variables.prodname} to pull images from it.
...
An **image path** is a directory in the private registry that contains images required to install {variables.prodname}.
...
- [Push {variables.prodname} images to your private registry](#push-calico-enterprise-images-to-your-private-registry-image-path)
