...
import PrivateRegistryRegularTemp from '@site/calico-enterprise_versioned_docs/version-3.19-1/_includes/components-temp/PrivateRegistryRegular-temp';
...
- [Push {variables.prodname} images to your private registry](#push-calico-enterprise-images-to-your-private-registry)
