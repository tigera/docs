...
import InstallOpenShiftManifestsTemp from '@site/calico-enterprise_versioned_docs/version-3.19-1/_includes/components-temp/InstallOpenShiftManifests-temp';
import OpenShiftPullSecretTemp from '@site/calico-enterprise_versioned_docs/version-3.19-1/_includes/components-temp/OpenShiftPullSecret-temp';
import OpenShiftPrometheusOperatorTemp from '@site/calico-enterprise_versioned_docs/version-3.19-1/_includes/components-temp/OpenShiftPrometheusOperator-temp';
...
<InstallOpenShiftManifestsTemp upgradeFrom='OpenSource' />

**Add an image pull secret**

<OpenShiftPullSecretTemp />
...
<OpenShiftPrometheusOperatorTemp upgradeFrom='OpenSource' />
