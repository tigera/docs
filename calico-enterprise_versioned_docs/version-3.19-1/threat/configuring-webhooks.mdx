...
* **Jira**. You must have an API token for an Atlassian user account that has write permissions to your Jira instance.
  ...
  * A Jira project key. This is the Jira project where your {variables.prodname} webhook creates new issues. Ths user associated with your API token must have write permissions to this project.
