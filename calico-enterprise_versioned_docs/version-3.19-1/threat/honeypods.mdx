...
kubectl create -f {variables.filesUrl}/manifests/threatdef/honeypod/common.yaml
</CodeBlock>
...
<CodeBlock language='bash'>
kubectl apply -f {variables.filesUrl}/manifests/threatdef/honeypod/ip-enum.yaml
</CodeBlock>
...
<CodeBlock language='bash'>
kubectl apply -f {variables.filesUrl}/manifests/threatdef/honeypod/expose-svc.yaml
</CodeBlock>
...
<CodeBlock language='bash'>
kubectl apply -f {variables.filesUrl}/manifests/threatdef/honeypod/vuln-svc.yaml
</CodeBlock>
