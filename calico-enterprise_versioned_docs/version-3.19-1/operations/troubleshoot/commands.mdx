...
### Collect {variables.prodname} diagnostic logs
...
### View {variables.prodname} installation parameters
...
### Verify existing {variables.prodname} network policies
...
### Verify existing {variables.prodname} global network policies
