...
Configure roles using Kubernetes RBAC and lock down user permissions to {variables.prodname} features and functions.
...
| ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Network policy                 | - Tiered policy, including AWS security groups and federated services.<br />- Kubernetes network policy (in default tier)<br />- {variables.prodname} network policies including namespaces<br />- Staged policy, policy recommendation, policy preview |
...
{variables.prodname} provides the following predefined roles and permissions:

`tigera-ui-user`

- Basic user with access to {variables.prodname} Manager UI and Kibana:
