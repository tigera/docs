...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Prometheus    | Monitoring tool that scrapes metrics from instrumented jobs and displays time series data in a visualizer (such as Grafana). For {variables.prodname}, the “jobs” that Prometheus can harvest metrics from are the Elasticsearch and Fluentd components. |
| Elasticsearch | Stores {variables.prodname} logs.                                                                                                                                                                                                                        |
| Fluentd       | Sends {variables.prodname} logs to Elasticsearch for storage.                                                                                                                                                                                            |
