...
To learn more about {variables.prodname} network policies, read the [Get started with {variables.prodname} network policy](../beginners/calico-network-policy.mdx)
 guide.
