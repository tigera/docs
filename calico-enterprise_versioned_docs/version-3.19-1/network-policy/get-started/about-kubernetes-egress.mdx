...
the new IP addresses. This limitation can be circumvented using {variables.prodname} [Use external IPs or networks rules in policy](../beginners/policy-rules/external-ips-policy.mdx), or [DNS policy](../domain-based-policy.mdx) in policy rules.
