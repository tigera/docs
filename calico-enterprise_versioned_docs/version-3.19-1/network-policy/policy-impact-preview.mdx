...
- The {variables.prodname} Manager

## Before you begin...

You must have a running kubernetes cluster with {variables.prodname} installed.
...
There may be some flows that {variables.prodname} will not be able to predict. Those flows will appear as "Uncertain" as per the legend at the bottom right.
