...
Use {variables.prodname} network policy to allow/deny traffic for Kubernetes services.

## Value

Using {variables.prodname} network policy, you can leverage Kubernetes Service names to easily define access to Kubernetes services. Using service names in policy enables you to:
