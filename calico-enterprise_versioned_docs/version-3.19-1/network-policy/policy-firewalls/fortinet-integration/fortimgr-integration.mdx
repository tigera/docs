...
1. In this <Link to={variables.filesUrl + '/manifests/fortimanager-device-configmap.yaml'}>FortiManager ConfigMap manifest</Link>, add your FortiManager device information in the data section: `tigera.firewall.fortimanager-policies`. For example:
