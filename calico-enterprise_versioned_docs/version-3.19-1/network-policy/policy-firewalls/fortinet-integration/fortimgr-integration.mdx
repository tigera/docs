...
- Login access to [{variables.prodname} Manager UI](../../../operations/cnx/access-the-manager.mdx)
...
1. In this [FortiManager ConfigMap manifest]({variables.filesUrl}/manifests/fortimanager-device-configmap.yaml), add your FortiManager device information in the data section: `tigera.firewall.fortimanager-policies`. For example:
...
1. Apply the manifest.
   ...
   kubectl apply -f {variables.filesUrl}/manifests/fortimanager-device-configmap.yaml
   </CodeBlock>
...
1. Apply the manifest.
   ...
   <CodeBlock language='bash'>
   kubectl apply -f {variables.filesUrl}/manifests/fortimanager.yaml
   </CodeBlock>
