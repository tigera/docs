...
- Pull secret that you used during [{variables.prodname} installation](../../../getting-started/install-on-clusters/index.mdx)
...
1. In the [Fortigate ConfigMap manifest]({variables.filesUrl}/manifests/fortinet-device-configmap.yaml), add your FortiGate firewall information in the data section, `tigera.firewall.fortigate`.
...
1. In the [FortiManager ConfigMap manifest]({variables.filesUrl}/manifests/fortinet-device-configmap.yaml), add your FortiManager information in the data section, `tigera.firewall.fortimgr`.
...
1. Apply the manifest.
   ...
   <CodeBlock language=''>
   kubectl apply -f {variables.filesUrl}/manifests/fortinet-device-configmap.yaml
   </CodeBlock>
...
1. Apply the manifest.
   ...
   <CodeBlock language=''>
   kubectl apply -f {variables.filesUrl}/manifests/fortinet.yaml
   </CodeBlock>
