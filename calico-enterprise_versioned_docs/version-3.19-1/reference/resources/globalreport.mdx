...
A global report resource is a configuration for generating compliance reports. A global report configuration in {variables.prodname} lets you:
...
To use the {variables.prodname} compliance reporting feature, you must ensure all required resource types
