...
{variables.prodname} supports selecting one or multiple [WorkloadEndpoints resources](workloadendpoint.mdx)
...
{variables.prodname} supports the following syntax for expressing ports.
