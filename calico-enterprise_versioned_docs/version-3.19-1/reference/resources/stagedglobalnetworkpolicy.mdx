...
`StagedGlobalNetworkPolicy` resources can be used to define network connectivity rules between groups of {variables.prodname} endpoints and host endpoints, and
...
See [Using {variables.prodname} to Secure Host Interfaces](../host-endpoints/index.mdx)
