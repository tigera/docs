...
An alert exception resource is a filter that hides specific alerts from users in {variables.prodname} Manager UI.
...
| selector    | Selects alerts to filter from {variables.prodname} Manager UI queries.                      | string                  | yes      | [selector](#selector)   |
...
| Field            | Description                                                                        |
| ---------------- | ---------------------------------------------------------------------------------- |
| origin           | User specified or generated names from {variables.prodname} threat defense components.     |
| type             | {variables.prodname} threat defense components an alert is generated from.                 |
