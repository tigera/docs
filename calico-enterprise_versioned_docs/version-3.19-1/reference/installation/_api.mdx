...
<em>(Optional)</em>
<p>
OIDC contains the configuration needed to set up OIDC authentication.
</p>
...
<em>(Optional)</em>
<p>
Openshift contains the configuration needed to set up Openshift OAuth authentication.
</p>
...
<em>(Optional)</em>
<p>
LDAP contains the configuration needed to set up LDAP authentication.
</p>
...
If Enabled, this feature sets hostPID to true to read process cmdline.
Default: Enabled
</p>
...
<p>
AuthenticationLDAP is the configuration needed to set up LDAP.
</p>
<table>
<thead>
<tr>
...
<p>
AuthenticationOIDC is the configuration needed to set up OIDC.
</p>
<table>
<thead>
<tr>
...
<p>
AuthenticationOpenshift is the configuration needed to set up Openshift.
</p>
<table>
<thead>
<tr>
