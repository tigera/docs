...
Log storage provides persistent storage for {variables.prodname} Elasticsearch logs (flow, dns, l7, bpg, audit, etc.), and compliance reports.
...
| log-storage-access          | {variables.prodname} log storage API service.                        | <center>✔</center>     |                    | <center>         ✔</center> |
