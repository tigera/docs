...
policy, {variables.prodname} has a failsafe mechanism that keeps various pinholes open
in the firewall.

By default, {variables.prodname} keeps the following ports open on _all_ host endpoints:
