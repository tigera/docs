...
limited based on the datastore used for {variables.prodname} (Kubernetes API).
Please refer to the
...
- [Resources](../../resources/overview.mdx) for details on all valid resources, including file format
  and schema
- [NetworkPolicy](../../resources/networkpolicy.mdx) for details on the {variables.prodname} selector-based policy model
