...
Selectors can be used in the following three contexts in {variables.prodname}
security policy definitions:

- A selector can be used in the definition of each {variables.prodname} Policy object,
...
Note: the use of selectors in {variables.prodname} policy is described in detail by
