...
You can enable either feature in Manager UI or by running a kubectl command.
For Helm installations, you can enable the features during and update or installation.

:::note Update note
Updating to Calico Enterprise 3.20 introduces breaking changes to the packet capture and compliance reporting features.
...
* **PacketCapture CR** To maintain packet capture during an upgrade, you can create a PacketCaptureAPI custom resource.
