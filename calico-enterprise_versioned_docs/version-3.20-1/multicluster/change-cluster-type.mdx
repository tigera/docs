...
Change the configuration type for an existing {variables.prodname} cluster to management, managed, or standalone.
...
1. Install the Tigera custom resources.
   ...
   kubectl apply -f \{variables.filesUrl}/manifests/custom-resources.yaml
   </CodeBlock>
