...
Enable custom workflows for issuing and signing certificates used to secure communication between {variables.prodname} components.
...
certificate issuance, {variables.prodname} provides a simple configuration option that you add to your installation.
...
Currently, this feature is not supported in combination with [Multi-cluster management](../../multicluster/set-up-multi-cluster-management/standard-install/create-a-management-cluster.mdx).
