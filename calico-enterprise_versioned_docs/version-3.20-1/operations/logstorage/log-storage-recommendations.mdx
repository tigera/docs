...
{variables.prodname} installs an Elasticsearch cluster for storing logs internally.
...
set up this StorageClass before installing {variables.prodname}.
...
- Red health: There is a serious issue with your cluster, check the [troubleshoot page](../../visibility/elastic/troubleshoot.mdx)
