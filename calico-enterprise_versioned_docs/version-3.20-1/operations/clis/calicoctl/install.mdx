...
<CodeBlock language='bash'>
  {'${variables.version}' === 'master'
    ? `curl -o calicoctl -O -L ${variables.filesUrl}/download/binaries/${variables.releaseTitle}/calicoctl`
    : `curl -o calicoctl -O -L ${variables.downloadsurl}/ee/binaries/${variables.releaseTitle}/calicoctl`}
</CodeBlock>
...
<CodeBlock language='bash'>
  {'${variables.version}' === 'master'
    ? `curl -o calicoctl -O -L ${variables.filesUrl}/download/binaries/${variables.releaseTitle}/calicoctl-darwin-amd64`
    : `curl -o calicoctl -O -L ${variables.downloadsurl}/ee/binaries/${variables.releaseTitle}/calicoctl-darwin-amd64`}
</CodeBlock>
...
<CodeBlock language='bash'>
  {'${variables.version}' === 'master'
    ? `Invoke-WebRequest -Uri "${variables.filesUrl}/download/binaries/${variables.releaseTitle}/calicoctl-windows-amd64.exe" -OutFile "calicoctl.exe"`
    : `Invoke-WebRequest -Uri "${variables.downloadsurl}/ee/binaries/${variables.releaseTitle}/calicoctl-windows-amd64.exe" -OutFile "calicoctl.exe"`}
</CodeBlock>
...
<CodeBlock language='bash'>
  {'${variables.version}' === 'master'
    ? `curl -o kubectl-calico -O -L ${variables.filesUrl}/download/binaries/${variables.releaseTitle}/calicoctl`
    : `curl -o kubectl-calico -O -L ${variables.downloadsurl}/ee/binaries/${variables.releaseTitle}/calicoctl`}
</CodeBlock>
...
<CodeBlock language='bash'>
  {'${variables.version}' === 'master'
    ? `curl -o kubectl-calico -O -L ${variables.filesUrl}/download/binaries/${variables.releaseTitle}/calicoctl-darwin-amd64`
    : `curl -o kubectl-calico -O -L ${variables.downloadsurl}/ee/binaries/${variables.releaseTitle}/calicoctl-darwin-amd64`}
</CodeBlock>
...
<CodeBlock language='bash'>
  {'${variables.version}' === 'master'
    ? `Invoke-WebRequest -Uri "${variables.filesUrl}/download/binaries/${variables.releaseTitle}/calicoctl-windows-amd64.exe" -OutFile "kubectl-calico.exe"`
    : `Invoke-WebRequest -Uri "${variables.downloadsurl}/ee/binaries/${variables.releaseTitle}/calicoctl-windows-amd64.exe" -OutFile "kubectl-calico.exe"`}
</CodeBlock>
