...
The `calicoctl` CLI tool provides helpful administrative commands for interacting with a {variables.prodname} cluster.

## Concepts

### Default calicoctl behavior

Most `calicoctl` commands require access to the {variables.prodname} datastore. By default, calicoctl
