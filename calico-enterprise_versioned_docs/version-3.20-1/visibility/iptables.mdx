...
{variables.prodname} adds a Felix option `DropActionOverride` that configures how the
...
the current {variables.prodname} policy, i.e., by the ordered combination of all the
