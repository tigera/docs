...
{variables.prodname} audit logs provide security teams and auditors historical data of all changes to resources over time.

## Concepts

### Resources used in audit logs

{variables.prodname} audit logs are enabled by default for the following resources:
...
{variables.prodname} audit logs are displayed in the Timeline dashboard in Manager UI. You can filter logs, and export data in .json or .yaml formats.
