...
{variables.prodname} packet capture is implemented in a Kubernetes-native way so you can troubleshoot service/application connectivity issues and performance issues. You can start a packet capture in Manager UI Service Graph, or using the CLI.
...
With {variables.prodname} packet capture you can:
...
##### Enable packet capture using Manager UI

1. From the Manager UI, click the Service Graph to view the service graph diagram for your cluster.
