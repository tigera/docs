...
that is not specific to {variables.prodname}.
...
![In-cluster ingress](/img/calico-enterprise/ingress-in-cluster.svg)
...
![External ingress](/img/calico-enterprise/ingres-external.svg)
...
![In-cluster ingress with NLB local](/img/calico-enterprise/ingress-in-cluster-nlb-local.svg)

**External ingress solution via node ports**

![External ingress via node port](/img/calico-enterprise/ingress-external-node-ports.svg)
