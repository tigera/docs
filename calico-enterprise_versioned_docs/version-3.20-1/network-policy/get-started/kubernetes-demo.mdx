...
kubectl create -f \{variables.tutorialFilesURL}/00-namespace.yaml
kubectl create -f \{variables.tutorialFilesURL}/01-management-ui.yaml
kubectl create -f \{variables.tutorialFilesURL}/02-backend.yaml
kubectl create -f \{variables.tutorialFilesURL}/03-frontend.yaml
kubectl create -f \{variables.tutorialFilesURL}/04-client.yaml
</CodeBlock>
...
<CodeBlock language='shell'>
kubectl create -n stars -f \{variables.tutorialFilesURL}/default-deny.yaml
kubectl create -n client -f \{variables.tutorialFilesURL}/default-deny.yaml
</CodeBlock>
...
<CodeBlock language='shell'>
kubectl create -f \{variables.tutorialFilesURL}/allow-ui.yaml
kubectl create -f \{variables.tutorialFilesURL}/allow-ui-client.yaml
</CodeBlock>
...
<CodeBlock language='shell'>
kubectl create -f \{variables.tutorialFilesURL}/backend-policy.yaml
</CodeBlock>
...
<CodeBlock language='shell'>
kubectl create -f \{variables.tutorialFilesURL}/frontend-policy.yaml
</CodeBlock>
...
To use {variables.prodname} to enforce egress policy on Kubernetes pods, see [the advanced policy demo](kubernetes-policy-advanced.mdx).
