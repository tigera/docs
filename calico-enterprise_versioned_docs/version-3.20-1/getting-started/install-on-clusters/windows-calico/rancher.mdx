...
Install {variables.prodnameWindows} on Rancher Kubernetes Engine (RKE).
...
1. Download the necessary Installation custom resources.
   ...
   <CodeBlock language='bash'>
   wget \{variables.filesUrl}/manifests/custom-resources.yaml
   </CodeBlock>
...
- [Secure pods with {variables.prodname} network policy](../../../network-policy/beginners/calico-network-policy.mdx)
