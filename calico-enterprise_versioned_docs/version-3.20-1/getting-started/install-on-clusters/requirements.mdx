...
import ReqsSys from "@site/calico-enterprise_versioned_docs/version-3.20-1/_includes/components/ReqsSys";
import ReqsKernel from "@site/calico-enterprise_versioned_docs/version-3.20-1/_includes/components/ReqsSys";
