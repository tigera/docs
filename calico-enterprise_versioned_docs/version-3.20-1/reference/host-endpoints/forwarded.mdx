...
This is different from how {variables.prodname} treats traffic to or from a local process:
...
{variables.prodname}'s handling of host endpoint policy has changed, since before
...
{variables.prodname} will apply this policy after all other policies. Refer to the
