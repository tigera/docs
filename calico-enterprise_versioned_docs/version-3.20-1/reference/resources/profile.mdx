...
Each {variables.prodname} endpoint or host endpoint can be assigned to zero or more profiles.
...
| --------------------- | ------------- | ------ | -------- | ------------------------------------------------------------------------------ |
| Kubernetes API server | No            | No     | Yes      | {variables.prodname} profiles are pre-assigned for each Namespace and Service Account. |
