...
import Httpmatch from '@site/calico-enterprise_versioned_docs/version-3.20-1/_includes/content/_httpmatch.mdx';
...
`GlobalNetworkPolicy` resources can be used to define network connectivity rules between groups of {variables.prodname} endpoints and host endpoints, and
