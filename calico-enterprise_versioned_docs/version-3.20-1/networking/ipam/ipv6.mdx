...
Configure {variables.prodname} IP address allocation to use dual stack for workload communications.

## Value

In addition to IPv4, IPv6 is increasingly desirable for Workload communication. {variables.prodname} supports:
...
- OpenShift
  ...
  - Requires 3.11 and later using {variables.prodname} 3.4 and later for IPv6 support
