...
this in the {variables.prodname} [determine best networking option](../determine-best-networking.mdx)
guide.
...
Note that when using {variables.prodname} in on-prem deployments you can also [advertise service IP addresses](../configuring/advertise-service-ips.mdx)
...
[determine best networking option](../determine-best-networking.mdx) guide. {variables.prodname} also
