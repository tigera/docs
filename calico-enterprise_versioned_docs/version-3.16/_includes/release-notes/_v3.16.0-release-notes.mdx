...
For more information, see [Rancher Manager](../../getting-started/install-on-clusters/rke2.mdx).
...
* We removed support and documentation for installing Calico Enterprise using the Rancher UI.
