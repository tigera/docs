---
description: Reference for Felix configuration parameters in Calico Enterprise covering environment variables, FelixConfiguration fields, and per-node overrides.
---
