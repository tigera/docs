---
description: Reference for the tigerastatus resource in Calico Enterprise that reports per-component installation and reconciliation health.
---
...
Log storage provides persistent storage for $[prodname] Elasticsearch logs (flow, dns, l7, bgp, audit, etc.), and compliance reports.
