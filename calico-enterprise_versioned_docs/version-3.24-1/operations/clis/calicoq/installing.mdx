...
import MaintenanceClisCalicoqInstalling from '@site/calico-enterprise_versioned_docs/version-3.24-1/_includes/components/MaintenanceClisCalicoqInstalling';
