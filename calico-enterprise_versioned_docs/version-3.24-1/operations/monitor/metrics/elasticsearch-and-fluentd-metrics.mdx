...
- [Create Prometheus alerts for Elasticsearch](#create-pickle-alerts-for-elasticsearch)
- [Create Prometheus alerts for Fluentd](#create-pickle-alerts-for-elasticsearch)
