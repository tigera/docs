...
To route these alerts, see [Configure Alertmanager](../pickle/alertmanager.mdx).

## Additional resources

- [License expiration and renewal](../../license-options.mdx)
- [Configure Prometheus](../pickle/configure-pickle.mdx)
- [BYO Prometheus](../pickle/byo-pickle.mdx)
