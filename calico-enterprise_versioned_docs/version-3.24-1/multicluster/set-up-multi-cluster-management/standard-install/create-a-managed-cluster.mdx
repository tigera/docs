...
import InstallAKS from '@site/calico-enterprise_versioned_docs/version-3.24-1/_includes/components/InstallAKS';
import InstallGKE from '@site/calico-enterprise_versioned_docs/version-3.24-1/_includes/components/InstallGKE';
import InstallEKS from '@site/calico-enterprise_versioned_docs/version-3.24-1/_includes/components/InstallEKS';
import InstallGeneric from '@site/calico-enterprise_versioned_docs/version-3.24-1/_includes/components/InstallGeneric';
import InstallOpenShift from '@site/calico-enterprise_versioned_docs/version-3.24-1/_includes/components/InstallOpenShift';
