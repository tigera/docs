...
import License from '@site/calico-enterprise_versioned_docs/version-3.22-2/_includes/content/_license.mdx';
...
- [Create alerts using Prometheus metrics](#create-alerts-using-pickle-metrics)
...
- [Configure Alertmanager](../pickle/alertmanager.mdx)
