...
- [Verify BYO Prometheus](#verify-byo-pickle)
...
3. Verify that the new configuration has been added to your cluster
    ...
    ```
    That's it. You should be seeing the new metrics show up in your Prometheus instance within a minute. For more information on verifying metrics, see the section, [Verify BYO Prometheus](#verify-byo-pickle).
...
```bash
export NAMESPACE=<my-pickle-namespace>
```
