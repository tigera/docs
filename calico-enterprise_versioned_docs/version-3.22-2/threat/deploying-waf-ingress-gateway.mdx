...
The WAF add-on for Calico Ingress Gateway is offered as part of a trial program and requires a trial license.
When they become generally available, add-ons for Calico Ingress Gateway require a paid license.

To enable this feature on a trial basis, contact your customer success engineer or account manager.
