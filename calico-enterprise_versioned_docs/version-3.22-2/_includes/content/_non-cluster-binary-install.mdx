import NonClusterReadOnlyStep from '@site/calico-enterprise_versioned_docs/version-3.22-2/_includes/content/_non-cluster-read-only-step.mdx';
import EnvironmentFile from '@site/calico-enterprise_versioned_docs/version-3.22-2/_includes/components/EnvironmentFile';
...
1. Confirm that the image has loaded by typing `docker images`.
   ...
   $[registry]$[releases.0.components.node.image]      $[releases.0.components.node.version]        e07d59b0eb8a   2 minutes ago   42MB
   ```
