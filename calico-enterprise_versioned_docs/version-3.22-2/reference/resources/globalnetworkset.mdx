---
description: Reference for the GlobalNetworkSet resource in Calico Enterprise that defines a cluster-scoped set of CIDRs referenced by tiered network policy.
---

# Global network set

import DomainNames from '@site/calico-enterprise_versioned_docs/version-3.22-2/_includes/content/_domain-names.mdx';
