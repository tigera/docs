...
import DownloadOpenShiftManifests from '@site/calico-enterprise_versioned_docs/version-3.22-2/_includes/components/DownloadOpenShiftManifests.js';
import InstallOpenShiftHCPResources from '@site/calico-enterprise_versioned_docs/version-3.22-2/_includes/components/InstallOpenShiftHCPResources.js';
