---
description: Upgrade from a manifest-installed Calico Open Source cluster to Calico Enterprise on Kubernetes.
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';
import UpgradeOperatorSimple from '@site/calico-enterprise_versioned_docs/version-3.22-2/_includes/components/UpgradeOperatorSimple';
