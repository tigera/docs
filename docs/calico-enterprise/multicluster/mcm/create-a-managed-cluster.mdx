...
- A [{{prodname}} license and pull secret](../../getting-started/calico-enterprise.mdx)
...
<InstallGeneric prodname='{{prodname}}' clusterType="managed" />

</TabItem>
<TabItem label="GKE" value="GKE-1">

<InstallGKE prodname='{{prodname}}' clusterType="managed" />

</TabItem>
<TabItem label="EKS" value="EKS-2">

<InstallEKS prodname='{{prodname}}' clusterType="managed" />

</TabItem>
<TabItem label="AKS" value="AKS-3">

<InstallAKS prodname='{{prodname}}' clusterType="managed" />

</TabItem>
<TabItem label="Openshift" value="Openshift-4">

<InstallOpenShift prodname='{{prodname}}' prodnameWindows='{{prodnameWindows}}' rootDirWindows='{{rootDirWindows}}' clusterType="managed" />
