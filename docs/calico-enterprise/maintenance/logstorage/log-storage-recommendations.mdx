...
- Red health: There is a serious issue with your cluster, check the [troubleshoot page](../../visibility/troubleshoot.mdx)
...
- [Troubleshooting Elasticsearch](../../visibility/troubleshoot.mdx)
- [LogStorage Specification](/reference/installation/api#operator.tigera.io/v1.LogStorage)
