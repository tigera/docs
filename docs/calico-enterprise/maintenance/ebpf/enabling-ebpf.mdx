...
- Distributions:
  ...
  - AKS with limitations:
    ...
    - [AKS with {{prodname}} networking](../../getting-started/kubernetes/aks#install-aks-with-{{prodnamedash}}-networking) is in testing with the eBPF dataplane. This should be a better solution overall but, at time of writing, the testing was not complete.
...
- Linux distribution/kernel:
  ...
  - Another [supported distribution](/getting-started/kubernetes/requirements) with Linux kernel v5.3 or above.  Kernel v5.8 or above with CO-RE enabled is recommended for better performance. 
