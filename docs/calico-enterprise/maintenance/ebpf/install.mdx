...
- Linux distribution/kernel:
  ...
  - Another [supported distribution](/getting-started/kubernetes/requirements) with Linux kernel v5.3 or above.
...
- Distributions:
  ...
  - RKE: eBPF mode cannot be enabled at install time because RKE doesn't provide
    a stable address for the API server.  However, by following [these instructions](../../maintenance/ebpf/enabling-ebpf.mdx),
