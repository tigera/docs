...
- [Apply policy to Kubernetes nodeports](/security/kubernetes-node-ports)
...
- {{prodname}} cluster IP advertisement
- **HostEndpoints**
- **GlobalNetworkPolicy**
  - applyOnForward
  - preDNAT
...
[Configure Calico to advertise cluster IPs over BGP](/networking/advertise-service-ips).
...
- [Enable service IP advertisement](/networking/advertise-service-ips)
