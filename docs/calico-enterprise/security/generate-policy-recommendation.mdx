...
![Generate a Policy Recommendation](/img/calico-enterprise/generate-policy-recommendation/recommend-policy-screen.png)
...
- To observe the impact of a recommended policy on network traffic without affecting flows, see [Create staged policy](/security/staged-network-policies)
