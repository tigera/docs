...
- You have installed [{{prodname}} for EKS](/getting-started/kubernetes/eks)
...
- You are not using the {{prodname}} [auto hostendpoints feature](/security/kubernetes-nodes), and have not created any [host endpoints](../../../reference/resources/hostendpoint.mdx) that have a `spec.node` value that matches any of your Kubernetes nodes.
...
- [Configure fine-grained access control between VPC endpoints and pods](/security/aws-integration/tiers-and-policy)
