...
- [Install Multus 3.0+ on your Kubernetes cluster](https://github.com/intel/multus-cni/)
  ...
  :::
- [Install and configure calicoctl](/maintenance/clis/calicoctl/) or configure access to [Calico Enterprise Manager UI](../../getting-started/cnx/access-the-manager.mdx)
