...
and for more details see the [node configuration](/reference/node/configuration#ip-autodetection-methods) reference.
...
- For details on autodetection methods, see the [node configuration](/reference/node/configuration) reference.
- For calicoctl environment variables, see [Configuring {{nodecontainer}}](/reference/node/configuration)
