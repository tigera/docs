...
|-----------------|------------------------------------------------|----------|-----------------|-----------|
| reportType      | The type of report to produce.  This field controls the content of the report - see the links for each type for more details. | Yes | [cis&#8209;benchmark](/reference/compliance-reports/cis-benchmark), [inventory](/reference/compliance-reports/inventory), [network&#8209;access](/reference/compliance-reports/network-access), [policy&#8209;audit](../compliance-reports/policy-audit.mdx) | string |
...
> Server](/visibility/elastic/kube-audit) to send audit logs for Kubernetes-owned resources
> to Elasticsearch.
