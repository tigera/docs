...
| Field | Description | Type | Required |
|---|---|---|---|
| name | Name specifies the AnomalyDetection Detector to run. The name has to match a detector ID which can be found in the [Anomaly detection reference page](../anomaly-detection/all-detectors.mdx). | string | yes |
