...
A {{prodname}} [Kubernetes controllers](/reference/kube-controllers/configuration) configuration resource (`KubeControllersConfiguration`) represents configuration options for the {{prodname}} Kubernetes controllers.
