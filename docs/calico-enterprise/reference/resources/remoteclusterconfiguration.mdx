...
For the meaning of the fields matches the configuration used for configuring `calicoctl`, see [Kubernetes datastore](../../maintenance/clis/calicoctl/configure/datastore.mdx) instructions for more details.
