...
is configured correctly, follow the [Configuring IP-in-IP guide](/networking/vxlan-ipip)
...
1. Follow the instructions to install [{{prodname}} on AWS](/getting-started/kubernetes/aws).
