...
Options:
  -h --help                Show this screen.
     ...
     --node-image=<DOCKER_IMAGE_NAME>
                           ...
                           [default: {{page.registry}}{{imageNames["node"]}}:latest]
     --backend=(bird|none)
...
When {{prodname}} is configured to use the Kubernetes API as the datastore, BGP routing is *currently*
...
[Configuring `{{nodecontainer}}`](/reference/node/configuration).
...
-  [Installing calicoctl](../../../maintenance/clis/calicoctl/install.mdx)
