...
See [Installing calicoq](../../../maintenance/clis/calicoq/index.mdx) for
...
For more detail, see
[Configuring calicoq](../../../maintenance/clis/calicoq/configure/index.mdx).
