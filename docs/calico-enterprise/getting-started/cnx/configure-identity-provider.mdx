...
The {{prodname}} authentication method is configured through the [Authentication API resource](/reference/installation/api#operator.tigera.io/v1.Authentication) named, `tigera-secure`.
