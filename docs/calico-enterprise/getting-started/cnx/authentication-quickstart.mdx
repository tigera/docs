...
Make sure you have installed {{prodname}} using one of the [installation guides](/getting-started/) and have set up [access to the Manager UI](access-the-manager.mdx).
