...
Review [Log storage recommendations](../maintenance/logstorage/log-storage-recommendations.mdx) for guidance on the number of nodes and resources to configure for your environment.
...
- [Adjust size of Elasticsearch cluster](../maintenance/logstorage/adjust-log-storage-size.mdx)
