...
<GeekDetails prodname='{{prodname}}' details='Policy:Calico,IPAM:Host Local,CNI:Calico,Overlay:No,Routing:VPC Native,Datastore:Kubernetes' />
...
<InstallGKE prodname='{{prodname}}' clusterType="standalone" />
