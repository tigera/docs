...
- Your MKE cluster meets the [{{prodname}} system requirements](/getting-started/kubernetes/requirements)
...
1. Install any extra [{{prodname}} resources](/reference/resources) needed at cluster start using [calicoctl](../../../reference/calicoctl/overview.mdx).
...
- [Configure an external identity provider](../../cnx/configure-identity-provider.mdx)
