...
- A compatible [Rancher Kubernetes Engine cluster](https://rancher.com/docs/rke/latest/en/) with version 1.3.3 and later. Note that RKE2 is a different Kubernetes distribution and [documented separately](/getting-started/kubernetes/rke2).
...
- RKE cluster meets the [{{side.prodname}} requirements](/getting-started/kubernetes/requirements)
