...
Although {{prodname}} requires a Kubernetes control plane to function, you may want to install the node components on [non-cluster hosts](/getting-started/install-on-clusters/bare-metal/) to consistently secure all of your infrastructure. 
