...
To learn how to restrict traffic to/from hosts using {{prodname}} network policy see, [Protect hosts](/security/protect-hosts). 
...
- Non-cluster host meets {{prodname}} [system requirements](/getting-started/bare-metal/about) 
