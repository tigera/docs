...
- [Push {{prodname}} images to your private registry](#push-{{prodname | slugify}}-images-to-your-private-registry-image-path)
...
See [the Installation resource reference page](/reference/installation/api) for more information on the `imagePullSecrets`, `registry` and `imagePath` fields.
