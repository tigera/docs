...
- A compatible [Rancher Kubernetes Engine cluster](https://rancher.com/docs/rke/latest/en/) with version 1.3.3. (RKE2 is a different Kubernetes distribution and [documented separately](/getting-started/install-on-clusters/kubernetes/rke2/)).
...
- RKE cluster meets the [{{side.prodname}} requirements](/getting-started/install-on-clusters/kubernetes/requirements/)
