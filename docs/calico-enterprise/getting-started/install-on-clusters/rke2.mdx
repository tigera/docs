...
<GeekDetails prodname='{{prodname}}' details='Policy:Calico,IPAM:Calico,CNI:Calico,Overlay:VXLAN,Routing:BGP,Datastore:Kubernetes' />

## Before you begin

**Required**

- RKE2 cluster meets the [{{side.prodname}} requirements](/getting-started/install-on-clusters/kubernetes/requirements/)

- A compatible [RKE2 cluster](https://docs.rke2.io/).
  - The version of RKE2 aligns with the [{{side.prodname}} Kubernetes versions requirements](/getting-started/install-on-clusters/kubernetes/requirements/)
