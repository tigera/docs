...
- Your MKE cluster meets the [{{prodname}} system requirements](/getting-started/install-on-clusters/kubernetes/requirements/)
...
- [Configure an external identity provider](../../maintenance/cnx/configure-identity-provider.mdx)
