...
Review the [Linux requirements](/getting-started/kubernetes/requirements) and the [{{prodnameWindows}} requirements](/getting-started/windows-calico/kubernetes/requirements).
...
The following steps install a Kubernetes cluster on a single Windows node with a [minimum](/getting-started/kubernetes/requirements#node-requirements) of 4 Linux worker nodes.
...
In addition to the [{{prodnameWindows}} requirements](/getting-started/windows-calico/kubernetes/requirements),
...
You can now use the {{prodname}} Linux-based docs site for your documentation. Before you continue, review the [Limitations and known issues](/getting-started/windows-calico/limitations) to understand the features (and sections of documentation) that do not apply to Windows.
