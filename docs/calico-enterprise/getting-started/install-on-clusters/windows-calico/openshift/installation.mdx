...
<InstallOpenshiftBeforeYouBegin prodname='{{prodname}}' prodnameWindows='{{prodnameWindows}}' clusterOS="hybrid" />
...
<InstallOpenShift prodname='{{prodname}}' prodnameWindows='{{prodnameWindows}}' rootDirWindows='{{rootDirWindows}}' clusterType="standalone" clusterOS="hybrid" />
