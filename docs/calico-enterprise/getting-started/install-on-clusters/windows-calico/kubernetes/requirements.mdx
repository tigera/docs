...
See the [Kubernetes requirements](/getting-started/install-on-clusters/kubernetes/requirements/#kubernetes-requirements).
...
- At least four Linux Kubernetes worker nodes to run {{prodname}}'s cluster-wide components that meets [Linux system requirements](/getting-started/install-on-clusters/kubernetes/requirements/), and is installed with {{prodname}} v3.5.0+
