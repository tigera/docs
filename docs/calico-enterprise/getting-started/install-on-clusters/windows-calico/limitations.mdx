...
| Feature                        |                                                              |
| ------------------------------ | ------------------------------------------------------------ |
| Distributions                  | **Supported:**<br />- EKS<br />- AWS<br />- GCE<br />- Azure<br />- AKS (via [upgrade from Calico](/maintenance/upgrade-to-tsee))<br />- Kubernetes on-premises<br />- OpenShift<br />- Rancher Kubernetes Engine (RKE) |
...
- [Quickstart](/getting-started/windows-calico/quickstart)
- [Standard install](/getting-started/windows-calico/kubernetes/standard)
