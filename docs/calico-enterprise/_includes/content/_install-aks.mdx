...
<GeekDetails prodname='{{prodname}}' details='Policy:Calico,IPAM:Azure,CNI:Azure,Overlay:No,Routing:VPC Native,Datastore:Kubernetes' />
{% endif %}

#### Create an AKS cluster

Make sure you have a [compatible](/getting-started/install-on-clusters/kubernetes/aks/) AKS cluster with:
