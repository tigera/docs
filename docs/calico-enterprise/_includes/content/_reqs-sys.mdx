...
Ensure that your hosts and firewalls allow the necessary traffic based on your configuration. See [Component architecture](../../reference/architecture/overview.mdx) to view the following components. 
