...
1. [Configure storage for {{prodname}}](../../maintenance/logstorage/create-storage.mdx).
...
1. (Optional) If your cluster architecture requires any custom [{{prodname}} resources](../../reference/resources/index.mdx) to function at startup, install them now using [calicoctl](../../reference/clis/calicoctl/overview.mdx).
