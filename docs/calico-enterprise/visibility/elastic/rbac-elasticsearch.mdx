...
- A `tigera-network-admin` role with full permissions to create and modify resources. For help, see [Log in to {{prodname}} Manager](../../getting-started/cnx/authentication-quickstart.mdx).

- To view Elasticsearch resources in {{prodname}} Manager, users must have [minimum permissions](/security/rbac-tiered-policies).
...
- Configure [RBAC for tiered policies](/security/rbac-tiered-policies).
