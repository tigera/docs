...
- [LogStorage](/reference/installation/api#operator.tigera.io/v1.LogStorage). It has settings for:
...
- [StorageClasses](../getting-started/create-storage.mdx)
