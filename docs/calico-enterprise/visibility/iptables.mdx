...
[Network Policy](/reference/resources/networkpolicy) or [Global Network Policy](../reference/resources/globalnetworkpolicy.mdx).
...
See the
[Felix configuration reference](/reference/felix/configuration#{{prodnamedash}}-specific-configuration) for
...
Note that [Denied Packet Metrics](../maintenance/monitor/metrics/index.mdx) are independent of the `DropActionOverride`
