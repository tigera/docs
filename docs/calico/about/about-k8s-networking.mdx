...
addresses](/networking/advertise-service-ips), allowing services to be conveniently accessed without
...
allows you to [configure outgoing NAT](/networking/workloads-outside-cluster) for specific IP address
