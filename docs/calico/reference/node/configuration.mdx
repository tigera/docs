...
BGP configuration for Calico nodes is normally configured through the [Node](/reference/resources/node), [BGPConfiguration](/reference/resources/bgpconfig), and [BGPPeer](../resources/bgppeer.mdx) resources.
...
also used to associate the node with per-node [BGP configuration](/reference/resources/bgpconfig), [felix configuration](../resources/felixconfig.mdx), and endpoints.
...
in the cluster, see [decommissioning a node](../../maintenance/decommissioning-a-node.mdx).
