...
{{prodname}} is installed and configured automatically in your [IBM Cloud Kubernetes Service][IBMKUBE].  Default policies are created to protect your Kubernetes cluster, with the option to create your own policies to protect specific services.
...
[IPIP]: /networking/configuring/vxlan-ipip/[IBMKUBE]: https://www.ibm.com/cloud/container-service/
