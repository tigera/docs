...
- **Azure user-defined routes**: This option provides networking without overlays.
  ...
  [Configuring {{nodecontainer}}](../node/configuration) and [Azure user-defined routes](#azure-user-defined-routes) for more information. If you're on Kubernetes, see [Self-managed-public-cloud)](../../getting-started/kubernetes/self-managed-public-cloud/index.mdx).
