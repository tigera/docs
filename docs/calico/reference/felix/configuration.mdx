...
| `SidecarAccelerationEnabled`      | `FELIX_SIDECARACCELERATIONENABLED`      | Enable experimental acceleration between application and proxy sidecar when using [application layer policy](../../security/istio/app-layer-policyindex.mdx). [Default: `false`] | boolean |
