...
Install {{prodname}} by using the following command.
   ...
   You can also
   [view the YAML in a new tab]({{data.versions.first.manifests_url}}/manifests/calico.yaml).
...
## Next steps
- Try running the [Kubernetes Network policy demo](/security/tutorials/kubernetes-policy-demo/kubernetes-demo) to see live graphical view of network policy in action
