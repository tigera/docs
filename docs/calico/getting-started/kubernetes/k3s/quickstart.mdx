...
## Next steps
- Try running the [Kubernetes Network policy demo](../../../security/get-started/kubernetes-policy/kubernetes-demo.mdx) to see live graphical view of network policy in action
