...
[Follow the instructions here](../../../security/istio/app-layer-policyindex.mdx) to enable application layer policy, install Istio, update the
...
You can test application layer policy by following the [Application Layer Policy tutorial](../../../security/istio/enforce-policy-istio.mdx).
