...
<ReqsSys prodname='{{prodname}}' orch="Kubernetes" />

## Kubernetes requirements

#### Supported versions

We test {{prodname}} {{page.version}} against the following Kubernetes versions.

- v1.22
- v1.23
- v1.24

Due to changes in the Kubernetes API, {{prodname}} {{page.version}} will not work
...
- `ipvs` Requires Kubernetes >=v1.9.3. Refer to
  [Enabling IPVS in Kubernetes](../../networking/enabling-ipvs.mdx) for more details.
