...
1. Install the {{prodname}} manifest.
   ...
   ```bash
   kubectl apply -f {{data.versions.first.manifests_url}}/manifests/calico-vxlan.yaml
   ```
...
**Required**
- [Install calicoctl command line tool](../../../maintenance/calicoctl/install.mdx)
...
- [Get started with Kubernetes network policy](../../../security/get-started/kubernetes-policy/kubernetes-network-policy.mdx)
- [Get started with {{prodname}} network policy](../../../security/get-started/calico-policy/calico-network-policy.mdx)
- [Enable default deny for Kubernetes pods](../../../security/get-started/kubernetes-default-deny.mdx)
