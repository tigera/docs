...
- Install and configure [calicoctl](../../../maintenance/clis/calicoctl/index.mdx)
...
1. Modify VXLAN as described in [Customize the manifests](../../kubernetes/installation/config-options.mdx) guide. Note the following:
