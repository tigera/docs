...
See the [Kubernetes requirements](../../kubernetes/requirements.mdx#kubernetes-requirements).
...
- At least one Linux Kubernetes worker node to run {{prodname}}'s cluster-wide components that meets [Linux system requirements](../../kubernetes/requirements.mdx), and is installed with {{prodname}} v3.12+.
