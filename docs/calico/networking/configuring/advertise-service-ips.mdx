...
**Required**
- [Configure BGP peering](/networking/bgp) between {{prodname}} and your network infrastructure
...
1. Determine the service cluster IP range.  (Or ranges, if your cluster is [dual stack](/networking/ipv6).)
...
- [Apply policy to services exposed externally as cluster IPs](/security/services-cluster-ips)
