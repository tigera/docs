...
For help on using IP in IP and/or VXLAN overlays, see [Configure overlay networking](/networking/vxlan-ipip).

For help on using WireGuard encryption, see [Configure WireGuard encryption](../../security/encrypt-cluster-pod-traffic.mdx).
