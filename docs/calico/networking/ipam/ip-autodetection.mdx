...
- [Changes to cross subnet packet encapsulation](/networking/vxlan-ipip)
...
For more details on autodetection methods, see [node configuration](../../reference/node/configuration.mdx) reference.
...
- For details on autodetection methods, see the [node configuration](../../reference/node/configuration.mdx) reference.
