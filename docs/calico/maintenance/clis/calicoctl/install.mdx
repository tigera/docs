...
```bash
docker pull {{page.registry}}{{page.imageNames["calicoctl"]}}:{{data.versions.first.title}}
```
...
- **etcd**
  ...
  ```bash
  kubectl apply -f {{data.versions.first.manifests_url}}/manifests/calicoctl-etcd.yaml
  ```

  :::note

  You can also
  [view the YAML in a new tab]({{data.versions.first.manifests_url}}/manifests/calicoctl-etcd.yaml).
...
- **Kubernetes API datastore**
  ...
  ```bash
  kubectl apply -f {{data.versions.first.manifests_url}}/manifests/calicoctl.yaml
  ```

  :::note

  You can also
  [view the YAML in a new tab]({{data.versions.first.manifests_url}}/manifests/calicoctl.yaml).
