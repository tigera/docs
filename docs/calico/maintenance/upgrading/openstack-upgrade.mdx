...
This page describes how to upgrade to {{page.version}} from {{prodname}} v3.0 or later. The procedure
...
1. On all nodes, change the location of the {{prodname}} packages to point to the {{page.version}} repo:
