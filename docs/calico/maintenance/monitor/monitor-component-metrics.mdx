...
For more information about calicoctl please use [this link](../clis/calicoctl/install.mdx).
...
A list of Felix metrics can be [found at this link](/reference/felix/prometheus). Similar lists can be found for [kube-controllers](/reference/kube-controllers/prometheus) and [Typha](../../reference/typha/prometheus.mdx).
...
If you enable {{prodname}} metrics to Prometheus, a best practice is to use network policy to limit access to the {{prodname}} metrics endpoints. For details, see [Secure {{prodname}} Prometheus endpoints](../../security/comms/secure-metrics.mdx).
