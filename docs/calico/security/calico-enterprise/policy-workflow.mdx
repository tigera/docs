...
![policy-workflow](/img/calico/policy-workflow.png)
...
![policy-recommendation](/img/calico/policy-recommendation.png)
...
![policy-builder](/img/calico/policy-builder.png)
...
![policy-options](/img/calico/policy-options.png)
