...
## Before we begin
If you haven't already, you will need to [install calicoctl](../../maintenance/clis/calicoctl/install.mdx) to apply the example {{prodname}} network policies from this page.
