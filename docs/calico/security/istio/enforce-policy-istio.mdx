...
3. Install the [calicoctl command line tool](../../maintenance/clis/calicoctl/install.mdx).
  **Note**: Ensure calicoctl is configured to connect with your datastore.
4. [Enable application layer policy](/security/app-layer-policy).
...
You can also
[view the manifest in your browser](manifests/10-yaobank.yaml).
...
You can also
[view the manifest in your browser](manifests/30-policy.yaml).
