...
Follow the instructions to [Enable application layer policy](/security/app-layer-policy).
...
The final step to establishing your Zero Trust Network is to write the policies for each service in your network. The [Application Layer Policy Tutorial](/security/tutorials/app-layer-policy/enforce-policy-istio) gives an overview of setting up policies that allow traffic based on Service Account identity.
...
- [Protect hosts](/security/protect-hosts)
- [Global network policy](../reference/resources/globalnetworkpolicy.mdx)
- [Network policy](../reference/resources/networkpolicy.mdx)
- <EnterpriseLink href='calico-enterprise/network-visibility'>Network visibility with Calico Enterprise</EnterpriseLink>
- <EnterpriseLink href='calico-enterprise/egress-access-controls'>Advanced egress access controls with Calico Enterprise</EnterpriseLink>
- <EnterpriseLink href='calico-enterprise/compliance'>Advanced compliance controls with Calico Enterprise</EnterpriseLink>
- <EnterpriseLink href='calico-enterprise/federation'>Federation</EnterpriseLink>
- <EnterpriseLink href='calico-enterprise/threat-defense'>Threat defense</EnterpriseLink>
- <EnterpriseLink href='calico-enterprise/user-console'>Calico Enterprise user console</EnterpriseLink>
