...
For OpenShift, add the Felix configuration with WireGuard enabled [under custom resources](../getting-started/openshift/installation.mdx#optionally-provide-additional-configuration).
