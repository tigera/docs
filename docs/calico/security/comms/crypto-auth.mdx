...
- Configure each {{prodname}} component to verify the etcd server's identity and to present
  ...
  - [{{nodecontainer}}](../../reference/node/configuration.mdx)
  - [`calicoctl`](../../maintenance/clis/calicoctl/configure/etcd.mdx)
  - [CNI plugin](../../reference/cni-plugin/configuration.mdx#etcd-location) (Kubernetes and OpenShift only)
