...
![calico-cloud](/img/calico/calico-cloud-small.png)
...
#### Don't have a {{prodname}} cluster? Easy...

[Try it now](https://www.tigera.io/tigera-products/cloud-trial)

#### Already have a {{prodname}} cluster? You are **5 minutes** away from connecting to Calico Cloud. 

1. Verify that your [cluster is compatible](https://docs.calicocloud.io/get-started/connect/system-requirements). Want to know what happens when you connect/disconnect your cluster to Calico Cloud? See [Connect your cluster to Calico Cloud](https://docs.calicocloud.io/get-started/connect/connect-cluster).

1. Identify the cluster you want to use and apply the following manifest.

   You can use any {{prodname}} operator-installed cluster. Ensure `kubectl` is connected to it, and then execute the following:
...
1. Accept your invite to join {{prodname}}.
