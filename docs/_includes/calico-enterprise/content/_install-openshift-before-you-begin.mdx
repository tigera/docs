...
- Your environment meets the {{prodname}} [system requirements](/getting-started/openshift/requirements)

- [Private registry credentials and license key](../../../calico-enterprise/getting-started/calico-enterprise.mdx)
