...
Selectors can match [workload endpoints](../../../calico-enterprise/reference/resources/workloadendpoint.mdx), host endpoint and 
([namespaced](../../../calico-enterprise/reference/resources/networkset.mdx) or
[global](../../../calico-enterprise/reference/resources/globalnetworkset.mdx)) network sets.  
