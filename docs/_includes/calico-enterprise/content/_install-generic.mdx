...
1. [Configure storage for {{prodname}}](../../../calico-enterprise/getting-started/create-storage.mdx).
...
1. (Optional) If your cluster architecture requires any custom [{{prodname}} resources](/reference/resources) to function at startup, install them now using [calicoctl](../../../calico-enterprise/reference/calicoctl/overview.mdx).
