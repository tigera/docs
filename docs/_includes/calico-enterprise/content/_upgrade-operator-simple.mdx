...
1. If your cluster has OIDC login configured, follow these steps:
   ...
   ```
   If both of these resources are present, you can continue with the next step. Otherwise, use the instructions to [configure an identity provider](../../../calico-enterprise/getting-started/cnx/configure-identity-provider.mdx) to configure OIDC.

   d) Follow [configure an identity provider](../../../calico-enterprise/getting-started/cnx/configure-identity-provider.mdx).
