...
Calico now supports BGP communities! Check out the BGP configuration resource [reference](../../../calico-enterprise/reference/resources/bgpconfig.mdx#communities) for more details. We've also added custom BGP port configuration.
