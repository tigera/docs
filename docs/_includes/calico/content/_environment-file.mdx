...
{%- if include.install == "container" %}
 [{{nodecontainer}} configuration reference](../../../calico/reference/node/configuration.mdx).
{% else %}
 [Felix configuration reference](../../../calico/reference/felix/configuration.mdx).
{% endif %}

<Tabs>
<TabItem label="Kubernetes datastore" value="Kubernetes datastore-0">
...
<TabItem label="etcd datastore" value="etcd datastore-1">
...
<TabItem label="Either datastore" value="Either datastore-2">
