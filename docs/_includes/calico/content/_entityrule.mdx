...
Selectors can match [workload endpoints](../../../calico/reference/resources/workloadendpoint.mdx), host endpoint and 
([namespaced](../../../calico/reference/resources/networkset.mdx) or
[global](../../../calico/reference/resources/globalnetworkset.mdx)) network sets.  
