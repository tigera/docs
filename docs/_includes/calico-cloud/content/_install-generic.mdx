...
1. Install your pull secret.
   ...
   ```
1. (Optional) If your cluster architecture requires any custom [{{prodname}} resources](/reference/resources) to function at startup, install them now using [calicoctl](/reference/calicoctl/overview).
