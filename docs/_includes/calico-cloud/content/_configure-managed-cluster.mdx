...
1. Add a managed cluster and save the manifest containing a [ManagementClusterConnection](/reference/installation/api#operator.tigera.io/v1.ManagementClusterConnection) and a Secret.
   ```bash
