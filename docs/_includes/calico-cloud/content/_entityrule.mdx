...
Selectors can match workload endpoints, host endpoint and 
([namespaced](../../../calico-cloud/reference/resources/networkset.mdx) or
[global](../../../calico-cloud/reference/resources/globalnetworkset.mdx)) network sets.  
