...
- Experience using [{{prodname}} tiers](/reference/resources/tier) and [Global network policy](../../../reference/resources/globalnetworkpolicy.mdx)
...
1. Create a tier for organizing global network policies.
    ...
    Create a new [Tier](../../../get-started/tutorials/policy-tiers.mdx) to organize all Fortigate firewall global network policies in a single location. 
...
- [Extend FortiManager firewall policies to Kubernetes](/security/fortinet-integration/fortimgr-integration)
