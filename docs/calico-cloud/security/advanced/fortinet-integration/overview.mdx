---
title: Determine the best Fortinet integration solution
description: Learn how to integrate Kubernetes clusters with existing Fortinet firewall workflows.
---
...
- [Extend Kubernetes to Fortinet firewall devices](/security/fortinet-integration/firewall-integration)
