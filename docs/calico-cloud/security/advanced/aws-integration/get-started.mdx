...
![aws-vpc](/img/calico-cloud/aws-security-groups/aws-security-groups.png)

With {{prodname}}, you can extend AWS security groups to pods, 

![aws-goal](/img/calico-cloud/aws-security-groups/aws-pods.png)

and use network policy and annotations to secure and control access to VPC resources.

![ingress-egress](/img/calico-cloud/aws-security-groups/ingress-egress.png) 
...
- [Configure {{prodname}} AWS security groups integration](/security/aws-integration/aws-security-group-integration)
