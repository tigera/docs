...
![Navigate to Policy Recommendation](/img/calico-cloud/generate-policy-recommendation/recommend-policy-action-bar.png)
...
![Generate a Policy Recommendation](/img/calico-cloud/generate-policy-recommendation/recommend-policy-screen.png)
...
![Preview or Stage a Policy Recommendation](/img/calico-cloud/generate-policy-recommendation/create-policy-action-buttons.png)
