...
- Configure Felix for log data collection
  ...
  Configure L7 log aggregation, retention, and reporting. See the [Felix Configuration documentation](../../../reference/felix/configuration.mdx) for details.
...
1. Create or update the [ApplicationLayer](/reference/installation/api#operator.tigera.io/v1.ApplicationLayer)
