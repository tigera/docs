...
For more examples of using network sets, see [Secure egress access from workloads to destinations outside the cluster](/workload-access/applications/egress-controls), and [Understanding network sets](networksets.mdx).
