...
the new IP addresses. This limitation can be circumvented using {{prodname}} [Use external IPs or networks rules in policy](../../security/beginners/external-ips-policy.mdx), or [DNS policy](../../security/beginners/domain-based-policy.mdx) in policy rules.
...
- [Use external IPs or networks rules in policy](../../security/beginners/external-ips-policy.mdx)
