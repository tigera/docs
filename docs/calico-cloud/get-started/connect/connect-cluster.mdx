...
![connect-disconnect](/img/calico-cloud/connect-disconnect.png)
...
For details of the migration script, see [Uninstall {{prodname}} from a cluster]({{sitebase.url}}/operations/disconnect).
