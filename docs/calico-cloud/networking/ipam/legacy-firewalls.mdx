...
Also, cluster administrators must have [configured IP pools](../../reference/resources/ippool.mdx) to define the valid IP ranges to use for allocating pod IP addresses.
...
For help configuring {{prodname}} IPAM, see [Configuring the {{prodname}} CNI Plugins](../../reference/cni-plugin/configuration.mdx). 
