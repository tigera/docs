...
- [Private registry credentials and license key](/getting-started/calico-enterprise)
...
- OpenShift installer **v4.6 or 4.8** and OpenShift command line interface from [cloud.redhat.com](https://cloud.redhat.com/openshift/install/aws/installer-provisioned)
