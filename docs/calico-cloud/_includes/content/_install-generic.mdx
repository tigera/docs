...
1. [Configure storage for {{prodname}}](/getting-started/create-storage).
...
1. Install your pull secret.
   ...
   ```
1. (Optional) If your cluster architecture requires any custom [{{prodname}} resources](../../reference/resources/index.mdx) to function at startup, install them now using [calicoctl](/reference/calicoctl/overview).
...
Install the following network policies to secure {{prodname}} component communications.
