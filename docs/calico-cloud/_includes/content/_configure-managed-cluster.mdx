...
1. Add a managed cluster and save the manifest containing a [ManagementClusterConnection](../../reference/installation/api.mdx#operator.tigera.io/v1.ManagementClusterConnection) and a Secret.
   ```bash
...
1. Secure {{prodname}} on the managed cluster with network policy.
