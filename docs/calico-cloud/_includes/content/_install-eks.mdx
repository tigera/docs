...
- [A supported {{prodname}} managed Kubernetes version](/getting-started/kubernetes/requirements#supported-managed-kubernetes-versions).
...
1. Install any extra [{{prodname}} resources](../../reference/resources/index.mdx) needed at cluster start using [calicoctl](/reference/calicoctl/overview).
