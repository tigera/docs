...
Calico now supports BGP communities! Check out the BGP configuration resource [reference](/reference/resources/bgpconfig#communities) for more details. We've also added custom BGP port configuration.
