---
description: Suppress low-value Calico Enterprise DNS log entries with Fluent Bit filters configured through a ConfigMap in the operator namespace.
---
...
For the release-level summary of what changes, see the [release notes](../../../release-notes/index.mdx).
