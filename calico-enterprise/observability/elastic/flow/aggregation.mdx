...
#### Level 3: aggregate IPs, source and destination ports
...
|                          |           | **Source Traffic**  | |          | **Destination Traffic**  | |          | **Packet counts**      | |
|--------------------------|-----------|----------|---------|----------|----------|---------|----------|------------|-------------|
| **Aggr level**             | **Flows** | **Name** | **IP**  | **Port** | **Name** | **IP**  | **Port** | **Pkt in** | **Pkt out** |
...
| 1 (source port)             | 3         | client-a | 1.1.1.1 | -        | `nginx-1`  | 2.2.2.2 | 80       | 2          | 5           |
...
| 3 (+destination port)           | 1         | client-* | -       | -        | `nginx-*`  | -       | -        | 7          | 11          |
