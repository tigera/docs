...
- Calico Enterprise v3.23 EP2 or later on both the management and managed clusters.
- `calicoctl` v3.23 EP2 or later (for CLI access).
...
The ps output includes contextual warnings when relevant:
