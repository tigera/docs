...
- Pods can communicate with all other pods in the cluster using pod IP addresses (without
  [NAT]({{site.baseurl}}/networking/training/about-networking))
...
Kubernetes network implementations use [overlay networks]({{site.baseurl}}/networking/training/about-networking#overlay-networks).
