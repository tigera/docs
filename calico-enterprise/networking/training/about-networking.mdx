...
You can get up and running with {{site.prodname}} by following any of the {{site.prodname}} [install
guides]({{site.baseurl}}/getting-started/) without needing to be a networking expert. {{site.prodname}} hides the complexities for
