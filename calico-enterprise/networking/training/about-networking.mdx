...
guides](../../getting-started/index.mdx) without needing to be a networking expert. {{prodname}} hides the complexities for
...
![OSI network layers diagram](/img/calico-enterprise/master/osi-network-layers.svg)
...
![Anatomy of a network packet](/img/calico-enterprise/master/anatomy-of-a-packet.svg)
...
![Anatomy of an overlay network packet](/img/calico-enterprise/master/anatomy-of-an-overlay-packet.svg)
