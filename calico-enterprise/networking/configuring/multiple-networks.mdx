...
- [Install and configure calicoctl](../../operations/clis/calicoctl/index.mdx) or configure access to [Calico Enterprise Manager UI](/operations/cnx//access-the-manager/)
