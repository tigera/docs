...
- [Configure namespaces or pods to use egress gateways](#configure-namespaces-or-pods-to-use-egress-gateways)
...
```bash
kubectl annotate ns  egress.projectcalico.org/namespaceSelector="projectcalico.org/name == ''"
```
