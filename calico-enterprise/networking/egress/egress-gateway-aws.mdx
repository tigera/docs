...
- [Configuring namespaces or pods to use egress gateways](#configuring-namespaces-or-pods-to-use-egress-gateways)
...
#### Configure a namepace or pod to use an egress gateway (annotation method)
