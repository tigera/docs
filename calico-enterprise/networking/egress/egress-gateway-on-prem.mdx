...
- [Domain-based policy](../../security/domain-based-policy.mdx) is not supported at egress from egress
...
```bash-plain-text
kubectl apply -f {{url}}{{baseUrl}}/manifests/rancher/custom-psp-rke2-cis-hardened.yaml
```
