...
1. OR dest_domains = "www.calico.org"
...
The flows with `dest_domains = "www.calico.org"` was mapped and generated the rule:
```
Allow:Protocol is TCP
To:Ports [Port is 80 ]  Domains [www.calico.org, www.google.com, www.tigera.io]  
```
