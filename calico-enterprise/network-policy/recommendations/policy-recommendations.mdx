...
:::note
There are several legitimate reasons why you may not get policy recommendations, especially if you have put a default-deny policy in the default tier. If you are not getting any policy recommendations and want to test the tool, see [Troubleshoot policy recommendations](#troubleshoot-policy-recommendations).
:::
