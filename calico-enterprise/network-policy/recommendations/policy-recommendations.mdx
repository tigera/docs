...
- **Stabilization period** is the time (default 10 minutes) to capture enough flow logs to/from the namespace so a policy recommendation is an accurate reflection of the traffic. 
