...
- **Stabilization period** is the time that a recommended policy remains unchanged and stable so it can be enforced.

- **Interval** is the frequency to run the policy recommendation to create and refine recommended policies. 
