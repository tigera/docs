...
The AdminNetworkPolicy tier where is all Kubernetes admin network policies reside. It is automatically created during installation and has the order of 1,000.
