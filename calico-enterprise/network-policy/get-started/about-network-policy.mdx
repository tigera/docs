...
![Example mix of network policy types](/img/calico-enterprise/3.14/example-k8s-calico-policy-mix.svg)
...
![Example tiers](/img/calico-enterprise/3.14/example-tiers.svg)
