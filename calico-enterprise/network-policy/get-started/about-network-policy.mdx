...
![Example mix of network policy types](/img/calico-enterprise/3.15/example-k8s-calico-policy-mix.svg)
...
![Example tiers](/img/calico-enterprise/3.15/example-tiers.svg)
