---
description: Learn how you can apply ALP to your workloads and control ingress traffic.
---

# Enforce application layer policies on your apps (tutorial)

This tutorial demonstrates how to use {{prodname}} application layer policy to mitigate some common threats in a sample banking application.
