...
Policy recommendation automatically creates policies that explicitly allow traffic because of {{site.prodname}}'s [day-one zero trust](/security/policy-best-practices#policy-best-practices-for-day-one-zero-trust) enhanced security posture.
