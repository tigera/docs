...
1. Follow the [quickstart installation](/getting-started/install-on-clusters/kubernetes/quickstart/), making the following changes:
...
1. Create the cluster by following [the standard installation](/getting-started/install-on-clusters/openshift/installation/), with the following caveat:
