...
Ensure that your {{prodname}} OpenShift cluster is running a supported version of [OpenShift Container Platform](/getting-started/compatibility#openshift), and the {{prodname}} operator version is v1.2.4 or greater.
