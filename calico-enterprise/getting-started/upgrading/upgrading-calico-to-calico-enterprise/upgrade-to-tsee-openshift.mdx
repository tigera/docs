...
import InstallOpenShiftManifests from '@site/calico-enterprise/_includes/components/InstallOpenShiftManifests';
import OpenShiftPrometheusOperator from '@site/calico-enterprise/_includes/components/OpenShiftPrometheusOperator';
import OpenShiftPullSecret from '@site/calico-enterprise/_includes/components/OpenShiftPullSecret';
