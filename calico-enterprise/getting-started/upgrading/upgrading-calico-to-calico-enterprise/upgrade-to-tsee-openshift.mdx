...
> (Optional) If your cluster architecture requires any custom [{{prodname}} resources](../../../reference/resources/index.mdx) to function at startup, install them now using [calicoctl](/reference/clis/calicoctl/overview/).
...
2. (Optional) If your cluster architecture requires any custom [Calico resources](../../../reference/resources/index.mdx) to function at startup, install them now using [calicoctl](/reference/clis/calicoctl/overview/).
