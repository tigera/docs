...
1. Install the $[prodname] custom resource definitions.
   ...
   These steps apply to clusters using the aggregation API server, the default for existing and upgraded $[prodname] clusters. Upgrading does not change your cluster's CRD mode. If your cluster uses native v3 CRDs, see [Native v3 CRDs](../../../../operations/native-v3-crds.mdx) before upgrading.
