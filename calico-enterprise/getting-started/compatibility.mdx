...
| -------------------- | ---------------------------- | -------------------------------------------------------------------------------------- |
| 3.24                 | 1.33 - 1.35                  | - $[prodname] CNI with network policy<br />- AWS CNI with $[prodname] network policy |
...
| -------------------- | --------------------------- | ------------------------------------ |
| 3.24                 | 1.34 - 1.36                 | $[prodname] CNI with network policy |
...
| -------------------- | ----------- | ------------------------------------ | ------------------- |
| 3.24                 | MKE 4k 4.1.2     | $[prodname] CNI with network policy | 1.32                |
...
| -------------------- | ----------- | ------------------------------------ | ------------------- |
| 3.24                 | MKE 3.9     | $[prodname] CNI with network policy | 1.34                |
...
| -------------------- | --------------------------------- | ------------------------------------ |
| 3.24                 | 4.20 - 4.22                       | $[prodname] CNI with network policy |
...
| -------------------- | ----------- | ------------------------------------ | ------------------- |
| 3.24                 | 1.8         | $[prodname] CNI with network policy | 1.32                |
...
| -------------------- | ------------------------------------ | ------------------- |
| 3.24                 | $[prodname] CNI with network policy | 1.34 - 1.36         |
...
| -------------------- | ----------- | ------------------------------------ | ------------------- |
| 3.24                 | VKS 3.8     | $[prodname] CNI with network policy | 1.36                |
...
| -------------------- | ----------- | ------------------------------------ | ------------------- |
| 3.24                 | 2.4         | $[prodname] CNI with network policy | 1.27                |
