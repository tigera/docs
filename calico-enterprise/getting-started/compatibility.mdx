...
>**Note**: If your platform is listed below, the features in this release will work for your platform unless an individual feature topic explicitly calls out a vendor or {{site.prodname}} limitation. However, all Windows feature limitations are described in [Windows limitations]({{site.baseurl}}/getting-started/windows-calico/limitations), and are not called out in individual Linux topics.
{: .alert .alert-info}
