...
| Policy                         | - Staged network-policy<br />- Firewall integrations<br />- Policy for hosts (host endpoints, including automatic host endpoints)<br />- Tiered policy: GKE, AKS<br />- WAF integration<br />- AWS firewall integration<br />- Fortinet integration |
