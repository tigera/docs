...
The manual method for installing {{prodnameWindows}} is deprecated in favor of using [Windows HostProcess containers](#install-calico-enterprise-for-windows-using-hostprocess-containers). Support for this method will be dropped in a future {{prodname}} version.
...
#### Migrating from {{prodnameWindows}} installed manually to an HPC installation
