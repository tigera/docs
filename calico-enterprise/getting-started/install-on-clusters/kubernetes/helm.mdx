...
If you are installing on a cluster installed by EKS, GKE, AKS or Mirantis Kubernetes Engine (MKE), or you need to customize
TLS certificates, you **must** customize this Helm chart by creating a `values.yaml` file. Otherwise, you can skip this step.
Detailed information on customizing helm can be found in the [Helm Reference](../../../reference/installation/helm_customization.mdx) page.
...
--set-file imagePullSecrets.tigera-pull-secret=<path/to/pull/secret>,tigera-prometheus-helm_customoperator.imagePullSecrets.tigera-pull-secret=<path/to/pull/secret> \\
