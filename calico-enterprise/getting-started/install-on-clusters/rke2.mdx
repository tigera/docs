...
- {% include open-new-window.html text='Configure cluster with no CNI plugin' url='https://docs.rke2.io/reference/server_config#rke2-server-cli-help' %} using any of these methods:
   - RKE2 CLI: `--cni none` 
   - Install script: `RKE2_CNI=none`
   - {% include open-new-window.html text='Configuration file' url='https://docs.rke2.io/reference/server_config#rke2-server-cli-help' %}: `cni: none`
