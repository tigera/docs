...
Install {{site.prodname}} on an AKS managed Kubernetes cluster, including a Calico AKS cluster using network policy.
...
1. [Option A: Install with Azuure CNI networking](#install-aks-with-azure-cni-networking)
