---
description: Background on running Calico Enterprise on non-cluster hosts and VMs — what is supported, what changes versus a cluster install, and when to use it.
---
