...
- Ensure that your node supports the x86-64 v3 microarchitecture. You can check this via the program interpreter on the node:
  ```bash
...
1. Download the Calico Enterprise repository to work with your Linux distro.
   ...
   1. Copy the file into your apt sources directory:
      ...
      ```
   1. Tell apt to download the updated package index
      ```bash
      sudo apt-get update
      ```
   </TabItem>
