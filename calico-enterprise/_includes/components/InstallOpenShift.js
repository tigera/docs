...
import { prodname, prodnameWindows, prodnamedash, rootDirWindows, baseUrl } from '../../variables';
...
spec:
  ...
  calicoNetwork:
    ...
    - blockSize: 26
      ...
      <p>
        To include <Link href='../../reference/resources'>{prodname} resources</Link> during installation, edit{' '}
  ...
  > manifests/02-configmap-calico-resources.yaml`}
      ...
      {maybeRender(
        ...
        <>
          ...
          <CodeBlock language='bash'>
            curl -O -L {url}
            {baseUrl}/manifests/tigera-enterprise-resources.yaml
          </CodeBlock>
          <p>
    ...
    count: 1`}
      ...
      {maybeRender(
        ...
        <>
          ...
          <CodeBlock language='bash'>oc create -f "/manifests/tigera-enterprise-resources.yaml"</CodeBlock>
        </>
      )}
...
function InstallOpenShiftWindows() {
  return (
    <>
      ...
      <p>
        Next, <Link href='../../maintenance/clis/calicoctl/install'>install calicoctl</Link> and ensure strict affinity
        is true:
      </p>
      ...
      <ol>
        ...
        <li>
          ...
          <CodeBlock language='powershell'>
            ...
            {baseUrl}/scripts/install-calico-windows.ps1 -OutFile c:install-calico-windows.ps1
          </CodeBlock>
        </li>
        <li>
          <p>
