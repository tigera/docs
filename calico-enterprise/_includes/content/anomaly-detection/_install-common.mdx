...
1. Create the GlobalAlert from the manifest.
    ```bash
...
1. Verify that a detection cronjob is created for the GlobalAlert.
...
1. Verify that a training cronjob is created for the cluster.
