...
![expiration](/img/calico-enterprise/master/expiration.png)
...
- [Prometheus!](../../maintenance/monitor/metrics/license-agent.mdx). Monitor days till expiration, nodes available, and nodes used.
