...
| Logs and data                   | All nodes configured for log data collection using Fluent Bit.<br />Log storage for a single node.<br />One instance of Elasticsearch and Kibana.              |
