...
* To deal with the "unhappy case" where many `calico-node` instances restart at once (for any reason), Typha's handling
...
- Fixed a bug that prevented [controlPlaneNodeSelector]({{site.baseurl}}/reference/installation/api#operator.tigera.io/v1.InstallationSpec) 
...
- Typha now supports graceful shutdown.  Rather than disconnecting all clients and
  ...
  operator's [Installation]({{site.baseurl}}/reference/installation/api#operator.tigera.io/v1.InstallationSpec)
...
- Added `calicoNodeDaemonSet` section to the operator's [Installation]({{site.baseurl}}/reference/installation/api#operator.tigera.io/v1.InstallationSpec) 
...
- Added `typhaDeployment` section to the operator's [Installation]({{site.baseurl}}/reference/installation/api#operator.tigera.io/v1.InstallationSpec) 
