...
- Added [remote cluster status metrics]({{site.baseurl}}/reference/kube-controllers/prometheus) to the `calico-kube-controllers` deployment that lets users monitor the connectivity status for federated clusters.
