...
| localASNumber            | Specifies the Autonomous System Number (ASN) that Calico nodes use as their local ASN for specific BGP peer. This overrides the node’s default ASN, enabling scenarios with multiple local ASNs or specialized BGP configurations. If omitted, it defaults to the value of the node’s default ASN.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | A valid AS Number, may be specified in dotted notation.                                     | integer/string              |
