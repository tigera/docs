...
canonical_url: '/reference/resources/deeppacketinspection'
---

A deep packet inspection resource (`DeepPacketInspection`) represents live netwrok traffic monitor for malicious activities 
...
| lastUpdated | Time when the [active](#active) feild was updated.          |

#### Error Conditions

| Field       | Description                                                       |
|-------------|-------------------------------------------------------------------|
| message     | Errors preventing deep packet inspection from running sucessfully.|
