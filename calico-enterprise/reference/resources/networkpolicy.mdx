...
The following example shows how to retrieve all `NetworkPolicy` resources in the default tier:
...
The following example shows how to retrieve all `NetworkPolicy` resources in the `default` and `net-sec` tiers:
