...
| `suspend`         | Disable future scheduled report jobs. In-flight reports are not affected.                                                                                                                                                                                                                                   |          |                                                                                                                                                                                                                                      | boolean                                      |
...
| `includeUnscoredTests` | Boolean value that when false, applies a filter to exclude tests that are marked as “Unscored” by the CIS benchmark standard. If true, the tests will be included in the report. Default: false | No       | boolean                                      |
