...
Policy recommendation scope represents a collection of configuration options used to control the [policy recommendation](../../network-policy/recommendations/policy-recommendations.mdx) engine.
