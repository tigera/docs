...
| Field | Description |
| --- | --- |
| `name` _string_ | Name is an enum which identifies the Manager Deployment container by name.<br />Supported values are: calico-voltron, calico-manager, calico-ui-apis |
...
| Field | Description |
| --- | --- |
| `name` _string_ | Name is an enum which identifies the Manager Deployment init container by name.<br />Supported values are: manager-tls-key-cert-provisioner, internal-manager-tls-key-cert-provisioner, calico-voltron-linseed-tls-key-cert-provisioner |
