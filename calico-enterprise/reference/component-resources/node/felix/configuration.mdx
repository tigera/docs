...
If you have installed Calico using the operator, you cannot modify the environment provided to felix directly. To configure felix, see the [FelixConfiguration](/reference/resources/felixconfig) resource instead.
...
> refer to [Felix Configuration Resource](/reference/resources/felixconfig).
{: .alert .alert-info}
...
For more information, see [Felix Configuration Resource](/reference/resources/felixconfig).
