...
| `felix_cluster_num_hosts`                                            | Total number of {variables.prodname} hosts in the cluster.                                                                                                                  |
...
| `felix_cluster_num_tiers`                                            | Total number of {variables.prodname} tiers in the cluster.                                                                                                                  |
...
| `felix_ipsets_calico`                                                | Number of active {variables.prodname} IP sets.                                                                                                                              |
