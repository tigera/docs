...
| ** BPF events listener **                                            |                                                                                                                                                                     |
| `felix_bpf_events`                                                   | Number of events generated by BPF dataplane split by type/category.                                                                                                 |
...
| ** NFLOG reader **                                                   | _Low level component that receives messages from the kernel when packets hit certain iptables rules.  Used to collect policy verdicts, and DNS packets._            |
...
| ** Flow logs collector **                                            | _Component that collates flow logs and flow metrics_                                                                                                                |
...
| `felix_collector_packet_info_processing_latency_seconds`             | Histogram for measuring latency of processing "packet info" aggregates from the dataplane.                                                                          |
| ** DNS policy/logging **                                             |                                                                                                                                                                     |
...
| `felix_dns_packet_nfqueue_monitor_packets_released_programmed`       | Count of how many DNS response packets have been released after updating dataplane.                                                                                 |
