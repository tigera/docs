...
We recommend using the AWS VPC CNI plugin with [federation](../../multicluster/explanation/cluster-mesh.mdx) as it provides seamless IP connectivity
...
1. By default, the AWS CNI plugin performs SNAT for any packet routed outside the VPC. You must disable SNAT
   ...
   Required for [federation](../../multicluster/explanation/cluster-mesh.mdx).
