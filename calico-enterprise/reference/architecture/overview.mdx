...
**Main task**: Collects and forwards $[prodname] logs (flows, DNS, L7) to the log storage backend. Open source, lightweight log processor and forwarder. [Fluent Bit open source](https://fluentbit.io/).
