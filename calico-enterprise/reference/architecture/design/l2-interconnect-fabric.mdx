...
Carrier' url='https://datatracker.ietf.org/doc/html/rfc1149' %} as a transport for {{prodname}}
...
![A diagram showing the Ethernet spine planes. Each color represents a distinct Ethernet network, transporting a unique IP network.](/img/calico-enterprise/master/l2-spine-planes.png)
