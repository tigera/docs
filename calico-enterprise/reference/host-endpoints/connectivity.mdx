---
description: Reference for the Calico Enterprise failsafe policy that protects host endpoints from being cut off when host network policy is misconfigured.
---
