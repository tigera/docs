...
1. In Manager UI, select **Activity** > **Webhooks**.
2. The webhook that is due to be tested must be **Enabled**.
3. Select **Actions** > **Test Webhook** for the webhook that you want to test.

The above sequence will trigger the webhook immediately with test event data and the HTTP response will be shown.
