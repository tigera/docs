...
* **Alertmanager** You must have a webhook URL for your Alertmanager instance to send alerts to. Optionally you can also configure authentication if needed.
  ...
  Alertmanager integration in $[prodname] leverages API v2 exposed by the Alertmanager as documented here: [Clients | Prometheus](https://prometheus.io/docs/alerting/latest/clients/).
  See [Alertmanager | Prometheus](https://prometheus.io/docs/alerting/latest/Alertmanager/) for more information about Alertmanager.
