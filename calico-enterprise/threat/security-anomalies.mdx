...
import AnomalyDetectionMonitor from '@site/calico-enterprise/_includes/content/anomaly-detection/_monitor.mdx';

import AnomalyDetectionEnableDisableCommon from '@site/calico-enterprise/_includes/content/anomaly-detection/_enable-disable-common.mdx';
