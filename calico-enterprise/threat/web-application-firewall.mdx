...
- You cannot use the annotation on [LoadBalancer type](https://kubernetes.io/docs/concepts/services-networking/service/#loadbalancer) services.
- WAF is incompatible with egress gateways
- WAF cannot operate on TLS traffic
