...
3. If you wish to customize settings on default included rules, please see `.example` files for guidance. You must save these files without the .example extension if you wish for these changes to take effect.
