...
To disable WAF, but keep some ApplicationLayer features enabled, you must update the [ApplicationLayer](https://github.com/tigera/docs/reference/installation/api#operator.tigera.io/v1.ApplicationLayer) custom resource.
