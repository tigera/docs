...
With BYO Prometheus, {variables.prodname} metrics and alerts are not visible in Manager UI.
...
kubectl apply -f {variables.filesUrl}/manifests/prometheus/elasticsearch-metrics-service-monitor.yaml -n $NAMESPACE
</CodeBlock>
...
<CodeBlock language='bash'>
kubectl apply -f  {variables.filesUrl}/manifests/prometheus/fluentd-metrics-service-monitor.yaml -n $NAMESPACE
</CodeBlock>
...
<CodeBlock language='bash'>
kubectl apply -f  {variables.filesUrl}/manifests/prometheus/calico-node-monitor-service-monitor.yaml -n $NAMESPACE
</CodeBlock>
...
<CodeBlock language='bash'>
kubectl apply -f  {variables.filesUrl}/manifests/prometheus/kube-controller-metrics-service-monitor.yaml -n $NAMESPACE
</CodeBlock>
...
<CodeBlock language='bash'>
kubectl apply -f  {variables.filesUrl}/manifests/prometheus/felix-metrics-service-monitor.yaml -n $NAMESPACE
</CodeBlock>
...
<CodeBlock language='bash'>
kubectl apply -f  {variables.filesUrl}/manifests/prometheus/typha-metrics-service-monitor.yaml -n $NAMESPACE
</CodeBlock>
