...
For security, the $[prodname] web console is not exposed outside of the cluster by default. You can configure access to $[prodname] Manager UI using ingress, a load balancer service, or port forwarding.
