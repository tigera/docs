...
For clusters installed using operator, see how to [provide TLS certificates for Typha and Node](/security/comms/typha-node-tls).
...
For clusters installed using the Tigera Operator, see how to [configure manager TLS](/security/comms/manager-tls).
