...
The DNS server is the VPC's primary private IPV4 CIDR range plus two. For example, if you have a VPC with an IPv4 CIDR of 192.168.0.0/16, DNS server is at 192.168.0.2.
