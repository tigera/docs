...
- [Helm](../getting-started/install-on-clusters/kubernetes/helm.mdx) installs the `projectcalico.org.v3` CRD chart.
- [Tigera Operator](../getting-started/install-on-clusters/kubernetes/index.mdx) applies the `v3_projectcalico_org.yaml` CRD bundle.
...
<Tabs>
<TabItem label="Helm" value="apiserver-helm">
...
<TabItem label="Tigera Operator" value="apiserver-operator">
