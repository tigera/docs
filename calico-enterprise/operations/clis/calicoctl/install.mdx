...
1. Ensure that you have the [`config.json` file with the private Tigera registry credentials](/getting-started/install-on-clusters/calico-enterprise/#get-private-registry-credentials-and-license-key).
