...
canonical_url: /maintenance/logstorage/log-storage-recommendations
---
...
- Red health: There is a serious issue with your cluster, check the [troubleshoot page]({{site.baseurl}}/visibility/troubleshoot)
...
### Next Steps
- Read the [LogStorage overview page]({{site.baseurl}}/maintenance/logstorage/)
- [Troubleshooting Elasticsearch]({{site.baseurl}}/visibility/troubleshoot)
- [LogStorage Specification]({{site.baseurl}}/reference/installation/api#operator.tigera.io/v1.LogStorage)
