...
* The anomaly detection feature was removed in v3.18.1 If anomaly detection is enabled and you upgrade to {variables.prodname} 3.18, you will stop receiving anomaly detection alerts.
