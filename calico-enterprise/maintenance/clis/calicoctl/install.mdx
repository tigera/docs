...
<CodeBlock language='bash-plain-text'>
  {'{{version}}' === 'master'
    ? `curl -o calicoctl -O -L {{siteUrl}}/download/binaries/${version}/calicoctl`
...
<CodeBlock language='bash-plain-text'>
  {'{{version}}' === 'master'
    ? `curl -o calicoctl -O -L {{siteUrl}}/download/binaries/${version}/calicoctl-darwin-amd64`
...
<CodeBlock language='bash-plain-text'>
  {'{{version}}' === 'master'
    ? `Invoke-WebRequest -Uri "{{siteUrl}}/download/binaries/${version}/calicoctl-windows-amd64.exe" -OutFile "calicocttl.exe"`
...
<CodeBlock language='bash-plain-text'>
  {'{{version}}' === 'master'
    ? `curl -o kubectl-calico -O -L {{siteUrl}}/download/binaries/${version}/calicoctl`
...
<CodeBlock language='bash-plain-text'>
  {'{{version}}' === 'master'
    ? `curl -o kubectl-calico -O -L {{siteUrl}}/download/binaries/${version}/calicoctl-darwin-amd64`
...
<CodeBlock language='bash-plain-text'>
  {'{{version}}' === 'master'
    ? `Invoke-WebRequest -Uri "{{siteUrl}}/download/binaries/${version}/calicoctl-windows-amd64.exe" -OutFile "kubectl-calico.exe"`
