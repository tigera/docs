...
1. Export one or more managed clusters.
  ...
  export MANAGED_CLUSTER_CERTIFICATE=my-managed-cluster.crt.base64
  ```

1. Verify that the management cluster context is correctly updated in the `values.yaml`. For a NodePort:
  ...
  managedClusters:
    ...
    - name: $MANAGED_CLUSTER_NAME
      ...
      certificate: $MANAGED_CLUSTER_CERTIFICATE
  ```
