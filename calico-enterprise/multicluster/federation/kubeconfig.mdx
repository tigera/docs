...
We will now use RemoteClusterConfiguration to instruct each cluster to connect to its peer remote clusters using the `kubeconfig`s we created in the previous section.
