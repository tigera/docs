...
![audit-logs](/img/calico-enterprise/3.15/audit-logs.png)
...
![kibana-auditlogs](/img/calico-enterprise/3.15/kibana-auditlogs.png)

Finally, audit logs provide the core data for compliance reports.

![compliance-reports](/img/calico-enterprise/3.15/configuration-compliance.png)
