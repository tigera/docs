...
![dashboards](/img/calico-enterprise/master/dashboards.png)
...
![service-graph](/img/calico-enterprise/master/service-graph.png)
...
![service-graph-namespace](/img/calico-enterprise/master/service-graph-namespace.png)
...
![edges](/img/calico-enterprise/master/edges.png)
...
![service-graph-layers](/img/calico-enterprise/master/service-graph-layers.png)
...
![service-graph-flows](/img/calico-enterprise/master/service-graph-flows.png)
...
![packet-capture-service](/img/calico-enterprise/master/packet-capture-service.png)
...
![flow-viz](/img/calico-enterprise/master/flow-viz.png)
...
![policy-board](/img/calico-enterprise/master/policy-board.png)
...
![policy-filters](/img/calico-enterprise/master/policy-filters.png)
...
![stage-policyl](/img/calico-enterprise/master/stage-policy.png)
...
![endpoints](/img/calico-enterprise/master/endpoints.png)

**Node List**

This page lists all nodes associated with your cluster.

![node-list](/img/calico-enterprise/master/node-list.png)
...
![networksets](/img/calico-enterprise/master/networksets.png)
...
![managed-clusters](/img/calico-enterprise/master/managed-clusters.png)
...
![cis-benchmark](/img/calico-enterprise/master/cis-benchmark.png)

Using the filter, you can select report types.

![compliance-filter](/img/calico-enterprise/master/compliance-filter.png)
...
![timeline](/img/calico-enterprise/master/timeline.png)
...
![alerts](/img/calico-enterprise/master/alerts.png)
...
![kibana-dashboards](/img/calico-enterprise/master/kibana-dashboards.png)
...
![kibana](/img/calico-enterprise/master/kibana.png)
