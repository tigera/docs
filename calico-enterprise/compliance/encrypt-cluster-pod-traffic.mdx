...
- Pod-to-pod traffic
- Encryption for direct node-to-node communication is supported on managed clusters deployed on EKS (AWS CNI and Calico CNI) and AKS (Azure CNI and Calico CNI)
