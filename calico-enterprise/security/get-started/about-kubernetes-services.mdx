...
![Kubernetes Service conceptual diagram](/img/calico-enterprise/master/k8s-service-concept.svg)
...
![kube-proxy cluster IP](/img/calico-enterprise/master/kube-proxy-cluster-ip.svg)
...
![kube-proxy node port](/img/calico-enterprise/master/kube-proxy-node-port.svg)
...
![kube-proxy load balancer](/img/calico-enterprise/master/kube-proxy-load-balancer.svg)
...
![kube-proxy service advertisement](/img/calico-enterprise/master/kube-proxy-service-advertisement.svg)
...
![kube-proxy service advertisement](/img/calico-enterprise/master/kube-proxy-service-local.svg)
...
dataplane](../../maintenance/ebpf/enabling-ebpf.mdx) supports native service handling. This preserves source IP to
...
![kube-proxy service advertisement](/img/calico-enterprise/master/calico-native-service-handling.svg)
