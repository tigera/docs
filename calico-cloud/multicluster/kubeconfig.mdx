...
Add remote cluster configuration where needed. Each instance of the [Remote Cluster Configuration](/reference/resources/remoteclusterconfiguration)
...
[Configure federated services](/multicluster/services-controller/)
