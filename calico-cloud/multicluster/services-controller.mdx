...
- [Configure federated endpoint identity](/multicluster/federation/kubeconfig.mdx)
...
- [Federated identity and services example for AWS](/multicluster/federation/aws.mdx)
