...
- [Configure federated endpoint identity](/multicluster/kubeconfig/)
...
- [Federated identity and services example for AWS](/multicluster/aws/)
- [Federated service controller](/reference/component-resources/kube-controllers/configuration)
