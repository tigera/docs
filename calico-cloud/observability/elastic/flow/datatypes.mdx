...
| `enforced_policies`               | array of keywords | A comma-delimited list of all enforced network policies that applied an action to the flow up until the first enforced policy to apply .                                 |
| `pending_policies`                | array of keywords | A comma-delimited list of all enforced and staged network policies that applied an action to the flow up until the first policy (staged or not) that applied a verdict.  |
