---
description: Architecture overview of Calico Cloud — components that run in the connected cluster and the SaaS-side services they communicate with.
---
