...
- A checklist to [troubleshoot your installation](/get-started/connect/checklist.mdx)

- Additional troubleshooting for the [Tigera Operator](/get-started/connect/operator-checklist.mdx)
