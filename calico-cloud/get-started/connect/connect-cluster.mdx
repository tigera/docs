...
<!-- If link changes, update link in OS docs here: https://projectcalico.docs.tigera.io/calico-enterprise/ -->
...
![connect-disconnect](/img/calico-cloud/master/connect-disconnect.png)
...
For details of the migration script, see [Uninstall {{prodname}} from a cluster](/operations/disconnect).
...
- A checklist to [troubleshoot your installation](/get-started/connect/checklist)

- Additional troubleshooting for the [Tigera Operator](/get-started/connect/operator-checklist)
