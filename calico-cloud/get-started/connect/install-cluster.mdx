...
Although not required, it may save you troubleshooting if you verify your cluster meets [system requirements](/get-started/requirements/system-requirements.mdx).
...
- Helm v3
- Before you start the installation wizard, add {{prodname}} images to a [private registry](/get-started/connect/setup-private-registry.mdx). You'll need the following values in the installation wizard:
...
1. Click **Advanced Options**, and select both **Install via helm** and **Install private registry**. (Private registry supports only Helm).
   ![private-registry](/img/calico-cloud/master/private-registry.png)
...
1. Click **Advanced Options**, and select **Install via helm**.
   ![helm](/img/calico-cloud/master/helm.png)
1. Click **Connect** and follow the wizard.
1. Monitor the progress on the Managed Clusters page.

## Need help?

See [Troubleshooting checklist](/get-started/connect/checklist.mdx) and [Tigera operator troubleshooting checklist](/get-started/connect/operator-checklist.mdx).
