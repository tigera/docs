...
Although not required, it may save you troubleshooting if you verify your cluster meets [system requirements](/get-started/connect/requirements/system-requirements/).
...
- Helm v3
- Before you start the installation wizard, add {{prodname}} images to a [private registry](/get-started/connect/setup-private-registry). You'll need the following values in the installation wizard:
...
See [Troubleshooting checklist](/get-started/connect/checklist) and [Tigera operator troubleshooting checklist](/get-started/connect/operator-checklist).
