...
quay.io/tigera/image-assurance-admission-controller:v1.3.4
quay.io/tigera/runtime-security-operator:v1.3.0
quay.io/tigera/skimble:v1.3.0
quay.io/tigera/cc-core:v0.1.2
