...
If you have verified all of the above steps and still have issues, you can move on to the [Tigera Operator checklist](/get-started/connect/operator-checklist.mdx).
