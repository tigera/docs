...
Although {{prodname}} checks that your cluster meets [System requirements](/get-started/requirements/system-requirements.mdx), verifying now can save you time troubleshooting.
...
[Troubleshooting checklist](/get-started/connect/checklist.mdx)
