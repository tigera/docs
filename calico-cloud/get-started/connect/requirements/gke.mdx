...
Although {{prodname}} checks that your cluster meets [System requirements](/get-started/connect/requirements/system-requirements/), verifying now can save you time troubleshooting.
...
[Troubleshooting checklist](/get-started/connect/checklist)
