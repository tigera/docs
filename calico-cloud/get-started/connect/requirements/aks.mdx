...
To allow existing AKS managed clusters with Calico to be managed in the same deployment as new {{prodname}} clusters, you must change the CNI in those clusters to `None`.
:::
