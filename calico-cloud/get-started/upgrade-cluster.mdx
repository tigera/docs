...
1. Click the **Actions** link on the cluster you want to reinstall, and then select  **ReInstall**.
...
1. Click **Next**, then copy the command and apply it to appropriate cluster.
