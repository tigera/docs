...
:::important
If you install from a private registry, [mirror the new version's images](setup-private-registry.mdx), including its operator image, before you run the command.
:::
