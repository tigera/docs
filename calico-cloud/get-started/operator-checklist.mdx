---
description: Additional Tigera Operator troubleshooting steps for Calico Cloud connected clusters when the standard support checklist is not enough.
---
...
metadata:
  annotations:
    kubectl.kubernetes.io/last-applied-configuration: |
      {"apiVersion":"operator.tigera.io/v1","kind":"Installation","metadata":{"annotations":{},"name":"default"},"spec":{"imagePullSecrets":[{"name":"tigera-pull-secret"}],"variant":"CalicoEnterprise"}}
