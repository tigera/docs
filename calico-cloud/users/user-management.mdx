...
The User Admin role has the ability to manage team members and their assigned roles $[prodname].
...
The Cluster Connection Admin role has administrative capabilities of managed clusters $[prodname].
