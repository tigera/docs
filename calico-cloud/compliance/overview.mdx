...
- [Configure audit logs for Kubernetes resources](/visibility/elastic/audit-overview)
...
To configure and schedule a compliance report, create a [GlobalReport](/reference/resources/globalreport) with the following information.
...
- For details on configuring and scheduling reports, see [Global reports](/reference/resources/globalreport)
- For report field descriptions, see [Compliance reports](/reference/resources/compliance-reports/index)
