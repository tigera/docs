...
- The **Layout Settings** shows the default metrics. To get WireGuard metrics for pod-to-pod and host-to-host encryption, you must [enable WireGuard](/compliance/encrypt-cluster-pod-traffic).
...
- [Understanding policy tiers](policy-tiers.mdx)
