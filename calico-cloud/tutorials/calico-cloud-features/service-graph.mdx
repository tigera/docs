...
For more examples of using network sets, see [Secure egress access from workloads to destinations outside the cluster](/workload-access/applications/egress-controls.mdx), and [Understanding network sets](/get-started/tutorials/networksets.mdx).
