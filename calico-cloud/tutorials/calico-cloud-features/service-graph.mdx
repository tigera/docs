...
For more examples of using network sets, see [Secure egress access from workloads to destinations outside the cluster](/tutorials/applications/egress-controls/), and [Understanding network sets](/tutorials/calico-cloud-features/networksets/).
