...
canonical_url: '/get-started/tutorials/networksets'
---
...
### Best practices with networksets
...
- Namespaced network set 
   - [Secure ingress access to a microservice or application]({{site.baseurl}}/workload-access/applications/)

- Global network set
   - [Secure egress access from workloads to destinations outside the cluster]({{site.baseurl}}/workload-access/applications/egress-controls)
   - [Global egress access controls]({{site.baseurl}}/workload-access/enterprise-security/global-egress)
