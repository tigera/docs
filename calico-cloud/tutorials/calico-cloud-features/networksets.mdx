...
- Namespaced network set
  ...
  - [Secure ingress access to a microservice or application](/tutorials/applications/index/)

- Global network set
  - [Secure egress access from workloads to destinations outside the cluster](/tutorials/applications/egress-controls/)
  - [Global egress access controls](/tutorials/enterprise-security/global-egress/)
