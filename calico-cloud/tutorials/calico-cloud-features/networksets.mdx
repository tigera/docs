---
title: Understanding network sets
...
![public-private-networks](/img/calico-cloud/master/public-private-networks.png)
...
![add-networkset-google](/img/calico-cloud/master/add-networkset-google.png)
...
![hipstershop](/img/calico-cloud/master/hipstershop.png)
...
- Namespaced network set
  ...
  - [Secure ingress access to a microservice or application](../../workload-access/applications/index.mdx)

- Global network set
  - [Secure egress access from workloads to destinations outside the cluster](../../workload-access/applications/egress-controls.mdx)
  - [Global egress access controls](../../workload-access/enterprise-security/global-egress.mdx)
