...
canonical_url: /get-started/training/about-network-policy
---
...
In contrast, the [Kubernetes network model]({{site.baseurl}}/get-started/training/about-kubernetes-networking) defines a "flat"
...
For more flexible control and delegation of responsibilities between two or more teams, {{site.prodname}} extends this
...
[Calico Cloud]({{site.baseurl}}/get-started/tutorials/policy-tiers) supports hierarchical network policy using policy tiers. RBAC
