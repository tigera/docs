...
![Kubernetes Service conceptual diagram](/img/calico-cloud/master/k8s-service-concept.svg)
...
[DNAT](/get-started/training/about-networking.mdx) is used to map the destination IP address from the Cluster IP to the
chosen backing pod. Response packets on the connection then have the NAT reverse on their way back to the pod that
initiated the connection.

![kube-proxy cluster IP](/img/calico-cloud/master/kube-proxy-cluster-ip.svg)
...
![kube-proxy node port](/img/calico-cloud/master/kube-proxy-node-port.svg)
...
![kube-proxy load balancer](/img/calico-cloud/master/kube-proxy-load-balancer.svg)
...
![kube-proxy service advertisement](/img/calico-cloud/master/kube-proxy-service-advertisement.svg)
...
![kube-proxy service advertisement](/img/calico-cloud/master/kube-proxy-service-local.svg)
...
![kube-proxy service advertisement](/img/calico-cloud/master/calico-native-service-handling.svg)
