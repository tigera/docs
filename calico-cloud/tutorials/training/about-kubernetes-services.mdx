...
canonical_url: /get-started/training/about-kubernetes-services
---
...
[DNAT]({{site.baseurl}}/get-started/training/about-networking) is used to map the destination IP address from the Cluster IP to the
...
{{site.prodname}}'s eBPF dataplane native service handling (rather than kube-proxy) which preserves source IP address.
