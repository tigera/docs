...
canonical_url: '/get-started/training/about-networking'
---
...
You can get up and running with {{site.prodname}} without needing to be a networking expert. {{site.prodname}} hides the complexities for
...
{{site.prodname}} to provide an overlay network, or non-overlay network. 
