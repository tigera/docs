...
In contrast to ingress traffic, where Kubernetes has the [Ingress](/tutorials/training/about-kubernetes-ingress/)
...
achieved using [Network Policy](/tutorials/training/about-network-policy/) to define egress rules for each
microservice, often in conjunction with a [default deny](/tutorials/training/about-network-policy/#default-deny)
