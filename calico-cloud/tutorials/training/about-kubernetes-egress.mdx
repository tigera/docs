...
canonical_url: /get-started/training/about-kubernetes-egress
---
...
In contrast to ingress traffic, where Kubernetes has the [Ingress]({{site.baseurl}}/get-started/training/about-kubernetes-ingress)
...
achieved using [Network Policy]({{site.baseurl}}/get-started/training/about-network-policy) to define egress rules for each
microservice, often in conjunction with a [default deny]({{site.baseurl}}/get-started/training/about-network-policy#default-deny)
