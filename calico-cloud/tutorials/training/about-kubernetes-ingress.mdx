...
Kubernetes Ingress builds on top of Kubernetes [Services](/get-started/training/about-kubernetes-services.mdx) to provide
...
Given that Kubernetes [Services](/get-started/training/about-kubernetes-services.mdx) already provide a mechanism for load
...
![In-cluster ingress](/img/calico-cloud/master/ingress-in-cluster.svg)
...
![External ingress](/img/calico-cloud/master/ingres-external.svg)

Note that most application load balancers support a basic mode of operation of forwarding traffic to the chosen service
backing pods via the [node port](/get-started/training/about-kubernetes-services.mdx#node-port-services) of the
...
addresses are maintained, in the [About Kubernetes Services](/get-started/training/about-kubernetes-services.mdx) guide.
...
![In-cluster ingress with NLB local](/img/calico-cloud/master/ingress-in-cluster-nlb-local.svg)

**External ingress solution via node ports**

![External ingress via node port](/img/calico-cloud/master/ingress-external-node-ports.svg)

**External ingress solution direct to pods**

![External ingress direct to pods](/img/calico-cloud/master/ingress-external-direct-to-pods.svg)
