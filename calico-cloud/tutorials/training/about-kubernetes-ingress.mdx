...
Kubernetes Ingress builds on top of Kubernetes [Services](/tutorials/training/about-kubernetes-services/) to provide
...
Given that Kubernetes [Services](/tutorials/training/about-kubernetes-services/) already provide a mechanism for load
...
backing pods via the [node port](/tutorials/training/about-kubernetes-services/#node-port-services) of the
...
addresses are maintained, in the [About Kubernetes Services](/tutorials/training/about-kubernetes-services/) guide.
