...
canonical_url: /get-started/training/about-kubernetes-ingress
---
...
Kubernetes Ingress builds on top of Kubernetes [Services]({{site.baseurl}}/get-started/training/about-kubernetes-services) to provide
...
Given that Kubernetes [Services]({{site.baseurl}}/get-started/training/about-kubernetes-services) already provide a mechanism for load
...
backing pods via the [node port]({{site.baseurl}}/get-started/training/about-kubernetes-services#node-port-services) of the
...
addresses are maintained, in the [About Kubernetes Services]({{site.baseurl}}/get-started/training/about-kubernetes-services) guide.
