...
Policy recommendation automatically creates policies that explicitly allow traffic because of {{prodname}}'s [day-one zero trust](/network-policy/policy-best-practices.mdx#policy-best-practices-for-day-one-zero-trust) enhanced security posture.
...
![Navigate to Policy Recommendation](/img/calico-enterprise/master/generate-policy-recommendation/recommend-policy-action-bar.png)
...
![Create a Policy Recommendation](/img/calico-enterprise/master/generate-policy-recommendation/recommend-policy-screen.png){:height="75%" width="75%"}
...
![Create a Policy Recommendation](/img/calico-enterprise/master/generate-policy-recommendation/recommend-policy-screen-advanced-options.png){:height="75%" width="75%"}
...
![Preview or Stage a Policy Recommendation](/img/calico-enterprise/master/generate-policy-recommendation/create-policy-action-buttons.png)
...
- [Stage, preview impacts, and enforce policy](/network-policy/staged-network-policies.mdx)
