...
Policy recommendation automatically creates policies that explicitly allow traffic because of {{prodname}}'s [day-one zero trust](/network-policy/policy-best-practices#policy-best-practices-for-day-one-zero-trust) enhanced security posture.
...
- [Stage, preview impacts, and enforce policy](/network-policy/staged-network-policies)
