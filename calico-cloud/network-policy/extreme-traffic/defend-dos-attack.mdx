...
| Kernel          | The kernel supports **XDP generic mode** and Calico is configured to explicitly use it. This mode is rarely used and has no performance benefits over iptables raw mode below. To enable, see [Felix Configuration](/reference/resources/felixconfig). | Fast        |
...
- [Global network sets](/reference/resources/globalnetworkset)
- [Global network policy](/reference/resources/globalnetworkpolicy)
- [Create a host endpoint](/reference/resources/hostendpoint)
