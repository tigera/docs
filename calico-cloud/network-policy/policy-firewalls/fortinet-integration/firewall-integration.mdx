...
1. Create a tier for organizing global network policies.
   ...
   Create a new [Tier](/network-policy/policy-tiers/tiered-policy.mdx) to organize all Fortigate firewall global network policies in a single location.
...
- [Extend FortiManager firewall policies to Kubernetes](/network-policy/policy-firewalls/fortinet-integration/fortimgr-integration.mdx)
