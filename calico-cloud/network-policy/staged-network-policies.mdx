...
- [Staged global network policy](/reference/resources/stagedglobalnetworkpolicy)
- [Staged network policy](/reference/resources/stagednetworkpolicy)
- [Staged Kubernetes network policy](/reference/resources/stagedkubernetesnetworkpolicy)
- For details on how to configure RBAC for staged policy resources, see [Configuring RBAC for tiered policy](/network-policy/policy-tiers/rbac-tiered-policies)
- For details on staged policy metrics, see
  - [Flow logs](/visibility/elastic/flow/datatypes)
  - [Prometheus statistics](/operations/monitor/metrics/index#content-main)
