...
- For details on how to configure RBAC for staged policy resources, see [Configuring RBAC for tiered policy](/network-policy/policy-tiers/rbac-tiered-policies.mdx)
