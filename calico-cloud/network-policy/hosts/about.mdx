...
import DockerContainerService from '@site/calico-cloud/_includes/content/_docker-container-service.mdx';

import NonClusterBinaryInstall from '@site/calico-cloud/_includes/content/_non-cluster-binary-install.mdx';
...
![non-cluster-host](/img/calico-enterprise/master/non-cluster-host.png)
...
To learn how to restrict traffic to/from hosts using {{prodname}} network policy see, [Protect hosts](/network-policy/hosts/protect-hosts).
...
- Non-cluster host meets {{prodname}} [system requirements](/network-policy/hosts/requirements/)
...
- [Protect hosts](/network-policy/hosts/protect-hosts)
