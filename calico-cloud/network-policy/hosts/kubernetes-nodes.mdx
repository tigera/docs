...
- AKS and EKS require [eBPF](/operations/ebpf/index) (iptables are not supported)
...
- [Protect hosts tutorial](/network-policy/hosts/protect-hosts-tutorial)
...
- [Host endpoints](/reference/resources/hostendpoint)
