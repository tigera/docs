...
- [Apply policy to Kubernetes nodeports](/network-policy/beginners/services/kubernetes-node-ports)
...
[Configure Calico to advertise cluster IPs over BGP](/networking/configuring/advertise-service-ips).
...
- [Enable service IP advertisement](/networking/configuring/advertise-service-ips)
