---
description: Expose Kuberenetes service cluster IPs over BGP using Calico Cloud, and restrict who can access them using Calico Cloud network policy.
---

# Apply {{prodname}} policy to services exposed externally as cluster IPs
