...
This guide is a variation of the [simple policy demo](/network-policy/get-started/kubernetes-policy-basic.mdx) intended to introduce the extra features of {{prodname}} to people already familiar with Project Calico for Kubernetes.
