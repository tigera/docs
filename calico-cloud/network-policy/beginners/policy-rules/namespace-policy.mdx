...
- For more network policies, see [Network policy](/reference/resources/networkpolicy)
- To apply policy to all namespaces, see [Global network policy](/reference/resources/globalnetworkpolicy)
