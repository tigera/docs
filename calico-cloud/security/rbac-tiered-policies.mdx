...
1. Download the [min-ui-user-rbac.yaml manifest]({{url}}{{baseUrl}}/get-started/kubernetes/installation/hosted/cnx/demo-manifests/min-ui-user-rbac.yaml).
...
1. Download the [`read-all-crud-default-rbac.yaml` manifest]({{url}}{{baseUrl}}/get-started/kubernetes/installation/hosted/cnx/demo-manifests/read-all-crud-default-rbac.yaml).
