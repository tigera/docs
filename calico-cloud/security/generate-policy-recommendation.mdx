...
description: Generate a Calico Cloud policy recommendation to secure unprotected workloads.
---
...
![Navigate to Policy Recommendation](/img/calico-cloud/master/generate-policy-recommendation/recommend-policy-action-bar.png)
...
![Generate a Policy Recommendation](/img/calico-cloud/master/generate-policy-recommendation/recommend-policy-screen.png)
...
![Preview or Stage a Policy Recommendation](/img/calico-cloud/master/generate-policy-recommendation/create-policy-action-buttons.png)
...
- To preview the impact of a recommended policy before applying it see, [Policy impact preview](policy-impact-preview.mdx)
