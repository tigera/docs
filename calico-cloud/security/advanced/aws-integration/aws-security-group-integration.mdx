---
title: Configure Calico Cloud AWS security groups integration
description: Combine AWS security groups with network policy to enforce access control between Kubernetes pods and AWS VPC resources.
---
...
- You have installed [{{prodname}} for EKS on your cluster, or kubeadm/kops.
...
1.  Install AWS per-account resources.
    ...
    --template-body {{url}}{{baseUrl}}/manifests/aws/security-group-integration/account-cf.yaml
...
1.  Install AWS per-VPC resources.
    ...
    --template-body {{url}}{{baseUrl}}/manifests/aws/security-group-integration/vpc-cf.yaml
...
1.  Install AWS per-cluster resources.
    ...
    --template-body {{url}}{{baseUrl}}/manifests/aws/security-group-integration/cluster-cf.yaml
