...
Each time you install {{prodname}} on a cluster, the cluster is added to the drop-down menu in Manager.

![cluster-menu](/img/calico-cloud/master/cluster-menu.png)
...
![export-policy](/img/calico-cloud/master/export-policy.png)
