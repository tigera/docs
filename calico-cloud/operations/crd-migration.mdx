---
description: Migrate Calico Cloud resources from the aggregated API server backing storage to native projectcalico.org/v3 CRDs so the API server component can be removed.
---
