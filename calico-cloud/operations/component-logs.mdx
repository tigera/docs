...
BGP log level is configured via the [BGPConfiguration](/reference/resources/bgpconfig) API, and can be one of the following values:
...
Felix log level is configured via the [FelixConfiguration](/reference/resources/felixconfig) API, and can be one of the following values:
