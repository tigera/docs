...
- [Learn more about eBPF](/operations/ebpf/use-cases-ebpf)

**Recommended - Security**

- [Get started with {{prodname}} tiered network policy](/network-policy/policy-tiers/tiered-policy)
