---
description: Switch Calico Cloud to native projectcalico.org/v3 CRDs so resources are stored directly as CRDs without the aggregated API server component.
---
