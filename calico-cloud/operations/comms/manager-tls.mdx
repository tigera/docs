...
Additional documentation is available for securing [{{prodname}} manager connections](/operations/comms/crypto-auth.mdx#calico-enterprise-manager-connections).
