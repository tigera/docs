...
Additional documentation is available for securing [{{prodname}} manager connections](/operations/comms/crypto-auth#connections-from-calico-enterprise-components-to-kube-apiserver-kubernetes-and-openshift).
