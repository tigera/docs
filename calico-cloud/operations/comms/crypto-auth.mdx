...
For clusters installed using operator, see how to [provide TLS certificates for Typha and Node](/operations/comms/typha-node-tls).
...
- **Node**: [Node-Typha TLS configuration](/reference/component-resources/node/felix/configuration#felix-typha-tls-configuration)
...
For clusters installed using the Tigera Operator, see how to [configure manager TLS](/operations/comms/manager-tls).
