...
For clusters installed using operator, see how to [provide TLS certificates for Typha and Node](/operations/comms/typha-node-tls.mdx).
...
![{{prodname}} Manager traffic diagram](/img/calico-enterprise/master/cnx-tls-mgr-comms.svg)
...
For clusters installed using the Tigera Operator, see how to [configure manager TLS](/operations/comms/manager-tls.mdx).
