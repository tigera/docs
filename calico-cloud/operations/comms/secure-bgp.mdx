...
When [configuring a BGP peer](/networking/configuring/bgp),
...
Include the secret in the default [BGP configuration](/reference/resources/bgpconfig)
...
peers](/networking/configuring/bgp).
