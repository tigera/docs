...
- Ensure the generated certificates meet the requirements for [TLS connections between Node and Typha](/operations/comms/crypto-auth#connections-from-node-to-typha-kubernetes).
