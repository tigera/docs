...
- Ensure the generated certificates meet the requirements for [TLS connections between Node and Typha](/operations/comms/crypto-auth.mdx#connections-from-node-to-typha-kubernetes).
