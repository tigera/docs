...
Refer to [Configuring Prometheus](/operations/monitor/prometheus/index) for information on how to create a new Alerting rule or updating the scraping interval for how often Prometheus collects the metrics.
...
- [Secure {{prodname}} Prometheus endpoints](/operations/comms/secure-metrics)
- [Configuring Prometheus](/operations/monitor/prometheus/index)
