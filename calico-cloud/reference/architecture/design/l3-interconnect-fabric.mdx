...
discussed in our earlier [technical note](/reference/architecture/design/l2-interconnect-fabric).
...
detailed in [this post](/reference/architecture/design/l2-interconnect-fabric).
...
and the [Ethernet fabric note](/reference/architecture/design/l2-interconnect-fabric),
...
In the {{prodname}} [Ethernet fabric](/reference/architecture/design/l2-interconnect-fabric)
...
In the [Ethernet fabric](/reference/architecture/design/l2-interconnect-fabric)
