...
_local_ AS (since they share the source and destination of the route share the
same AS).
...
iBGP) peering relationship. If they are members of different AS numbers, then
