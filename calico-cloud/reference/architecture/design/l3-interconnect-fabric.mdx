...
discussed in our earlier [technical note](/reference/architecture/design/l2-interconnect-fabric.mdx).
...
![](/img/calico-enterprise/master/l3-fabric-diagrams-as-rack-l2-spine.png)
...
![](/img/calico-enterprise/master/l3-fabric-diagrams-as-rack-l3-spine.png)
...
![](/img/calico-enterprise/master/l3-fabric-diagrams-as-server-l2-spine.png)
...
![](/img/calico-enterprise/master/l3-fabric-diagrams-as-server-l3-spine.png)
...
![](/img/calico-enterprise/master/l3-fabric-downward-default.png)
...
detailed in [this post](/reference/architecture/design/l2-interconnect-fabric.mdx).
...
and the [Ethernet fabric note](/reference/architecture/design/l2-interconnect-fabric.mdx),
...
In the {{prodname}} [Ethernet fabric](/reference/architecture/design/l2-interconnect-fabric.mdx)
...
In the [Ethernet fabric](/reference/architecture/design/l2-interconnect-fabric.mdx)
