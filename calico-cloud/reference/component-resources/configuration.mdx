...
match a configured [IPPool](/reference/resources/ippool) resource.
...
`nodeSelector` field. Check out the [IP pool resource document](/reference/resources/ippool)
for more details.
...
topology](/networking/ipam/assign-ip-addresses-topology)
for a full example.
