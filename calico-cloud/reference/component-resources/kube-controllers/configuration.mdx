...
If you have installed Calico using the operator, see the [KubeControllersConfiguration](/reference/resources/kubecontrollersconfig.mdx) resource instead.
...
Whenever possible, prefer configuring the kube-controllers component using the [KubeControllersConfiguration](/reference/resources/kubecontrollersconfig.mdx) API resource,
