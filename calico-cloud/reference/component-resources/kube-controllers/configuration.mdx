...
If you have installed Calico using the operator, see the [KubeControllersConfiguration](/reference/resources/kubecontrollersconfig) resource instead.
...
Whenever possible, prefer configuring the kube-controllers component using the [KubeControllersConfiguration](/reference/resources/kubecontrollersconfig) API resource,
...
[Configuring federated services](/multicluster/services-controller/) usage guide.
