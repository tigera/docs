...
`CalicoEnterprise` otherwise it is `calico`.
...
| Field | Description |
| --- | --- |
| `variant` _[ProductVariant](#productvariant)_ | (Optional) Variant is the product to install - one of Calico or CalicoEnterprise<br />Default: Calico |
...
| Field | Description |
| --- | --- |
| `variant` _[ProductVariant](#productvariant)_ | Variant is the most recently observed installed variant - one of Calico or CalicoEnterprise |
