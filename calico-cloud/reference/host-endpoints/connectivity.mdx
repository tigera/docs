...
except for traffic that is allowed by the [failsafe rules](/reference/host-endpoints/failsafe.mdx).

While the [failsafe rules](/reference/host-endpoints/failsafe.mdx) provide protection against removing all
...
[failsafe rules](/reference/host-endpoints/failsafe.mdx).
