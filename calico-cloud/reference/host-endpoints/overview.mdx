...
Felix](/reference/component-resources/node/felix/configuration.mdx).
...
See [GlobalNetworkPolicy spec](/reference/resources/globalnetworkpolicy.mdx#spec).
...
`forwarded traffic`.
![](/img/calico-enterprise/master/bare-metal-packet-flows.svg)
