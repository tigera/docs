...
IPSet threat feeds can also be configured to be synchronized to a [global network set](/reference/resources/globalnetworkset.mdx),
...
with a [global network set](/reference/resources/globalnetworkset.mdx). This global network set will have the name `threatfeed.<threat feed name>`
