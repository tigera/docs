...
will use to apply
[policy](/reference/resources/networkpolicy)
...
Host endpoints with `interfaceName: *` do not support [untracked policy](/network-policy/extreme-traffic/high-connection-workloads).
