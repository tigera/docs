...
- [DNS logs](/visibility/elastic/dns/index)
- [Flow logs](/visibility/elastic/flow/index)
- [L7 logs](/visibility/elastic/l7/index)
...
| Field | Description                                                                                                                                                                      | Type   | Required |
| ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | -------- |
| name  | Name specifies the AnomalyDetection Detector to run. The name has to match a detector ID which can be found in the [Anomaly detection reference page](/reference/anomaly-detection). | string | yes      |
...
See [DNS logs](/visibility/elastic/dns/dns-logs) for description of fields.

### Flow logs

See [Flow logs](/visibility/elastic/flow/datatypes) for description of fields.

### L7 logs

See [L7 logs](/visibility/elastic/l7/datatypes) for description of fields.
