...
{{prodname}} supports Kubernetes [annotations that force the use of specific IP addresses](/reference/component-resources/configuration.mdx#requesting-a-specific-ip-address). These annotations override any `IPReservation`s that
are in place.
