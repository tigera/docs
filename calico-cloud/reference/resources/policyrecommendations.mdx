...
The policy recommendation scope is a collection of configuration options to control the [policy recommendation](../../network-policy/recommendations/policy-recommendations.mdx) engine.
