...
[global network policy](/reference/resources/globalnetworkpolicy.mdx) rule, or within a
[network policy](/reference/resources/networkpolicy.mdx) rule whose `namespaceSelector` includes `global()`, it includes
