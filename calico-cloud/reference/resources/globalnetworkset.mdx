...
[global network policy](/reference/resources/globalnetworkpolicy) rule, or within a
[network policy](/reference/resources/networkpolicy) rule whose `namespaceSelector` includes `global()`, it includes
