...
- [Inventory](/reference/resources/compliance-reports/inventory)
- [Network Access](/reference/resources/compliance-reports/network-access)
- [Policy Audit](/reference/resources/compliance-reports/policy-audit)
- [CIS Benchmark](/reference/resources/compliance-reports/cis-benchmark)

Create a [`GlobalReport`](/reference/resources/globalreport) resource to automatically schedule report generation, and specify the report scope (resources to include in the report).
