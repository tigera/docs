...
- [Inventory](/reference/resources/compliance-reports/inventory.mdx)
- [Network Access](/reference/resources/compliance-reports/network-access.mdx)
- [Policy Audit](/reference/resources/compliance-reports/policy-audit.mdx)
- [CIS Benchmark](/reference/resources/compliance-reports/cis-benchmark.mdx)

Create a [`GlobalReport`](/reference/resources/globalreport.mdx) resource to automatically schedule report generation, and specify the report scope (resources to include in the report).
