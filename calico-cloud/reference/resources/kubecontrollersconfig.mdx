...
A {{prodname}} [Kubernetes controllers](/reference/component-resources/kube-controllers/configuration) configuration resource (`KubeControllersConfiguration`) represents configuration options for the {{prodname}} Kubernetes controllers.
...
The federated services controller syncs Kubernetes services from remote clusters defined through [RemoteClusterConfigurations](/reference/resources/remoteclusterconfiguration).
