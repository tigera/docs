...
| Field                           | Description                                                                               | Accepted Values | Schema                                                                                                         | Default |
| ------------------------------- | ----------------------------------------------------------------------------------------- | --------------- | -------------------------------------------------------------------------------------------------------------- | ------- |
| spec.template.spec.containers   | Containers is a list of runtime reporter DaemonSet containers.                            |                 | [RuntimeReporterDaemonSetContainer](#runtimereporterdaemonsetcontainer)                                        |         |                                      |         |
| spec.template.spec.affinity     | Affinity is a group of affinity scheduling rules for the runtime reporter DaemonSet pods. |                 | [corev1.Affinity](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#affinity-v1-core)       |         |
| spec.template.spec.nodeSelector | NodeSelector is the runtime reporter pod's scheduling constraints.                        |                 | Map                                                                                                            |         |
| spec.template.spec.tolerations  | Tolerations is the runtime reporter pod's tolerations.                                    |                 | [corev1.Tolerations](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#toleration-v1-core)  |         |
