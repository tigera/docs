...
| loadBalancer         | Loadbalancer configuration for this node. This is applicable only if the eBPF dataplane is enabled in [Felix Configuration](felixconfig.mdx). |                 | [LoadBalancer](#loadbalancer) |
