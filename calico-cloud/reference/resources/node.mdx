...
| wireguard            | WireGuard configuration for this node. This is applicable only if WireGuard is enabled in [Felix Configuration](/reference/resources/felixconfig.mdx). |                 | [WireGuard](#wireguard)      |
