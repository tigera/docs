...
import Ipnat from '@site/calico-cloud/_includes/content/_ipnat.mdx';
...
For more information, see the [multiple-networks how-to guide](/networking/configuring/multiple-networks).
...
be referenced as a named port in [policy rules](/reference/resources/networkpolicy#entityrule).

| Field    | Description                                                                                                                                              | Accepted Values      | Schema | Default |
| -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- | ------ | ------- |
| name     | The name to attach to this port, allowing it to be referred to in [policy rules](/reference/resources/networkpolicy#entityrule). Names must be unique within an endpoint. |                      | string |         |
