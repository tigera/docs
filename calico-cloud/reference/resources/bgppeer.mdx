...
[{{prodname}} over IP fabrics](/reference/architecture/design/l3-interconnect-fabric).
...
| password                 | [BGP password](/operations/comms/secure-bgp) for the peerings generated by this BGPPeer resource.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |                                                                                             | [BGPPassword](#bgppassword) | `nil` (no password)                                                          |
...
> [BGPConfiguration resource](/reference/resources/bgpconfig). That value can be overridden per-node by using the `bgp` field of
> the [node resource](/reference/resources/node).
