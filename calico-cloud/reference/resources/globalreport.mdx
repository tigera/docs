...
| --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------- |
| reportType      | The type of report to produce. This field controls the content of the report - see the links for each type for more details.                                                                                                                                                                                | Yes      | [cis&#8209;benchmark](/reference/resources/compliance-reports/cis-benchmark.mdx), [inventory](/reference/resources/compliance-reports/inventory.mdx), [network&#8209;access](/reference/resources/compliance-reports/network-access.mdx), [policy&#8209;audit](/reference/resources/compliance-reports/policy-audit.mdx) | string                                    |
...
> **Note**: To use the {{prodname}} compliance reporting feature, you must ensure all required resource types
> are being audited and the logs archived in Elasticsearch. You must explicitly configure the [Kubernetes API
> Server](/visibility/kube-audit.mdx) to send audit logs for Kubernetes-owned resources
> to Elasticsearch.
