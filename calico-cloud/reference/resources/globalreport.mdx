...
| --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------- |
| reportType      | The type of report to produce. This field controls the content of the report - see the links for each type for more details.                                                                                                                                                                                | Yes      | [cis&#8209;benchmark](/reference/resources/compliance-reports/cis-benchmark), [inventory](/reference/resources/compliance-reports/inventory), [network&#8209;access](/reference/resources/compliance-reports/network-access), [policy&#8209;audit](/reference/resources/compliance-reports/policy-audit) | string                                    |
...
> Server](/visibility/kube-audit) to send audit logs for Kubernetes-owned resources
> to Elasticsearch.
