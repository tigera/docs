...
- **Azure user-defined routes**: This option provides networking without overlays.
  ...
  [Configuring {{nodecontainer}}](/reference/component-resources/node/configuration) and [Azure user-defined routes](#azure-user-defined-routes) for more information. If you're on Kubernetes, refer to [Self-managed Kubernetes in Microsoft Azure](/getting-started/install-on-clusters/kubernetes/self-managed-public-cloud/azure/).
