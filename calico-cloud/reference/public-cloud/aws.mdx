...
See the [IP pool configuration reference](/reference/resources/ippool.mdx)
...
you must configure outgoing NAT on your [{{prodname}} IP pool](/reference/resources/ippool.mdx).
