...
See the [IP pool configuration reference](/reference/resources/ippool.mdx) for information on how to configure {{prodname}} IP pools.
...
To allow {{prodname}} networked containers to reach resources outside of GCE, you must configure outgoing NAT on your [{{prodname}} IP pool](/reference/resources/ippool.mdx).
