...
# Trace and block suspicious domains
...
A best practice is to develop an allow-list of "known-good" domains that particular applications or services must access, and then [enforce this allow-list with network policy](/network-policy/domain-based-policy).
...
See [GlobalThreatFeed](/reference/resources/globalthreatfeed) resource definition for all configuration options.
