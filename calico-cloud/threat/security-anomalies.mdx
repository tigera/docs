...
import AnomalyDetectionMonitor from '@site/calico-cloud/_includes/content/anomaly-detection/_monitor.mdx';

import AnomalyDetectionEnableDisableCommon from '@site/calico-cloud/_includes/content/anomaly-detection/_enable-disable-common.mdx';
