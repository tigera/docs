...
[Honeypods are configured](/threat/honeypod/honeypods.mdx) for clusters, and alerts are generated when the honeypods are accessed.
...
The following manifest enables packet capture on default [honeypods](/threat/honeypod/honeypods.mdx).
