---
title: Alert on suspicious activity in a Kubernetes cluster
...
```bash
kubectl apply -f {{url}}{{baseUrl}}/manifests/threatdef/honeypod/common.yaml
```
...
```bash
kubectl apply -f {{url}}{{baseUrl}}/manifests/threatdef/honeypod/ip-enum.yaml
```
...
```bash
kubectl apply -f {{url}}{{baseUrl}}/manifests/threatdef/honeypod/expose-svc.yaml
```
...
```bash
kubectl apply -f {{url}}{{baseUrl}}/manifests/threatdef/honeypod/vuln-svc.yaml
```
