...
When modifying the provided honeypod manifests, be sure to update the [globalalert](/reference/resources/globalalert) section in the manifest to match your changes. Ensure the alert name has the prefix `honeypod`, for example `honeypod.new.alert`.
...
- [Monitor honeypods](/threat/honeypod/honeypod-controller)
- [GlobalAlerts](/reference/resources/globalalert)
