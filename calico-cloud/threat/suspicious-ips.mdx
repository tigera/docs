...
1. Create a file called feodo-tracker.yaml with the following contents:
   ...
   This pulls updates using the default period of once per day. See the [Global Resource Threat Feed API](/reference/resources/globalthreatfeed) for all configuration options.
