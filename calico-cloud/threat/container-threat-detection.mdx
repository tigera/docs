...
### Create Exceptions for runtime logs

If there is a program running within the cluster that is performing a suspicious action but you want to except it from create a runtime log, and thus from triggering a Security Event. Then you can create an Excetpion in the Runtime Security CR: 
