...
[ModSecurity](https://owasp.org/www-project-modsecurity-core-rule-set/) with OWASP CoreRuleSet v3.3.5 modified for kubernetes workloads. To review the rules deployed with the WAF, see [Ruleset files]([Ruleset files](https://github.com/tigera/operator/tree/master/pkg/render/applicationlayer/embed/coreruleset/rules)).
...
- [modsecdefault.conf](https://github.com/tigera/operator/blob/master/pkg/render/applicationlayer/embed/coreruleset/modsecdefault.conf)
- [crs-setup.conf](https://github.com/tigera/operator/blob/master/pkg/render/applicationlayer/embed/coreruleset/crs-setup.conf)
