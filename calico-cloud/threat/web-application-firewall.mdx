...
Create or update the [ApplicationLayer](../reference/installation/api.mdx#operator.tigera.io/v1.ApplicationLayer) resource to include the webApplicationFirewall section of the file. Ensure value of the field is set to Enabled.
...
For completeness, it is a good practice to download these bootstrapping configuration files
...
<img
  src='/img/calico-cloud/master/waf-kibana.png'
...
<img
  src='/img/calico-cloud/master/waf-alert.png'
  alt='WAF alert'
  width='600'
/>
