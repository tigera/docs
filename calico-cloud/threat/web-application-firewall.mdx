...
You can enable WAF in your cluster using the User Interface:
- click on **Threat Defense** and select **Web Application Firewall**

<img
  src='/img/calico-enterprise/master/waf-menu.png'
  alt='Threat Defense / WAF'
  width='600'
/>

- on the page click on **Configure Web Application Firewall** to enable WAF in the cluster.

<img
  src='/img/calico-enterprise/master/waf-configure.png'
  alt='Configure cluster for WAF'
  width='600'
/>
...
Once you cluster is configured for WAF you will be presented with a list of Kubernetes services available in the cluster:
