...
For help on using IP in IP and/or VXLAN overlays, see [Configure overlay networking](/networking/configuring/vxlan-ipip).

For help on using WireGuard encryption, see [Configure WireGuard encryption](/compliance/encrypt-cluster-pod-traffic).
