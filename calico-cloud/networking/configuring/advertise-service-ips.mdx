...
- Calico CNI
- [Configure BGP peering](/networking/configuring/bgp.mdx) between {{prodname}} and your network infrastructure
...
1. Determine the service cluster IP range. (Or ranges, if your cluster is [dual stack](/networking/ipam/ipv6.mdx).)
