...
- [Install and configure calicoctl](/maintenance/clis/calicoctl/index) or configure access to [Calico Enterprise Manager UI](/maintenance/cnx//access-the-manager/)
