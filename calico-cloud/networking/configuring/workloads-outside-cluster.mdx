...
If you choose to implement {{prodname}} networking with [BGP peered with your physical network infrastructure](/networking/configuring/bgp), you can use your own infrastructure to NAT traffic from pods to the internet. In this case, you should disable the {{prodname}} `natOutgoing` option. For example, if you want your pods to have public internet IPs, you should:
