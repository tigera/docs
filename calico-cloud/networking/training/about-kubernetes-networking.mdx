...
- Pods can communicate with all other pods in the cluster using pod IP addresses (without
  [NAT](/networking/training/about-networking.mdx))
...
Kubernetes network implementations use [overlay networks](/networking/training/about-networking.mdx#overlay-networks).
