...
View pods running vulnerability images for all your Managed Clusters.

## Value

Runtime View collects image information from all the pods running in all of your connected Managed Clusters. This information is linked to uploaded image scan results so you can see if you clusters are running vulnerable images.
...
Ensure that all Managed Clusters connected to your Management Cluster are running a Kubernetes using a CRI for container management.
