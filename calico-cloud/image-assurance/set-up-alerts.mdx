---
title: Set up alerts on vulnerabilities
...
To create alerts, use the [Global alert resource](/reference/resources/globalalert).
...
For a complete list of parameters, see [Global alert resource](/reference/resources/globalalert).
