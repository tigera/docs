...
* **Dismiss:** Temporarily hide scan results that are not immediately important. Dismissed scan results will be marked as 'Unknown', and you can review or restore them by enabling the Dismissed toggle filter and turning it on.
