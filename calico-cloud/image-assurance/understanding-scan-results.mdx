...
The scanning process also attaches EPSS and known exploit data onto each image and vulnerability.

EPSS information can be found [here](https://www.first.org/epss/model).
