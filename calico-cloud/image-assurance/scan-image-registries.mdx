...
- [Set up alerts on vulnerabilities](/image-assurance/set-up-alerts.mdx)

- Create [policy](/image-assurance/install-the-admission-controller.mdx) to block vulnerable containers from deploying to your cluster
