...
To see the latest version, see [Release notes](/release-notes/index).
...
- [Set up alerts on vulnerabilities](/image-assurance/set-up-alerts)

- Create [policy](/image-assurance/install-the-admission-controller) to block vulnerable containers from deploying to your cluster
