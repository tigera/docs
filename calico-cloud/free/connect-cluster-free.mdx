...
Not sure if you meet these requirements? Run the interactive installation tool!

## Interactive Compatibility Checker and Installer

The interactive installation tool:

1. Check if your cluster meets the prerequisites
2. Check if your Calico installation meets requirements and offers to update if possible.
3. Automatically connect the cluster to Calico Cloud Free Tier.
...
1. Follow the prompts to create a name for your cluster and click the "Download Installer" button .
1. Execute the script:
   ```
   bash oss-install.sh
   ```

  Note: the bash script contains embedded credentials for your cluster so be careful!
