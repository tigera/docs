...
![expiration](/img/calico-cloud/master/expiration.png)
...
- [Prometheus!](/maintenance/monitor/metrics/license-agent). Monitor days till expiration, nodes available, and nodes used.
- Use `kubectl` to get [license key information](/reference/resources/licensekey#viewing-information-about-your-license-key)
