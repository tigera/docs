...
![anomaly-detection-single-alert](/img/calico-cloud/master/anomaly-detection-single-alert.png)

**Service Graph**

From the left navbar, click Service Graph. Monitor security performance in the bottom panel.

![anomaly-detection-service-graph-alerts-tab](/img/calico-cloud/master/anomaly-detection-service-graph-alerts-tab.png)
