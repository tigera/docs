    ...
    -p '{"spec":{"template":{"spec":{"imagePullSecrets":[{"name": "tigera-pull-secret"}]}}}}'`}
        ...
        {props.clusterType === 'managed' ? (
          <li>
            ...
            <CodeBlock language='batch'>curl -O -L {filesUrl_CE}/manifests/aks/custom-resources.yaml</CodeBlock>
            <p>
  ...
  nodes:
    count: 1`}
          ...
          <li>
            ...
            <CodeBlock>kubectl create -f {filesUrl_CE}/manifests/aks/custom-resources.yaml</CodeBlock>
            <p>You can now monitor progress with the following command:</p>
            <CodeBlock>watch kubectl get tigerastatus</CodeBlock>
          </li>
        )}
    ...
    -p '{"spec":{"template":{"spec":{"imagePullSecrets":[{"name": "tigera-pull-secret"}]}}}}'`}
        ...
        {props.clusterType === 'managed' ? (
          <li>
            ...
            <CodeBlock language='batch'>curl -O -L {filesUrl_CE}/manifests/aks/custom-resources-calico-cni.yaml</CodeBlock>
            <p>
              Remove the <code>Manager</code> custom resource from the manifest file.
            </p>
            <CodeBlock language='yaml'>
  ...
  nodes:
    count: 1`}
          ...
          <li>
            ...
            <CodeBlock>kubectl create -f {filesUrl_CE}/manifests/aks/custom-resources-calico-cni.yaml</CodeBlock>
            <p>You can now monitor progress with the following command:</p>
            <CodeBlock>watch kubectl get tigerastatus</CodeBlock>
          </li>
        )}
