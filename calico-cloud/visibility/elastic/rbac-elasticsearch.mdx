...
- A `tigera-network-admin` role with full permissions to create and modify resources. For help, see [Log in to {{prodname}} Manager](/maintenance/cnx/authentication-quickstart/).
