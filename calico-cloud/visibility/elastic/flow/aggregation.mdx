...
The following is a sample flow log entry using aggregation by pod prefix for allowed traffic. For flow log fields and filter parameters, see [Filter flow logs](/visibility/elastic/flow/filtering.mdx).
...
- Verify that the parameters that you want to see in your aggregation level, are not already [filtered](/visibility/elastic/flow/filtering.mdx)
...
- [Archive logs to storage](/visibility/elastic/archive-storage.mdx)
