...
1. Create a `filters` directory with a file called `flow` with your desired filters. If you are also adding [dns filters](/visibility/elastic/dns/filtering-dns.mdx), add the `dns` file to the directory.
...
- [Flow log aggregation](/visibility/elastic/flow/aggregation.mdx)
