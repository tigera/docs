...
{{prodname}} also supports archiving [Cloudwatch for EKS audit logs](/reference/installation/api#operator.tigera.io/v1.LogCollectorSpec).
...
- [Configure flow log aggregation](/visibility/elastic/flow/aggregation)
- [Audit logs](/visibility/elastic/audit-overview)
- [BGP logs](/visibility/elastic/bgp)
- [DNS logs](/visibility/elastic/dns/dns-logs)
- [Archive logs](/visibility/elastic/archive-storage)
- [Log collection options](/reference/installation/api#operator.tigera.io/v1.LogCollectorSpec)
