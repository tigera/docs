...
| runtime  | File and process activity used in container threat detection to compare against known malicious program fingerprints and activity patterns. | {{prodname}} container threat detection     | `ee_runtime` | `tigera_secure_ee_runtime*`   |
