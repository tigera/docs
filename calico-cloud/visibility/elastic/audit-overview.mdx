...
![audit-logs](/img/calico-cloud/audit-logs.png)
...
![kibana-auditlogs](/img/calico-cloud/kibana-auditlogs.png)

Finally, audit logs provide the core data for compliance reports.

![configuration-compliance](/img/calico-cloud/configuration-compliance.png)
