...
From the left navbar in Manager UI, select **Activity**, \*\*Timeline. You can filter logs, and export data in .json or .yaml formats.

![audit-logs](/img/calico-cloud/master/audit-logs.png)
...
![kibana-auditlogs](/img/calico-cloud/master/kibana-auditlogs.png)

Finally, audit logs provide the core data for compliance reports.

![configuration-compliance](/img/calico-cloud/master/configuration-compliance.png)
