...
![audit-logs](/img/calico-enterprise/master/audit-logs.png)
...
![kibana-auditlogs](/img/calico-enterprise/master/kibana-auditlogs.png)

Finally, audit logs provide the core data for compliance reports.

![compliance-reports](/img/calico-enterprise/master/configuration-compliance.png)
...
- [Enable Kubernetes audit logs](/visibility/kube-audit.mdx)
