...
3. You can enable TLS option for syslog forwarding by including the "encryption" option in the [Syslog section](/reference/installation/api#operator.tigera.io/v1.SyslogStoreSpec).
