...
All users can view the status and health of the Calico Cloud service on our new status page: {% include open-new-window.html text='https://status.calicocloud.io' url='https://status.calicocloud.io/' %}.
...
To get started see, [Container Threat Detection]({{site.baseurl}}/threat/container-threat-detection)

### September 26, 2022

#### New feature: Helm

{{site.prodname}} now supports [installation using Helm]({{ site.baseurl }}/get-started/connect/install-cluster).

#### New feature: Private Registry

{{site.prodname}} now supports [installation from private registries](https://docs.calicocloud.io/get-started/connect/install-cluster). Note that this is only supported when installing with Helm.
