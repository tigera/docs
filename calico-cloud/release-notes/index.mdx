...
For more information, see [Connect a cluster to Calico Cloud using Helm](../get-started/install-cluster.mdx).
...
{{prodname}} now supports [installation from private registries](https://docs.calicocloud.io/get-started/install-cluster). Note that this is only supported when installing with Helm.
