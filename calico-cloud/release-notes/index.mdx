...
* It is no longer supported to uninstall $[prodname] on a cluster that before connecting to $[prodname] it had Calico managed with add-on manager. This includes AKS clusters that had Calico installed and managed by AKS.
