...
[ModSecurity](https://owasp.org/www-project-modsecurity-core-rule-set/) with OWASP CoreRuleSet v3.3.5 modified for kubernetes workloads. To review the rules deployed with the WAF, see [Ruleset files](https://github.com/tigera/operator/tree/{{tigeraOperator.version}}/pkg/render/applicationlayer/modsec-core-ruleset).
...
- [modsecdefault.conf](https://github.com/tigera/operator/tree/{{tigeraOperator.version}}/pkg/render/applicationlayer/modsec-core-ruleset/modsecdefault.conf)
- [crs-setup.conf](https://github.com/tigera/operator/tree/{{tigeraOperator.version}}/pkg/render/applicationlayer/modsec-core-ruleset/crs-setup.conf)
- [Ruleset files](https://github.com/tigera/operator/tree/{{tigeraOperator.version}}/pkg/render/applicationlayer/modsec-core-ruleset)
