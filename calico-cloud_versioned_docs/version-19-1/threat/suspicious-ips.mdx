...
{variables.prodname} supports pull methods for updating threat feeds. Use this method for fully automated threat feed updates without user intervention.
...
This section describes how to pull threat feeds to {variables.prodname}, and block traffic to a cluster for a suspicious IP.
