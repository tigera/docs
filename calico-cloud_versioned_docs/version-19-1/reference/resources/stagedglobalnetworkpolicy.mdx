...
`StagedGlobalNetworkPolicy` resources can be used to define network connectivity rules between groups of {variables.prodname} endpoints and host endpoints.
<!--TODO-XREF-CC
