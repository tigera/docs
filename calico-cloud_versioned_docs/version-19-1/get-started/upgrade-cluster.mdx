...
To upgrade managed clusters to the latest version of {variables.prodname}:

1. In Manager UI, go to **Managed Clusters**.
1. For the cluster you want to upgrade, select **Actions** > **Reinstall**.
1. Select the version of {variables.prodname} you want to install, you can select the currently installed version, or any newer supported version
