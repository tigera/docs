...
{variables.prodname} Admins can view product usage metrics on the **Usage Metrics** page of the UI.
...
{variables.prodname} provides users with 200 GB per month of ingested data, which is included in the standard pricing before overage charges are incurred. Additional data usage is charged at a rate of $0.25 / GB / month.
