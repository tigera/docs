...
import License from '@site/calico-cloud_versioned_docs/version-19-1/_includes/content/_license.mdx';
...
1. Apply the manifest.
   <CodeBlock language=''>
    kubectl apply -f {variables.filesUrl_CE}/manifests/licenseagent.yaml
   </CodeBlock>
