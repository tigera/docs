...
{variables.prodname} supports Google Social login and username / password for user authentication.
...
The Owner role cannot be assigned to new users. The only Owner is the user who created the {variables.prodname} account.

:::

## Add your own identity provider

{variables.prodname} works with any identity provider that supports [OpenID Connect](https://openid.net/connect/). For example, OKTA, Google, and Azure AD.
