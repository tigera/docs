...
{variables.prodname} comes with a set of predefined global roles that let you give permissions to users based on what they need to do.
...
## Required permissions for common {variables.prodname} features

Certain permissions are required for a user to access common {variables.prodname} features.
...
1. Click the user icon <IconUser width="20"/> > **Manage Team**.
1. Under the **Roles** tab, click **Export Custom Roles** and select **Export YAML** to download the custom role definitions.
