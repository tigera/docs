...
**What happens when a license expires or is invalid?**  
 Users can log in to the web console with read/access for all previously-created resources, but they cannot create any new $[prodname] resources. The web console may appear to function, but actions will not be applied; so it is important to proactively managed your license.
