...
- You are signed in to the web console and you have [Owner or Admin privileges](../users/user-management.mdx).
...
## Manage and monitor multiple clusters in the web console

### Access your managed clusters

Each time you install $[prodname] on a cluster, the cluster is added to the drop-down menu in the web console.
