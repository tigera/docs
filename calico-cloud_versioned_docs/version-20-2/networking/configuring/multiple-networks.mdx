...
<!--//TODO-CC-XREFS- [Install and configure calicoctl](/operations/clis/calicoctl/index) or configure access to [the web console](/operations/cnx//access-the-manager/)-->
