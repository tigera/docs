...
* **Cluster Health:**: Lorem ipsum, et cetera.
* **Security Posture:** Lorem ipsum, et cetera.
* **Data Volume:** Lorem ipsum, et cetera.
* **DNS Logs:** Lorem ipsum, et cetera.
* **Flow Log:** Lorem ipsum, et cetera.
* **L7:** Lorem ipsum, et cetera.
* **TCP Performance:** Lorem ipsum, et cetera.
* Custom dashboards: Lorem ipsum, et cetera.
  For more information, see [Create a custom dashboard](../../visibility/dashboards.mdx#create-a-custom-dashboard).
