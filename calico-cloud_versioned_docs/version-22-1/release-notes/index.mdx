...
<h2 id="22.0.1">September DD, 2025 (version 22.0.1</h2>

### Bug fixes

* Fixed a security vulnerability by removing the impersonate permission for the calico-guardian ClusterRole.
