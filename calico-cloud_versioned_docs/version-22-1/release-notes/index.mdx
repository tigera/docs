...
#### External load balancers for Calico Ingress Gateway (tech preview)
...
#### Policy recommendations for Calico Cloud Free

We added support for policy recommendations for Calico Cloud Free.
