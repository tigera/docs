...
const variables = {
  ...
  cloudUserVersion: 'v22.0.1',
  prodname: 'Calico Cloud',
  manifestsUrl: 'https://raw.githubusercontent.com/projectcalico/calico/v3.30.3',
  prodnamedash: 'calico-cloud',
  baseUrl: '/calico-cloud',
  filesUrl: 'https://docs.calicocloud.io',
  filesUrl_CE: 'https://downloads.tigera.io/ee/v3.22.0-1.0',
  tutorialFilesURL: 'https://docs.tigera.io/files',
  prodnameWindows: 'Calico Enterprise for Windows',
  rootDirWindows: 'C:\\TigeraCalico',
  nodecontainer: 'cnx-node',
  noderunning: 'calico-node',
  cloudversion: 'v3.22.0-1.0-8', // TODO: Update for CC 22.0.1
  clouddownloadurl: 'https://installer.calicocloud.io/manifests/v3.22.0-1.0-8', // TODO: Update for CC 22.0.1
