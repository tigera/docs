...
1. Generate the certificate key pair.
   ...
   export URL="{variables.clouddownloadurl}/manifests" && curl ${URL}/generate-open-ssl-key-cert-pair.sh | bash
   </CodeBlock>
