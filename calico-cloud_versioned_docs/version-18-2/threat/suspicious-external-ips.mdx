...
1. Download the patch file to patch-ingress.yaml.
   ...
   curl {variables.filesUrl_CE}/manifests/ingress/patch-ingress.yaml -O
   </CodeBlock>
...
<!--TODO-XREFS-CC - [{variables.prodname} installed](/getting-started/index)-->
...
1. Download the appropriate patch file for enabling the Policy Sync API on Felix.
   <CodeBlock language='bash'>
   curl {variables.filesUrl_CE}/manifests/ingress/patch-flexvol.yaml -O
   </CodeBlock>
