...
- [modsecdefault.conf](https://github.com/tigera/operator/tree/{{tigeraOperator.version}}/pkg/render/applicationlayer/coreruleset/modsecdefault.conf)
- [crs-setup.conf](https://github.com/tigera/operator/tree/{{tigeraOperator.version}}/pkg/render/applicationlayer/coreruleset/crs-setup.conf)
- [Ruleset files](https://github.com/tigera/operator/tree/{{tigeraOperator.version}}/pkg/render/applicationlayer/coreruleset/rules)
