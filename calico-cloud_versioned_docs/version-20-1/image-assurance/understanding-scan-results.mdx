...
An EPSS score of 0.1 - or 10% - means a vulnerability has a 10% probability that the vulnerability will be exploited in the wild within the next 30 days. 
Users should use this information alongside CVSS scores to prioritize remediating vulnerabilities. 
...
Known exploits are based off of the [CISA KEV Catalog](https://www.cisa.gov/known-exploited-vulnerabilities-catalog).
