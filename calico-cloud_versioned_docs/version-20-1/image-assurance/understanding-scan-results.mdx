...
all critical or high vulnerabilities, but you can use the EPSS score to help prioritize those critical or high vulnerabilities with an EPSS score of > 90% in order to target those that are most likely to be exploited.
