...
1. Download the <Link to={variables.tutorialFilesURL + '/min-ui-user-rbac.yaml'}>min-ui-user-rbac.yaml manifest</Link>.
...
1. Download the <Link to={variables.tutorialFilesURL + '/read-all-crud-default-rbac.yaml'}>`read-all-crud-default-rbac.yaml` manifest</Link>.
