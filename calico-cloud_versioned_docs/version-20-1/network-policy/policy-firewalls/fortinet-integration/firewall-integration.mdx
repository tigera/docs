...
1. In the <Link to={variables.filesUrl_CE + '/manifests/fortinet-device-configmap.yaml'}>Fortigate ConfigMap manifest</Link>, add your FortiGate firewall information in the data section, `tigera.firewall.fortigate`.
...
1. In the <Link to={variables.filesUrl_CE + '/manifests/fortinet-device-configmap.yaml'}>FortiManager ConfigMap manifest</Link>, add your FortiManager information in the data section, `tigera.firewall.fortimgr`.
