...
<Link to={variables.downloadsurl + '/ee/archives/release-v3.15.0-v1.28.6.tgz'}>Release archive</Link> with Kubernetes manifests. Based on Calico v3.24.
...
{variables.prodname} has rearchitected Egress Gateway pods to improve security and make use of a temporary init container to set up packet forwarding. [Link to documentation](../../networking/egress/egress-gateway-on-prem.mdx)
