...
To learn more about {variables.prodname} network policies, read the [Get started with {variables.prodname} network policy](../../network-policy/beginners/calico-network-policy.mdx)
 guide.
...
For more flexible control and delegation of responsibilities between two or more teams, {variables.prodname} extends this
