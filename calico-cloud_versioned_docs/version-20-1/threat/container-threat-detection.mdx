...
- (Optionally) Validate your changes by checking the detector settings page in the UI.

:::note

If duplicate detector IDs are present in the RS CR. The last entry will take precedence.
