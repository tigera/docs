---
title: Block suspicious domains
...
A best practice is to develop an allow list of "known-good" domains that particular applications or services must access, and then [enforce this allow list with network policy](../../security/beginners/domain-based-policy.mdx).
...
1. Create the GlobalThreatFeed YAML and save it to file.
   ...
   spec:
     ...
     pull:
       http:
         url: https://my.threatfeed.com/denylist
   ```
