...
A deep packet inspection resource (`DeepPacketInspection`) represents live netwrok traffic monitor for malicious activities by analyzing header and payload of the packet using specific rules. Malicious activities are addeed to the “Alerts” page in {{prodname}} Manager.
