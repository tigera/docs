...
quay.io/tigera/image-assurance-admission-controller:v1.8.4
quay.io/tigera/image-assurance-operator:v1.8.4
quay.io/tigera/image-assurance-container-runtime-adaptor:v1.8.4
quay.io/tigera/image-assurance-cluster-scanner:v1.8.4
quay.io/tigera/runtime-security-operator:v1.8.0
quay.io/tigera/skimble:v1.8.0
