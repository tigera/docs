...
1. Download the tutorial YAML, creating the necessary resources [`policy-recommendation-deployments.yaml` manifest]({{tutorialFilesURL}}/policy-recommendation-deployments.yaml).
