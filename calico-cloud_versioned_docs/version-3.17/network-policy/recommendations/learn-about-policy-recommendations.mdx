...
Wait for the recommendations to be generated. Unless otherwise configured, the recommendations will take at least 2m30s to be generated, time equal to the default [Processing Interval spec](../resources/globalnetworkpolicy.mdx#spec).
