...
The Image Assurance scanner is available in a containerized version so you can easily update it as part of a container-or Kubernetes-based pipeline.
...
To get the latest updates, you must update the scanner binary. To see the current version you are running, run this command:
