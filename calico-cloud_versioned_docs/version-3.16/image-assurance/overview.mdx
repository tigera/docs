...
# Choosing an image scanning method
...
The Image Assurance scanner can be used to scan images using the following methods with the option to send results to the Manager UI.
...
- [Scan all images in a Kubernetes cluster](./scanners/cluster-scanner.mdx)
- [Integrate Image Assurance scanner in your build pipeline](./scanners/pipeline-scanner.mdx)
