...
You can get up and running with {{prodname}} without needing to be a networking expert. Calico hides the complexities for
...
{{prodname}} to provide an overlay network, or non-overlay network. You can read more about this in the
[Calico Enterprise determine best networking option](https://docs.tigera.io/calico-enterprise/latest/networking/determine-best-networking.mdx) guide.
