...
this in the [Calico Enterprise determine best networking option](https://docs.tigera.io/calico-enterprise/latest/networking/determine-best-networking.mdx)
guide.
...
overlay network, or prefer to have fully routable pod IPs. You can read more about this in the [Calico Enterprise determine best networking option](https://docs.tigera.io/calico-enterprise/latest/networking/determine-best-networking.mdx) guide. {{prodname}} also
