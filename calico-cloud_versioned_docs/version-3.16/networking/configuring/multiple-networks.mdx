...
# Configure multiple {{prodname}} networks on a pod
...
<!--//TODO-CC-XREFS- [Install and configure calicoctl](/operations/clis/calicoctl/index) or configure access to [{{prodname}} Manager UI](/operations/cnx//access-the-manager/)-->
