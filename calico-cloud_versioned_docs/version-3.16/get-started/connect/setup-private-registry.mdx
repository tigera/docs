...
quay.io/tigera/image-assurance-admission-controller:v1.7.3
quay.io/tigera/image-assurance-operator:v1.7.3
quay.io/tigera/image-assurance-container-runtime-adaptor:v1.7.3
quay.io/tigera/image-assurance-cluster-scanner:v1.7.3
quay.io/tigera/runtime-security-operator:v1.7.0
quay.io/tigera/skimble:v1.7.0
