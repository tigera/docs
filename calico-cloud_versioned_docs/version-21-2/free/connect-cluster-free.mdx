...
Try the [Calico Cloud Free quickstart guide](quickstart.mdx) to deploy a cluster locally and connect it to Calico Cloud Free.
:::

## Prerequisites
* You have a Kubernetes cluster that is running Calico Open Source 3.30 or later.
...
* Follow the [quickstart guide from *Step 4. Deploy NGINX and BusyBox to generate traffic*](quickstart.mdx#step-4-deploy-nginx-and-busybox-to-generate-traffic).
