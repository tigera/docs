...
* Logs for application layer polices are not included in flow log visualization tools such as Service Graph.
  To view logs for application layer policies, [do this](#).
