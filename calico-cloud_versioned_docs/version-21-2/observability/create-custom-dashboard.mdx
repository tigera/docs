...
<Screenshot alt="Screenshot of Calico Cloud web console with view of custom dashboard." src="/img/calico-cloud/custom-dashboard.png" />
...
<Screenshot alt="Screenshot of Calico Cloud web console with view of edit card page." src="/img/calico-cloud/edit-card.png" />
