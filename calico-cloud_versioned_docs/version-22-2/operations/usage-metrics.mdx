...
To view usage metrics, Calico Cloud Owners or users with Usage Metrics role can go to the web console, click the user icon <IconUser width="20"/>, and then click **Usage Metrics**.

<Screenshot src="/img/calico-cloud/usage-metrics.png" alt="A screenshot of the Usage Metrics page in the Calico Cloud web console." maxW="90%" />
