---
description: Reference for the PacketCapture resource in Calico Cloud connected clusters that captures pcap files from selected workloads for offline analysis.
---
...
[packet capture]: /observability/packetcapture.mdx