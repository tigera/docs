---
description: Reference for the RemoteClusterConfiguration resource in Calico Cloud that federates resources between connected clusters for shared identity.
---
