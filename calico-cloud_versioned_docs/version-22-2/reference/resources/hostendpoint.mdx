---
description: Reference for the HostEndpoint resource in Calico Cloud connected clusters that represents a host network interface for tiered policy enforcement.
---

# Host endpoint

import Endpointport from '@site/calico-cloud_versioned_docs/version-22-2/_includes/content/_endpointport.mdx';
