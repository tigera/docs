...
import EbpfValue from '@site/calico-cloud_versioned_docs/version-19-2/_includes/content/_ebpf-value.mdx';
...
- [Configure {variables.prodname} to talk directly to the API server](#configure-calico-cloud-to-talk-directly-to-the-api-server)
