...
guides without needing to be a networking expert. {variables.prodname} hides the complexities for
...
{variables.prodname} to provide an overlay network, or non-overlay network.
<!--TODO-XREFS-CC
You can read more about this in the {variables.prodname}
