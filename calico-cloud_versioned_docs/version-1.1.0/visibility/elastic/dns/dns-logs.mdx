...
{{prodname}} pushes DNS activity logs to Elasticsearch, for DNS information that is obtained from [trusted DNS servers](../../../security/beginners/domain-based-policy.mdx#trusted-dns-servers). The following table
