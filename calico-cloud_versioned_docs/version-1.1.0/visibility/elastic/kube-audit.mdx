...
1. Enable the **Audit** option, and click **Update**.
   <img
     src='/img/calico-cloud/audit-log.png'
     alt='Audit Log'
     width='300'
   />
...
1. Under **Logging**, **Cloudwatch**, make a note of the URL value for a later step, then click the link.
   <img
     src='/img/calico-cloud/cloudwatch-url.png'
...
1. In the **Log Streams** list, make note of the common prefix (for example, kube-apiserver-audit) for a later step.
   <img
     src='/img/calico-cloud/log-streams.png'
     alt='Log Streams'
     width='400'
   />
...
1. On the **Add user** page, make these changes:
   ...
   <img
     src='/img/calico-cloud/programmatic-access.png'
   ...
   <img
     src='/img/calico-cloud/cloudwatch-readonly.png'
     alt='Cloudwatch URL'
     width='400'
   />
