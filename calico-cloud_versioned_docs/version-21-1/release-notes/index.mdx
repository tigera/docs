...
### Introducing Calico Cloud Free

We are excited to introduce Calico Cloud Free, a new offering designed to provide users of Calico Open Source with powerful observability tools at no cost.
...
Calico Cloud Free offers a selection of core observability features from the full Calico Cloud platform, focused on helping you understand what's happening within your Calico Open Source cluster.
...
For more information about Calico Cloud Free, see the [overview](../free/overview.mdx) or the [quickstart guide](../free/quickstart.mdx).

<h3 id="21.2.0">April 29, 2025 (version 21.2.0)</h3>
...
<h3 id="21.1.0">April 1, 2025 (version 21.1.0)</h3>
...
<h3 id="21.0.0">March 10, 2025 (version 21.0.0)</h3>
...
<h3 id="20.4.0">February 11, 2025 (version 20.4.0)</h3>
...
<h3 id="20.3.1">December 19, 2024 (version 20.3.1)</h3>
