...
{/*//TODO-CC-XREFS- [Install and configure calicoctl](/operations/clis/calicoctl/index) or configure access to [the Calico Enterprise web console](/operations/cnx//access-the-manager/)*/}
