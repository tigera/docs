import NonClusterReadOnlyStep from '@site/calico-cloud_versioned_docs/version-21-1/_includes/content/_non-cluster-read-only-step.mdx';
import EnvironmentFile from '@site/calico-cloud_versioned_docs/version-21-1/_includes/components/EnvironmentFile';
