...
<h2 id="image-assurance.operator.tigera.io/v1" class="anchor anchorWithStickyNavbar">image-assurance.operator.tigera.io/v1</h2>
<div>
<p>
...
<h3 id="image-assurance.operator.tigera.io/v1.CrawdadDaemonSet" class="anchor anchorWithStickyNavbar">CrawdadDaemonSet</h3>
<p>
...
<h3 id="image-assurance.operator.tigera.io/v1.CrawdadDaemonSetContainer" class="anchor anchorWithStickyNavbar">CrawdadDaemonSetContainer</h3>
<p>
...
<h3 id="image-assurance.operator.tigera.io/v1.CrawdadDaemonSetPodSpec" class="anchor anchorWithStickyNavbar">CrawdadDaemonSetPodSpec</h3>
<p>
...
<h3 id="image-assurance.operator.tigera.io/v1.CrawdadDaemonSetPodTemplateSpec" class="anchor anchorWithStickyNavbar">CrawdadDaemonSetPodTemplateSpec</h3>
<p>
...
<h3 id="image-assurance.operator.tigera.io/v1.CrawdadDaemonSetSpec" class="anchor anchorWithStickyNavbar">CrawdadDaemonSetSpec</h3>
<p>
...
<h3 id="image-assurance.operator.tigera.io/v1.Exclusions" class="anchor anchorWithStickyNavbar">Exclusions</h3>
<p>
...
<h3 id="image-assurance.operator.tigera.io/v1.ImageAssurance" class="anchor anchorWithStickyNavbar">ImageAssurance</h3>
<p>
...
<h3 id="image-assurance.operator.tigera.io/v1.ImageAssuranceSpec" class="anchor anchorWithStickyNavbar">ImageAssuranceSpec</h3>
<p>
...
<h3 id="image-assurance.operator.tigera.io/v1.ImageAssuranceStatus" class="anchor anchorWithStickyNavbar">ImageAssuranceStatus</h3>
<p>
