---
description: Connect a Kubernetes cluster to Calico Cloud when its container images must be pulled from a private registry.
...
* You have [added the Calico Cloud images to a private registry](setup-private-registry.mdx) for the version you are installing, including its operator image, and you have the following information about the registry:
