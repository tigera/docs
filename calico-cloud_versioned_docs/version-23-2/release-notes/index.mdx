...
* L7 logging with Envoy is deprecated and will be removed in an upcoming release.
  For L7 observability, $[prodname] is moving to [Istio Ambient Mode](../compliance/istio/about-istio-ambient.mdx).

<h2 id="june-15-2026">June 22, 2026 (version 22.5.0)</h2>
