import NonClusterReadOnlyStep from '@site/calico-cloud_versioned_docs/version-23-2/_includes/content/_non-cluster-read-only-step.mdx';
import EnvironmentFile from '@site/calico-cloud_versioned_docs/version-23-2/_includes/components/EnvironmentFile';
