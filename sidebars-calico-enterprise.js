  ...
  calicoEnterpriseSidebar: [
          ...
          items: [
            ...
            'getting-started/install-on-clusters/tkg',
            {
              ...
              items: [
                ...
                'getting-started/install-on-clusters/windows-calico/quickstart',
                'getting-started/install-on-clusters/windows-calico/demo',
                {
                  type: 'category',
                  label: 'Kubernetes',
                  link: {type: 'doc', id:'getting-started/install-on-clusters/windows-calico/kubernetes/index'},
                  items: [
                    'getting-started/install-on-clusters/windows-calico/kubernetes/requirements',
                    'getting-started/install-on-clusters/windows-calico/kubernetes/standard',
                    'getting-started/install-on-clusters/windows-calico/kubernetes/rancher',
                  ],
                },
                'getting-started/install-on-clusters/windows-calico/openshift-installation',
                'getting-started/install-on-clusters/windows-calico/flowlogs',
                'getting-started/install-on-clusters/windows-calico/dnspolicy',
                'getting-started/install-on-clusters/windows-calico/kubeconfig',
                'getting-started/install-on-clusters/windows-calico/maintain',
    ...
    },
    {
      ...
      items: [
        ...
        'security/networksets',
        'security/default-deny',
        {
          type: 'category',
          label: 'Policy life cycle and automation',
          link: {type: 'doc', id: 'security/policy-lifecycle/index'},
          items: [
            'security/policy-lifecycle/staged-network-policies',
          ],
        },
        'security/policy-troubleshooting',
        {
          ...
          link: {type: 'doc', id: 'security/beginners/index'},
          items: [
            'security/beginners/kubernetes-default-deny',
            'security/beginners/calico-network-policy',
            'security/beginners/simple-policy-cnx',
            {
              type: 'category',
              label: 'Policy rules',
              link: {type: 'doc', id: 'security/beginners/policy-rules/index'},
              items: [
                'security/beginners/policy-rules/policy-rules-overview',
                'security/beginners/policy-rules/namespace-policy',
                'security/beginners/policy-rules/service-accounts',
                'security/beginners/policy-rules/service-policy',
                'security/beginners/policy-rules/external-ips-policy',
                'security/beginners/policy-rules/icmp-ping',
              ],
            },
            {
              type: 'category',
              label: 'Policy for services',
              link: {type: 'doc', id: 'security/beginners/services/index'},
              items: [
                'security/beginners/services/kubernetes-node-ports',
                'security/beginners/services/services-cluster-ips',
              ],
            },
          ],
        },
        'security/domain-based-policy',
        {
          type: 'category',
          label: 'Policy for firewalls',
          link: {type: 'doc', id: 'security/policy-firewalls/index'},
          items: [
            {
              type: 'category',
              label: 'Panorama firewall integrations',
              link: {type: 'doc', id: 'security/policy-firewalls/panorama-integration/index'},
              items: [
                'security/policy-firewalls/panorama-integration/tigera-panorama-policy-integration',
              ],
            },
            {
              type: 'category',
              label: 'Fortinet firewall integrations',
              link: {type: 'doc', id: 'security/policy-firewalls/fortinet-integration/index'},
              items: [
                'security/policy-firewalls/fortinet-integration/overview',
                'security/policy-firewalls/fortinet-integration/firewall-integration',
                'security/policy-firewalls/fortinet-integration/fortimgr-integration',
              ],
            },
            {
              type: 'category',
              label: 'AWS security groups integration',
              link: {type: 'doc', id: 'security/policy-firewalls/aws-integration/index'},
              items: [
                'security/policy-firewalls/aws-integration/get-started',
                'security/policy-firewalls/aws-integration/aws-security-group-integration',
                'security/policy-firewalls/aws-integration/tiers-and-policy',
                'security/policy-firewalls/aws-integration/metadata-access',
              ],
            },
          ],
        },
        ...
        },
        {
          ...
          items: [
            'security/get-started/about-network-policy',
            'security/get-started/kubernetes-network-policy',
            'security/get-started/kubernetes-demo',
            'security/get-started/kubernetes-policy-basic',
            'security/get-started/kubernetes-policy-advanced',
            'security/get-started/about-kubernetes-services',
            'security/get-started/about-kubernetes-ingress',
            'security/get-started/about-kubernetes-egress',
          ],
        },
      ],
    },
      ...
      items: [
        {
          ...
          link: {type: 'doc', id: 'maintenance/cnx/index'},
          items: [
            'maintenance/cnx/access-the-manager',
            'maintenance/cnx/authentication-quickstart',
            'maintenance/cnx/configure-identity-provider',
            'maintenance/cnx/roles-and-permissions',
          ],
        },
        {
          type: 'category',
          label: 'Secure component communications',
          link: {type: 'doc', id: 'maintenance/comms/index'},
          items: [
            'maintenance/comms/crypto-auth',
            'maintenance/comms/secure-metrics',
            'maintenance/comms/secure-bgp',
            'maintenance/comms/manager-tls',
            'maintenance/comms/log-storage-tls',
            'maintenance/comms/apiserver-tls',
            'maintenance/comms/typha-node-tls',
            'maintenance/comms/compliance-tls',
            'maintenance/comms/packetcapture-tls',
            'maintenance/comms/certificate-management',
          ],
        },
        {
          type: 'category',
          label: 'CLIs',
          link: {type: 'doc', id: 'maintenance/clis/index'},
          items: [
            {
              type: 'category',
              label: 'calicoctl',
              link: {type: 'doc', id: 'maintenance/clis/calicoctl/index'},
              items: [
                'maintenance/clis/calicoctl/install',
                {
                  type: 'category',
                  label: 'Configure calicoctl',
                  link: {type: 'doc', id: 'maintenance/clis/calicoctl/configure/index'},
                  items: [
                    'maintenance/clis/calicoctl/configure/overview',
                    'maintenance/clis/calicoctl/configure/datastore',
                  ],
                },
              ],
            },
            {
              type: 'category',
              label: 'calicoq',
              link: {type: 'doc', id: 'maintenance/clis/calicoq/index'},
              items: [
                'maintenance/clis/calicoq/installing',
                {
                  type: 'category',
                  label: 'Configure calicoq',
                  link: {type: 'doc', id: 'maintenance/clis/calicoq/configure/index'},
                  items: [
                    'maintenance/clis/calicoq/configure/overview',
                    'maintenance/clis/calicoq/configure/datastore',
                  ],
                },
              ],
            },
        ...
        },
        {
          type: 'category',
          label: 'Storage',
          link: {type: 'doc', id: 'maintenance/logstorage/index'},
          items: [
            'maintenance/logstorage/log-storage-recommendations',
            'maintenance/logstorage/create-storage',
            'maintenance/logstorage/adjust-log-storage-size',
            'maintenance/logstorage/advanced-node-scheduling',
          ],
        },
          ...
          items: [
            {
              type: 'category',
              label: 'Prometheus',
              link: {type: 'doc', id: 'maintenance/monitor/prometheus/index'},
              items: [
                'maintenance/monitor/prometheus/support',
                'maintenance/monitor/prometheus/byo-prometheus',
                'maintenance/monitor/prometheus/configure-prometheus',
                'maintenance/monitor/prometheus/alertmanager',
              ],
            },
            {
              type: 'category',
              label: 'Metrics',
              link: {type: 'doc', id: 'maintenance/monitor/metrics/index'},
              items: [
                'maintenance/monitor/metrics/bgp-metrics',
                'maintenance/monitor/metrics/license-agent',
                'maintenance/monitor/metrics/policy-metrics',
                'maintenance/monitor/metrics/elasticsearch-and-fluentd-metrics',
              ],
            },
          ],
        },
