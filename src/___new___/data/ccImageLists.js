const ccImageLists = {
  // TODO: placeholder copied from the v23.0.1 list. Replace it with the
  // v23.0.2 list once the release is in staging:
  // curl -0 https://installer.calicocloud.io/manifests/<v23.0.2 manifest>/image-list
...
quay.io/tigera/prometheus-config-reloader:v3.23.1
quay.io/tigera/cc-cni-config-scanner:v0.7.3`,
  // TODO: placeholder copied from the v22.5.0 list. Replace it with the
  // v22.5.1 list once the release is in staging:
  // curl -0 https://installer.calicocloud.io/manifests/<v22.5.1 manifest>/image-list
