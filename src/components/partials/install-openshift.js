      ...
      {maybeRender(
        ...
        <>
          <p>
            ...
            enables VXLAN and disables BGP. This is required for {props.prodnameWindows}:
          </p>
          <CodeBlock>
...
spec:
  ...
  calicoNetwork:
    ...
    - blockSize: 26
      ...
      <blockquote>
        <p>
          <strong>Notes</strong>: If you have a directory with the {props.prodname} resources, you can create the file
          with the command:
          <CodeBlock>
...
EOF`}
      ...
      {maybeRender(props.clusterOS === 'hybrid', <InstallOpenShiftWindows {...props} />)}
    </>
  );
}
...
Kubernetes Version: v1.18.3+5302882`}
        ...
        <li>
          ...
          <CodeBlock language='powershell'>
            {props.rootDirWindows}\kubernetes\install-kube-services.ps1 -service kube-proxy{'\n'}
