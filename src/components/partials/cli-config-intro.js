...
export default function CliConfigIntro(props) {
  return (
    <>
      <p>
        Many <code>{props.cli}</code> commands require access to the {props.prodname} datastore. In most circumstances,{' '}
...
spec:
  ...
  ...`}
      ...
      <p>
        See the section that corresponds to your <a href='../../'>datastore type</a> for a full set of options and
        examples.
      </p>
