              ...
              items: [
                ...
                'getting-started/kubernetes/windows-calico/demo',
                {
                  ...
                  items: [
                    ...
                    'getting-started/kubernetes/windows-calico/kubernetes/rancher',
                  ],
                },
                'getting-started/kubernetes/windows-calico/openshift-installation',
                'getting-started/kubernetes/windows-calico/kubeconfig',
                'getting-started/kubernetes/windows-calico/maintain',
      ...
      items: [
          ...
          items: [
            {
              ...
              items: [
                ...
                'security/get-started/calico-policy/calico-policy-tutorial',
              ],
            },
            {
              type: 'category',
              ...
              items: [
                ...
                'security/get-started/kubernetes-policy/kubernetes-policy-basic',
                'security/get-started/kubernetes-policy/kubernetes-policy-advanced',
              ],
            },
            'security/get-started/kubernetes-default-deny',
          ],
        },
        {
          type: 'category',
          ...
          items: [
            ...
            'security/policy-rules/service-policy',
            'security/policy-rules/service-accounts',
            'security/policy-rules/external-ips-policy',
            'security/policy-rules/icmp-ping',
        ...
        },
        {
          ...
          items: [
            ...
            'security/hosts/protect-hosts-tutorial',
            'security/hosts/host-forwarded-traffic',
          ],
        },
        {
          type: 'category',
        ...
        'security/encrypt-cluster-pod-traffic',
        {
          type: 'category',
          ...
          items: [
            ...
            'security/comms/secure-metrics',
            'security/comms/secure-bgp',
          ],
        },
      ],
    },
      ...
      items: [
        {
          ...
          items: [
            ...
            'maintenance/upgrading/openstack-upgrade',
          ],
        },
        {
          type: 'category',
          ...
          items: [
            'maintenance/calicoctl/install',
            {
              ...
              items: [
                ...
                'maintenance/calicoctl/configure/kdd',
              ],
            },
          ],
        },
        ...
        'maintenance/datastore-migration',
        'maintenance/operator-migration',
        'maintenance/install-apiserver',
        {
          type: 'category',
          label: 'eBPF',
          ...
          items: [
            ...
            'maintenance/ebpf/install',
            'maintenance/ebpf/troubleshoot-ebpf',
          ],
        },
        {
          type: 'category',
        ...
        'maintenance/decommissioning-a-node',
        {
          type: 'category',
          label: 'Troubleshoot',
          ...
          items: [
            ...
            'maintenance/troubleshoot/component-logs',
            //NOTE: Source doubled up on 'maintenance/ebpf/troubleshoot-ebpf'. Removing from here.
            'maintenance/troubleshoot/vpp',
          ],
        },
