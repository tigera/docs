...
[Check out the video Getting Started with EKS and Gateway API to learn more about using the Gateway API with Calico.](https://www.youtube.com/watch?v=Q8pbFLJIi5I)
