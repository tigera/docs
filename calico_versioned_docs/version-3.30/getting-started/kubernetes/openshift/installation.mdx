...
import InstallOpenShiftManifests from '@site/calico_versioned_docs/version-3.30/_includes/components/InstallOpenShiftManifests';
...
Augments the applicable steps in the [OpenShift documentation](https://docs.redhat.com/en/documentation/openshift_container_platform/)
to install $[prodname].
...
Refer to the [OpenShift installer documentation](https://docs.redhat.com/en/documentation/openshift_container_platform/) for more information
