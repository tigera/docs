...
This allows developers to run Berkeley Packet Filter (BPF) bytecode that can leverage specific kernel resources.
...
To learn more about eBPF, read our [eBPF](https://www.tigera.io/learn/guides/ebpf/) guide for detailed information on:
