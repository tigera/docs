---
description: Reference for the HostEndpoint resource in Calico Open Source that represents a host network interface for policy enforcement.
---

# Host endpoint

import Endpointport from '@site/calico_versioned_docs/version-3.32/_includes/content/_endpointport.mdx';
