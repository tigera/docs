---
description: Reference for the BGPPeer resource in Calico Open Source that defines a BGP neighbor relationship between Calico nodes and external routers.
---
...
A BGP peer resource (`BGPPeer`) represents a remote Border Gateway Protocol (BGP) peer
