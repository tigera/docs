---
description: Reference for the GlobalNetworkPolicy resource in Calico Open Source, a cluster-scoped policy that selects endpoints across all namespaces.
---

# Global network policy

import Httpmatch from '@site/calico_versioned_docs/version-3.32/_includes/content/_httpmatch.mdx';
...
import SelectorScopes from '@site/calico_versioned_docs/version-3.32/_includes/content/_selector-scopes.mdx';
