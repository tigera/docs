---
description: Reference for the StagedNetworkPolicy resource in Calico Open Source that previews namespaced policy without enforcing it.
---

# Staged network policy

import Servicematch from '@site/calico_versioned_docs/version-3.32/_includes/content/_servicematch.mdx';

import Serviceaccountmatch from '@site/calico_versioned_docs/version-3.32/_includes/content/_serviceaccountmatch.mdx';

import Ports from '@site/calico_versioned_docs/version-3.32/_includes/content/_ports.mdx';

import Selectors from '@site/calico_versioned_docs/version-3.32/_includes/content/_selectors.mdx';

import Entityrule from '@site/calico_versioned_docs/version-3.32/_includes/content/_entityrule.mdx';

import Icmp from '@site/calico_versioned_docs/version-3.32/_includes/content/_icmp.mdx';

import Rule from '@site/calico_versioned_docs/version-3.32/_includes/content/_rule.mdx';
