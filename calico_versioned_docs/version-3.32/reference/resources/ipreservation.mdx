---
description: Reference for the IPReservation resource in Calico Open Source that excludes specific addresses or ranges from automatic allocation.
---
...
$[prodname] supports Kubernetes [annotations that force the use of specific IP addresses](../configure-cni-plugins.mdx#requesting-a-specific-ip-address). These annotations override any `IPReservation`s that
are in place.
