---
description: Reference for Typha configuration parameters in Calico Open Source covering environment variables and config file options for scaling the Kubernetes datastore.
---
...
| `ServerHost`                            | `TYPHA_SERVERHOST`                            | TCP network address that typha sync_server endpoint should bind to. [Default: `""`]                                                                                                            | string                                       |
| `ServerPort`                            | `TYPHA_SERVERPORT`                            | TCP port that typha sync_server endpoint should bind to. [Default: `5473`]                                                                                                                     | int                                          |
...
[Connections from Felix to Typha (Kubernetes)](../../network-policy/comms/crypto-auth.mdx#connections-from-felix-to-typha-kubernetes).
