---
description: Reference covering the host network configuration applied by the Calico Open Source VPP data plane during initialization.
---
...
![Network architecture](/img/calico/vpp-host-net.svg)
