---
description: Reference summary describing how the different Calico Open Source host endpoint policy types interact and affect packet flows.
...
- Untracked policies technically do apply, but never have any net positive
  ...
  To be precise, untracked policy for the incoming host interface may
