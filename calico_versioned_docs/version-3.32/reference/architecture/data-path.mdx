---
description: Reference covering the Calico Open Source data path explaining how packets flow between workloads and to external destinations across networking modes.
---
...
indirect routes appear also. Alternatively, Felix can program those
indirect (cluster) routes directly for VXLAN, IP-in-IP, or unencapsulated
IP pools if Felix is configured to program cluster routes.
