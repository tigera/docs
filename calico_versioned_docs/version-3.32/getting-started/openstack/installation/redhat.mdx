---
description: Install Calico Open Source on an OpenStack deployment running Red Hat Enterprise Linux compute nodes.
---
...
import OpenStackEtcdAuth from '@site/calico_versioned_docs/version-3.32/_includes/content/_openstack-etcd-auth.mdx';
