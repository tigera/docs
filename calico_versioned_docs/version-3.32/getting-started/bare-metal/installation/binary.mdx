---
description: Install the Calico Open Source binary directly on a non-cluster host without using a package manager.
---

import EnvironmentFile from '@site/calico_versioned_docs/version-3.32/_includes/components/EnvironmentFile';
import FelixInitDatastore from '@site/calico_versioned_docs/version-3.32/_includes/content/_felix-init-datastore.mdx';
