---
description: Run the Calico Open Source agent on a non-cluster host inside a Docker container.
---

# Docker container install

import DockerContainerService from '@site/calico_versioned_docs/version-3.32/_includes/content/_docker-container-service.mdx';
