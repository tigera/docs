---
description: Install Calico Open Source for Windows on a Kubernetes cluster using the operator, for testing or development.
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';
import CalicoWindowsInstall from '@site/calico_versioned_docs/version-3.32/_includes/components/CalicoWindowsInstall';
