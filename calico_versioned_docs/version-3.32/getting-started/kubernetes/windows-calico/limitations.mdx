---
description: Known limitations of Calico Open Source for Windows that you should review before planning an installation.
---
...
| Install and upgrade | **Supported**: - Operator install<br /><br />**Not supported**: <br />- Non-cluster hosts<br />- Typha component for scaling (Linux-based feature)                                                                                                                                                                                                                                                                                                         |
