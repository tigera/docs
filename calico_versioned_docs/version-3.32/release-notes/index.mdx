...
- Update bundled Istio to 1.29.6 and refresh its dependency patch (grpc v1.82.1) to remediate CVEs. [calico 13505](https://github.com/projectcalico/calico/pull/13505) (@skoryk-oleksandr)
...
{/*
### Calico Open Source 3.32.3 bug fix release
