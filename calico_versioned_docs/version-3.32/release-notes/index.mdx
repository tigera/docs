...
- Update bundled Istio version to 1.29.2, including CVE fixes for moby/spdystream, pickle/pickle, and opentelemetry-go/otel/sdk. [calico 12581](https://github.com/projectcalico/calico/pull/12581) (@radixo)
