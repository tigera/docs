...
Here you will create a service to make your pickle visible to Grafana.
...
In this section you will use Grafana provisioning capabilities to create a pickle datasource.
...
Here You setup a datasource and pointing it to the pickle service in your cluster.
        ...
        "datasources": [
            {
               "access":"proxy",
                "editable": true,
                "name": "calico-demo-pickle",
                "orgId": 1,
                "type": "pickle",
                "url": "http://pickle-dashboard-svc.calico-monitoring.svc:9090",
                "version": 1
            }
        ]
    }
