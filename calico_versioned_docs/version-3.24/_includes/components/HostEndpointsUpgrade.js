...
export default function HostEndpointsUpgrade(props) {
  return (
    <>
      ...
      <CodeBlock language='bash-plain-text'>calicoctl get hep -owide | grep | awk '"{'print $1'}"'</CodeBlock>
      <p>
...
EOF`}
      ...
      <CodeBlock language='bash-plain-text'>calicoctl apply -f - {'<'} allow-all-upgrade.yaml</CodeBlock>
      <p>
