...
![Kubernetes Service conceptual diagram](/img/calico/3.24/k8s-service-concept.svg)
...
![kube-proxy cluster IP](/img/calico/3.24/kube-proxy-cluster-ip.svg)
...
![kube-proxy node port](/img/calico/3.24/kube-proxy-node-port.svg)
...
![kube-proxy load balancer](/img/calico/3.24/kube-proxy-load-balancer.svg)
...
![kube-proxy service advertisement](/img/calico/3.24/kube-proxy-service-advertisement.svg)
...
![kube-proxy service advertisement](/img/calico/3.24/kube-proxy-service-local.svg)
...
![kube-proxy service advertisement](/img/calico/3.24/calico-native-service-handling.svg)
