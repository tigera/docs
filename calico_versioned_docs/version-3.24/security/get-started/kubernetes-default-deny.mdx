...
If you haven't already, you will need to [install calicoctl](../../maintenance/calicoctl/install.mdx) to apply the example {{prodname}} network policies from this page.
