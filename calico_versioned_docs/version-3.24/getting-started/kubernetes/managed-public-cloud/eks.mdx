...
2. Configure the {{prodname}} installation.
...
2. Configure {{prodname}} to disable AWS src/dst checks.
...
2. If you already have {{prodname}} added, you can update it to get the latest released version.

    ```batch
    helm repo update
    ```

3. Install version {{releaseTitle}} of the {{prodname}} operator and custom resource definitions.
