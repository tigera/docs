...
![OSI network layers diagram](/img/calico/v3.24/osi-network-layers.svg)
...
![Anatomy of a network packet](/img/calico/v3.24/anatomy-of-a-packet.svg)
...
![Anatomy of an overlay network packet](/img/calico/v3.24/anatomy-of-an-overlay-packet.svg)
