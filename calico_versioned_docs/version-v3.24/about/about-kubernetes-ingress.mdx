...
![In-cluster ingress](/img/calico/v3.24/ingress-in-cluster.svg)
...
![External ingress](/img/calico/v3.24/ingres-external.svg)
...
![In-cluster ingress with NLB local](/img/calico/v3.24/ingress-in-cluster-nlb-local.svg)

**External ingress solution via node ports**

![External ingress via node port](/img/calico/v3.24/ingress-external-node-ports.svg)

**External ingress solution direct to pods**

![External ingress direct to pods](/img/calico/v3.24/ingress-external-direct-to-pods.svg)
