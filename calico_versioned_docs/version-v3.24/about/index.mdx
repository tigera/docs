...
>
  <div className='col-md-6'>
    <img
      ...
      src='/img/calico/v3.24/felix_icon.png'
    />
  </div>
  <div className='col-md-6'>
    <h3
...
>
  ...
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/v3.24/intro/multiple-dataplanes.png'
    />
  </div>
</div>
...
<div id="why-use-calico-2" className='row'>
  <div className='col-md-6'>
    <img className='img-responsive center-block' src="/img/calico/v3.24/intro/best-practices.png"/>
  </div>
  <div className='col-md-6'>
...
>
  ...
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/v3.24/intro/performance.png'
    />
  </div>
</div>
...
>
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/v3.24/intro/scale.png'
    />
  </div>
  <div className='col-md-6'>
    <h3
...
>
  ...
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/v3.24/intro/interoperability.png'
    />
  </div>
</div>
...
>
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/v3.24/intro/deployed.png'
    />
  </div>
  <div className='col-md-6'>
    <h3
...
>
  ...
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/v3.24/intro/policy.png'
    />
  </div>
</div>
...
>
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/v3.24/intro/community.png'
    />
  </div>
  <div className='col-md-6'>
    <h3
...
>
  ...
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/v3.24/calico-cloud-small.png'
    />
    <div
