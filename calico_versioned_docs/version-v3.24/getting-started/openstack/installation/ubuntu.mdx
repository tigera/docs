...
import OpenstackEtcdAuth from '@site/calico_versioned_docs/version-v3.24/_includes/content/_openstack-etcd-auth.mdx';
...
[Upgrading {{prodname}} on OpenStack](../../../maintenance/upgrading/openstack-upgrade.mdx)
instead.
