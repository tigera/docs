...
[Set environment variables](/getting-started/kubernetes/windows-calico/standard/#install-calico-and-kubernetes-on-windows-nodes) to update the `KUBECONFIG` environment variable to the path of your kubeconfig file.
