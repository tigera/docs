...
import CalicoctlVersion from '@site/calico_versioned_docs/version-v3.24/_includes/content/_calicoctl-version.mdx';
...
[to connect to your datastore](../../maintenance/calicoctl/configure/overview.mdx).
