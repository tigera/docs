...
- Distributions:
  ...
  - AKS with limitations:
    ...
    - [AKS with {variables.prodname} networking](../../getting-started/kubernetes/managed-public-cloud/aks.mdx#install-aks-with-{{prodnamedash}}-networking) is in testing with the eBPF dataplane. This should be a better solution overall but, at time of writing, the testing was not complete.
...
- [Configure {variables.prodname} to talk directly to the API server](#configure-{{prodnamedash}}-to-talk-directly-to-the-api-server)
