...
Use Grafana dashboard to view {variables.prodname} component metrics.
...
- a running Kubernetes cluster with {variables.prodname}, calicoctl and kubectl installed
- completed all steps in the [monitor component metrics](monitor-component-metrics.mdx) guide to set up Prometheus to gather {variables.prodname} component metrics.

## How to

This tutorial will go through the necessary steps to create {variables.prodname} metrics dashboards with Grafana.
...
#### **2. Provisioning {variables.prodname} dashboards**

Here you will create a configmap with Felix and Typha dashboards.

<CodeBlock language='bash'>
kubectl apply -f {variables.manifestsUrl}/manifests/grafana-dashboards.yaml
</CodeBlock>
