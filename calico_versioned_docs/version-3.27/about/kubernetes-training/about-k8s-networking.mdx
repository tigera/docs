...
Note that when using {variables.prodname} in on-prem deployments you can also [advertise service IP addresses](/networking/configuring/advertise-service-ips.mdx)
