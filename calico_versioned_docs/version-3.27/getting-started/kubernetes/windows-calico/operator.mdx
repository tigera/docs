...
{{prodnameWindows}} is a hybrid implementation that requires a Linux cluster for {variables.prodname} components and Linux workloads, and Windows nodes for Windows workloads.
...
- [Install {{prodnameWindows}} using the operator](#install-calico-for-windows-using-the-operator)
