...
## About {variables.prodname} testing

{variables.prodname} is tested each release against the Kubernetes versions listed in [System requirements](requirements.mdx). 

{variables.prodname} works on many different platforms. The following are common platforms that {variables.prodname} tests with some regularity.  
...
This section is updated by {variables.prodname} community members. Please share what versions and platforms work for you. 
...
:::note
- If your {variables.prodname} setup is not working, the best place to start is the Calico Users Slack channel (calicousers.slack.com)
