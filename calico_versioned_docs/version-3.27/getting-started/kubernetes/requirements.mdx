...
We test {variables.prodname} {{version}} against the following Kubernetes versions. Other versions may work, but we are not actively testing them.

- v1.27
- v1.28
- v1.29

Due to changes in the Kubernetes API, {variables.prodname} {{version}} will not work
