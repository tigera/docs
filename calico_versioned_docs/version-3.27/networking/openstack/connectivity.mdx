...
configure your {variables.prodname}-based OpenStack deployment to ensure that you have
...
routers, floating IPs, and external networks. {variables.prodname}'s focus on
...
For {variables.prodname}, it's best to pick up to three address ranges you're going to
...
Your {variables.prodname} deployment will require a gateway router. In most
...
Then, the gateway router needs to be a BGP peer of the {variables.prodname} network.
...
document. If you don't know how to do this or want to know how {variables.prodname}
