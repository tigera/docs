...
import Selectors from '@site/calico_versioned_docs/version-3.26/_includes/content/_selectors.mdx';
...
| nodeSelector                       | Selects the nodes that {variables.prodname} IPAM should assign addresses from this pool to.                                                                                                 |                                                                                                                                                                                                                        | [selector](#node-selector) | all()                                         |
...
{variables.prodname} supports Kubernetes [annotations that force the use of specific IP addresses](../configure-cni-plugins.mdx#requesting-a-specific-ip-address). These annotations take precedence over the `allowedUses` field.
