...
import DetermineIpam from '@site/calico_versioned_docs/version-3.26/_includes/content/_determine-ipam.mdx';
...
For help configuring {variables.prodname} IPAM, see [Configuring the {variables.prodname} CNI Plugins](../../reference/configure-cni-plugins.mdx).
