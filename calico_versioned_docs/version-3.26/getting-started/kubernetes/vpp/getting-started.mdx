...
Trying out the beta will give you a taste of these benefits and an opportunity to give feedback to the VPP data plane team.
...
Start by getting the appropriate yaml manifest for the VPP data plane resources:
