...
import AutoHostendpointsMigrate from '@site/calico_versioned_docs/version-3.26/_includes/components/AutoHostendpointsMigrate';
import HostEndpointsUpgrade from '@site/calico_versioned_docs/version-3.26/_includes/components/HostEndpointsUpgrade';

# Upgrade Calico on Kubernetes

## About upgrading {variables.prodname}

This page describes how to upgrade to {{version}} from {variables.prodname} v3.0 or later. The
