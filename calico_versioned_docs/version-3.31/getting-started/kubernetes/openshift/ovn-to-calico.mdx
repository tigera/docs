...
- **VMware Migration Ready:** $[prodname] allows you to have capabilities such as tier-0 routing, VM tenant isolation, and microsegmentation to help your VMware migration journey to Kubernetes.
