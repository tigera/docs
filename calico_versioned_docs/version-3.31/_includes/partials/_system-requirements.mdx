...
* A Linux distribution that has the minimum required Linux kernel version and [required dependencies](#kernel-dependencies).
  If you use the eBPF data plane, a later version of the kernel is required.
  * Minimum Linux kernel version: 5.10.
  * Minimum Linux kernel version for eBPF: 5.17.

  The following distributions have the required kernels and dependencies, and are known to work well with $[prodname].
  <If condition={props.platform === 'kubernetes'}>
  <table>
    <thead>
    <tr>
      <th>Distribution</th>
      <th>Compatible with Calico</th>
      <th>Compatible with Calico eBPF</th>
    </tr>
    </thead>
    <tbody>
    <tr>
    ...
    <tr>
      <td>Ubuntu</td>
      <td>22.04 LTS or later</td>
      <td>24.04 LTS or later</td>
    </tr>
    <tr>
      <td>Debian</td>
      <td>11 or later</td>
