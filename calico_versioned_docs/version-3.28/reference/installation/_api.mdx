...
| `logFileMaxSize` _[Quantity](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.3/#quantity-resource-api)_ | (Optional)<br />Default: 100Mi |
