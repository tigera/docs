...
{`mkdir vpp
cd vpp
curl -O "${variables.vppFilesURL}/yaml/platforms/openshift/00-namespace-calico-vpp-dataplane.yaml"
curl -O "${variables.vppFilesURL}/yaml/platforms/openshift/01-cr-installation.yaml"
curl -O "${variables.vppFilesURL}/yaml/platforms/openshift/03-configmap-calico-vpp-resources.yaml"
curl -O "${variables.vppFilesURL}/yaml/platforms/openshift/03-role-calico-vpp-dataplane.yaml"
curl -O "${variables.vppFilesURL}/yaml/platforms/openshift/03-rolebinding-calico-vpp-dataplane.yaml"
curl -O "{variables.vppFilesURL}/yaml/platforms/openshift/03-serviceaccount-calico-vpp-dataplane.yaml"
curl -O "{variables.vppFilesURL}/yaml/platforms/openshift/04-calico-vpp-nohuge.yaml"
cd ..
cp vpp/* manifests/`}
</CodeBlock>
