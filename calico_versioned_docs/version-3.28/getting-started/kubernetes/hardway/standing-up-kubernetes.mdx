...
We will install {variables.prodname} on a Kubernetes cluster. To demonstrate a highly available {variables.prodname} control plane, we will use five nodes in this guide. This lab walks you through provisioning a Kubernetes cluster in AWS using kubeadm.
