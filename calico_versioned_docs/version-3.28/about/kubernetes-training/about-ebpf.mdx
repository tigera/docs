...
- **Traffic Control** (`tc`) programs can be attached at ingress and egress to a given network device. The kernel
  ...
  another interface. $[prodname]'s eBPF data plane is based on this type of hook; we use tc programs to load
...
in the standard dataplane. As part of that, the eBPF data plane replaces kube-proxy with an eBPF implementation.
...
| Factor                               | Standard Linux Dataplane                              | eBPF data plane                                                |
| ------------------------------------ | ----------------------------------------------------- | -------------------------------------------------------------- |
