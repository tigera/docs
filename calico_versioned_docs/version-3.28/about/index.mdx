...
The following table summarizes the main $[prodname] features. To search for specific features, see [Product comparison](calico-product-editions.mdx).
