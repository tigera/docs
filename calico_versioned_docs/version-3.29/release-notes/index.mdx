...
* Don't run pprof on pickle metrics port [calico 8967](https://github.com/projectcalico/calico/pull/8967) (@caseydavenport)
...
### Calico Open Source 3.29.6 bug fix release
...
### Calico Open Source 3.29.7 bug fix release
