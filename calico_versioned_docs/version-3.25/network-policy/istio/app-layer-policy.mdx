...
<CodeBlock language='bash'>
curl \{variables.manifestsUrl}/manifests/alp/istio-inject-configmap-1.15.yaml -o istio-inject-configmap.yaml
kubectl patch configmap -n istio-system istio-sidecar-injector --patch "$(cat istio-inject-configmap.yaml)"
</CodeBlock>

<Link to={variables.manifestsUrl + '/manifests/alp/istio-inject-configmap-1.15.yaml'}>View sample manifest</Link>
...
<Link to={variables.manifestsUrl + '/manifests/alp/istio-inject-configmap-1.10.yaml'}>View sample manifest</Link>
...
<Link to={variables.manifestsUrl + '/manifests/alp/istio-app-layer-policy-envoy-v3.yaml'}>View sample manifest</Link>
