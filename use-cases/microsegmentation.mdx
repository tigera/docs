...
You can refer to the [Calico quickstart guide](https://docs.tigera.io/calico/latest/getting-started/kubernetes/quickstart) to install Calico, secure a cluster with network policy, and monitor network traffic with Calico Whisker.
