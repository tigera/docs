...
If you’re new to network policies we recommend that you read this: [What is network policy?](https://docs.tigera.io/calico/latest/about/kubernetes-training/about-network-policy)

### What can egress access controls protect you from?

Egress access controls protect you and your network from multiple attack vectors, mainly revolving around initiating malicious communications with intent to control, download or run malware, or data exfiltration.
...
Once you’ve verified the behaviour of your policies you can enforce any staged (Calico Enterprise or Calico Cloud) or logged (Calico Open Source) default deny policies.
