  ...
  scripts: [
    {
      ...
      "data-modal-disclaimer": "This is a custom LLM for Tigera with access to all developer docs" +
        " (docs.tigera.io)." +
        " Please note that answers are generated by AI and may not be fully accurate, so please use your best judgement.",
      "data-modal-example-questions": "What is Calico good for?, How do I set up IPAM?, What's the deal with egress" +
        " gateways?",
      async: true,
    },
  ],
