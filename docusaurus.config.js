  ...
  const config = {
    ...
    themeConfig:
      /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
      {
        ...
        announcementBar: {
          id: "calico_ebpf",
          content: 'Master Kubernetes network security with Calico. Join our hybrid event, CalicoCon 2025, on November 10! <a href="https://link.tigera.io/ujbNx">Register now :rocket:</a>',
    ...
    plugins: [
      ...
      [
        ...
        /** @type {import('@docusaurus/plugin-content-docs').Options} */
        {
          ...
          onlyIncludeVersions: [...nextVersion, '3.30','3.29', '3.28'],
          lastVersion: '3.30',
          versions: {
            current: {
              label: 'Next',
      ...
      [
        ...
        /** @type {import('@docusaurus/plugin-content-docs').Options} */
        {
          ...
          editCurrentVersion: true,
          onlyIncludeVersions: [...nextVersion, '3.22-1','3.21-2', '3.20-2', '3.19-2'],
          lastVersion: '3.21-2',
          versions: {
            current: {
              label: 'Next',
